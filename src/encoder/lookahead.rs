...
pub mod pthread_h {
    use super::pthreadtypes_h::{pthread_attr_t, pthread_cond_t, pthread_mutex_t, pthread_t};
    extern "C" {
...
use self::analyse_h::{x264_10_slicetype_analyse, x264_10_slicetype_decide};
...
pub use self::pthreadtypes_h::{pthread_attr_t, pthread_cond_t, pthread_mutex_t, pthread_t};
...
pub use self::x264_h::{
    ...
    C2RustUnnamed_5, X264_TYPE_I, X264_TYPE_IDR, X264_TYPE_KEYFRAME,
};
#[c2rust::src_loc = "42:1"]
            ...
            if !(x264_10_macroblock_cache_allocate(look_h) != 0) {
                    ...
                    < 0 as ::core::ffi::c_int)
                {
                    if !(pthread_create(
                        ...
                        >(Some(
                            lookahead_thread
                                as unsafe extern "C" fn(*mut x264_t) -> *mut ::core::ffi::c_void,
                        ))),
...
pub unsafe extern "C" fn x264_10_lookahead_delete(mut h: *mut x264_t) {
    if (*h).param.i_sync_lookahead != 0 {
        ...
        x264_free((*h).thread[(*h).param.i_threads as usize] as *mut ::core::ffi::c_void);
    }
...
pub unsafe extern "C" fn x264_10_lookahead_is_empty(mut h: *mut x264_t) -> ::core::ffi::c_int {
    pthread_mutex_lock(&mut (*(*h).lookahead).ofbuf.mutex);
    pthread_mutex_lock(&mut (*(*h).lookahead).next.mutex);
