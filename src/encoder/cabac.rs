...
unsafe extern "C" fn cabac_mb_type_intra(
    ...
    if i_mb_type == I_4x4 as c_int || i_mb_type == I_8x8 as c_int {
        x264_10_cabac_encode_decision_c(cb, ctx0, 0);
    } else if i_mb_type == I_PCM as c_int {
        x264_10_cabac_encode_decision_c(cb, ctx0, 1);
        ...
        if (*h).mb.i_cbp_chroma == 0 {
            x264_10_cabac_encode_decision_c(cb, ctx2, 0);
        } else {
            x264_10_cabac_encode_decision_c(cb, ctx2, 1);
            x264_10_cabac_encode_decision_c(cb, ctx3, (*h).mb.i_cbp_chroma >> 1);
        }
        x264_10_cabac_encode_decision_c(cb, ctx4, i_pred >> 1);
        x264_10_cabac_encode_decision_c(cb, ctx5, i_pred & 1);
    };
}
#[c2rust::src_loc = "70:1"]
unsafe extern "C" fn cabac_field_decoding_flag(mut h: *mut x264_t, mut cb: *mut x264_cabac_t) {
    ...
    ctx += ((*h).mb.i_mb_top_mbpair_xy >= 0
        ...
        as c_int;
    x264_10_cabac_encode_decision_c(cb, 70 + ctx, (*h).mb.interlaced as i32);
...
unsafe extern "C" fn cabac_intra4x4_pred_mode(
    ...
    if i_pred == i_mode {
        x264_10_cabac_encode_decision_c(cb, 68, 1);
    } else {
        x264_10_cabac_encode_decision_c(cb, 68, 0);
        if i_mode > i_pred {
            i_mode -= 1;
        }
        x264_10_cabac_encode_decision_c(cb, 69, i_mode & 0x1 as c_int);
        x264_10_cabac_encode_decision_c(cb, 69, i_mode >> 1 & 0x1 as c_int);
        x264_10_cabac_encode_decision_c(cb, 69, i_mode >> 2);
    };
}
#[c2rust::src_loc = "98:1"]
unsafe extern "C" fn cabac_intra_chroma_pred_mode(mut h: *mut x264_t, mut cb: *mut x264_cabac_t) {
    ...
    x264_10_cabac_encode_decision_c(cb, 64 + ctx, (i_mode > 0) as c_int);
    if i_mode > 0 {
        x264_10_cabac_encode_decision_c(cb, 64 + 3, (i_mode > 1) as c_int);
        if i_mode > 1 {
            x264_10_cabac_encode_decision_c(cb, 64 + 3, (i_mode > 2) as c_int);
        }
    }
}
...
unsafe extern "C" fn cabac_cbp_luma(mut h: *mut x264_t, mut cb: *mut x264_cabac_t) {
    ...
    x264_10_cabac_encode_decision_c(cb, 76 - (cbp_l >> 1 & 1) - (cbp_t >> 1 & 2), cbp >> 0 & 1);
    x264_10_cabac_encode_decision_c(cb, 76 - (cbp >> 0 & 1) - (cbp_t >> 2 & 2), cbp >> 1 & 1);
    x264_10_cabac_encode_decision_c(cb, 76 - (cbp_l >> 3 & 1) - (cbp << 1 & 2), cbp >> 2 & 1);
    x264_10_cabac_encode_decision_c(cb, 76 - (cbp >> 2 & 1) - (cbp >> 0 & 2), cbp >> 3 & 1);
}
...
unsafe extern "C" fn cabac_cbp_chroma(mut h: *mut x264_t, mut cb: *mut x264_cabac_t) {
    ...
    if (*h).mb.i_cbp_chroma == 0 {
        x264_10_cabac_encode_decision_c(cb, 77 + ctx, 0);
    } else {
        x264_10_cabac_encode_decision_c(cb, 77 + ctx, 1);
        ctx = 4;
        ...
        x264_10_cabac_encode_decision_c(cb, 77 + ctx, (*h).mb.i_cbp_chroma >> 1);
    };
}
...
unsafe extern "C" fn cabac_qp_delta(mut h: *mut x264_t, mut cb: *mut x264_cabac_t) {
    ...
    if i_dqp != 0 {
        ...
        loop {
            x264_10_cabac_encode_decision_c(cb, 60 + ctx, 1);
            ctx = 2 + (ctx >> 1);
            val -= 1;
            if !(val != 0) {
                break;
...
unsafe extern "C" fn cabac_subpartition_p(mut cb: *mut x264_cabac_t, mut i_sub: c_int) {
    if i_sub == D_L0_8x8 as c_int {
        x264_10_cabac_encode_decision_c(cb, 21, 1);
        return;
    }
    x264_10_cabac_encode_decision_c(cb, 21, 0);
    if i_sub == D_L0_8x4 as c_int {
        x264_10_cabac_encode_decision_c(cb, 22, 0);
    } else {
        x264_10_cabac_encode_decision_c(cb, 22, 1);
        x264_10_cabac_encode_decision_c(cb, 23, (i_sub == D_L0_4x8 as c_int) as c_int);
    };
}
#[inline(always)]
...
unsafe extern "C" fn cabac_subpartition_b(mut cb: *mut x264_cabac_t, mut i_sub: c_int) {
    if i_sub == D_DIRECT_8x8 as c_int {
        x264_10_cabac_encode_decision_c(cb, 36, 0);
        return;
    }
    x264_10_cabac_encode_decision_c(cb, 36, 1);
    if i_sub == D_BI_8x8 as c_int {
        x264_10_cabac_encode_decision_c(cb, 37, 1);
        x264_10_cabac_encode_decision_c(cb, 38, 0);
        x264_10_cabac_encode_decision_c(cb, 39, 0);
        x264_10_cabac_encode_decision_c(cb, 39, 0);
        return;
    }
    x264_10_cabac_encode_decision_c(cb, 37, 0);
    x264_10_cabac_encode_decision_c(cb, 39, (i_sub == D_L1_8x8 as c_int) as c_int);
}
#[inline(always)]
...
unsafe extern "C" fn cabac_ref_internal(
    ...
    while i_ref > 0 {
        x264_10_cabac_encode_decision_c(cb, 54 + ctx, 1);
        ctx = (ctx >> 2) + 4;
        i_ref -= 1;
    }
    x264_10_cabac_encode_decision_c(cb, 54 + ctx, 0);
}
#[inline(never)]
...
unsafe extern "C" fn cabac_mvd_cpn(
    ...
    if mvd == 0 {
        x264_10_cabac_encode_decision_c(cb, ctxbase + ctx, 0);
        return 0;
    }
    let mut i_abs: c_int = abs(mvd);
    x264_10_cabac_encode_decision_c(cb, ctxbase + ctx, 1);
    static mut ctxes: [uint8_t; 8] = [3, 4, 5, 6, 6, 6, 6, 6];
    if i_abs < 9 {
        let mut i: c_int = 1;
        while i < i_abs {
            x264_10_cabac_encode_decision_c(cb, ctxbase + ctxes[(i - 1) as usize] as c_int, 1);
            i += 1;
        }
        x264_10_cabac_encode_decision_c(cb, ctxbase + ctxes[(i_abs - 1) as usize] as c_int, 0);
    } else {
        let mut i_0: c_int = 1;
        while i_0 < 9 {
            x264_10_cabac_encode_decision_c(cb, ctxbase + ctxes[(i_0 - 1) as usize] as c_int, 1);
            i_0 += 1;
        }
        x264_10_cabac_encode_ue_bypass(cb, 3, i_abs - 9);
    }
    x264_10_cabac_encode_bypass_c(cb, mvd >> 31);
...
unsafe extern "C" fn cabac_mb_header_i(
    ...
    if slice_type == SLICE_TYPE_I as c_int {
        ...
        x264_10_cabac_encode_decision_c(cb, 14, 1);
        cabac_mb_type_intra(
            h,
            cb,
            i_mb_type,
        ...
        x264_10_cabac_encode_decision_c(cb, 27 + 3, 1);
        x264_10_cabac_encode_decision_c(cb, 27 + 4, 1);
        x264_10_cabac_encode_decision_c(cb, 27 + 5, 1);
        x264_10_cabac_encode_decision_c(cb, 27 + 5, 0);
        x264_10_cabac_encode_decision_c(cb, 27 + 5, 1);
        cabac_mb_type_intra(
            h,
            cb,
...
unsafe extern "C" fn cabac_mb_header_p(
    ...
    if i_mb_type == P_L0 as c_int {
        x264_10_cabac_encode_decision_c(cb, 14, 0);
        if (*h).mb.i_partition == D_16x16 as c_int {
            x264_10_cabac_encode_decision_c(cb, 15, 0);
            x264_10_cabac_encode_decision_c(cb, 16, 0);
            ...
            x264_10_cabac_encode_decision_c(cb, 15, 1);
            x264_10_cabac_encode_decision_c(cb, 17, 1);
            if (*h).mb.pic.i_fref[0] > 1 {
                cabac_ref_p(h, cb, 0);
                cabac_ref_p(h, cb, 8);
            }
            ...
            x264_10_cabac_encode_decision_c(cb, 15, 1);
            x264_10_cabac_encode_decision_c(cb, 17, 0);
            if (*h).mb.pic.i_fref[0] > 1 {
                cabac_ref_p(h, cb, 0);
                cabac_ref_p(h, cb, 4);
            }
        ...
        x264_10_cabac_encode_decision_c(cb, 14, 0);
        x264_10_cabac_encode_decision_c(cb, 15, 0);
        x264_10_cabac_encode_decision_c(cb, 16, 1);
        let mut i: c_int = 0;
        while i < 4 {
...
unsafe extern "C" fn cabac_mb_header_b(
    ...
    if i_mb_type == B_DIRECT as c_int {
        x264_10_cabac_encode_decision_c(cb, 27 + ctx, 0);
        return;
    }
    x264_10_cabac_encode_decision_c(cb, 27 + ctx, 1);
    if i_mb_type == B_8x8 as c_int {
        ...
        x264_10_cabac_encode_decision_c(cb, 27 + 3, bits & 1);
        x264_10_cabac_encode_decision_c(cb, 27 + 5 - (bits & 1), bits >> 1 & 1);
        bits >>= 2;
        if bits != 1 {
            x264_10_cabac_encode_decision_c(cb, 27 + 5, bits & 1);
            bits >>= 1;
            x264_10_cabac_encode_decision_c(cb, 27 + 5, bits & 1);
            bits >>= 1;
            x264_10_cabac_encode_decision_c(cb, 27 + 5, bits & 1);
...
static mut coeff_abs_level1_ctx: [uint8_t; 8] = [1, 2, 3, 4, 0, 0, 0, 0];
#[c2rust::src_loc = "652:22"]
static mut coeff_abs_levelgt1_ctx: [uint8_t; 8] = [5, 5, 5, 5, 6, 7, 8, 9];
#[c2rust::src_loc = "655:22"]
static mut coeff_abs_levelgt1_ctx_chroma_dc: [uint8_t; 8] = [5, 5, 5, 5, 6, 7, 8, 8];
...
unsafe extern "C" fn cabac_block_residual_internal(
        ...
        if count_m1_0 == 63 {
            ...
            loop {
                if *l.offset(i_1 as isize) != 0 {
                    ...
                    x264_10_cabac_encode_decision_c(cb, ctx_sig + i_1, 1);
                    if i_1 == last {
                        x264_10_cabac_encode_decision_c(cb, ctx_last + i_1, 1);
                        break;
                    } else {
                        x264_10_cabac_encode_decision_c(cb, ctx_last + i_1, 0);
                    }
                } else {
                    x264_10_cabac_encode_decision_c(cb, ctx_sig + i_1, 0);
                }
                i_1 += 1;
                if !(i_1 == count_m1_0) {
                    continue;
    ...
    loop {
        ...
        let mut coeff_sign: c_int = coeff >> 31;
        let mut ctx: c_int = coeff_abs_level1_ctx[node_ctx as usize] as c_int + ctx_level;
        if abs_coeff > 1 {
            x264_10_cabac_encode_decision_c(cb, ctx, 1);
            ctx = *levelgt1_ctx.offset(node_ctx as isize) as c_int + ctx_level;
            let mut i_2: c_int = (if abs_coeff < 15 { abs_coeff } else { 15 }) - 2;
            while i_2 > 0 {
                x264_10_cabac_encode_decision_c(cb, ctx, 1);
                i_2 -= 1;
            }
            if abs_coeff < 15 {
                x264_10_cabac_encode_decision_c(cb, ctx, 0);
            } else {
                x264_10_cabac_encode_ue_bypass(cb, 0, abs_coeff - 15);
            }
...
unsafe extern "C" fn cabac_block_residual_422_dc(
    ...
    cabac_block_residual_internal(h, cb, DCT_CHROMA_DC as c_int, l, 1);
}
#[inline(always)]
...
unsafe extern "C" fn macroblock_write_cabac_internal(
    ...
    if i_mb_type == I_PCM as c_int {
        ...
        if chroma != 0 {
            ...
            while ch < 3 {
                let mut i_0: c_int = 0;
                while i_0 < 16 >> (*h).mb.chroma_v_shift {
                    let mut j: c_int = 0;
                    while j < 8 {
                        bs_write(
                            &mut s,
        ...
        || i_mb_type == I_16x16 as c_int
    {
        ...
        if i_mb_type == I_16x16 as c_int {
            ...
            while p_0 < plane_count {
                ...
                if (*h).mb.cache.non_zero_count[x264_scan8[(48 + p_0) as usize] as usize] != 0 {
                    x264_10_cabac_encode_decision_c(cb, ctxidxinc, 1);
                    ...
                    x264_10_cabac_encode_decision_c(cb, ctxidxinc, 0);
                }
                if (*h).mb.i_cbp_luma != 0 {
                    let mut i_1: c_int = p_0 * 16;
                    while i_1 < p_0 * 16 + 16 {
                        ...
                        if (*h).mb.cache.non_zero_count[x264_scan8[i_1 as usize] as usize] != 0 {
                            x264_10_cabac_encode_decision_c(cb, ctxidxinc_0, 1);
                            cabac_block_residual(
                                h,
                                cb,
                                ctx_cat_plane[DCT_LUMA_AC as c_int as usize][p_0 as usize] as c_int,
                            ...
                            x264_10_cabac_encode_decision_c(cb, ctxidxinc_0, 0);
                        }
                        i_1 += 1;
                    }
                }
            ...
            if plane_count == 3 {
                ...
                while p_1 < 3 {
                    ...
                    while msk != 0 && {
                        ...
                        if (*h).mb.cache.non_zero_count
                            [x264_scan8[(i_2 * 4 + p_1 * 16) as usize] as usize]
                            != 0
                        {
                            x264_10_cabac_encode_decision_c(cb, ctxidxinc_1, 1);
                            cabac_block_residual(
                                h,
                                cb,
                                ...
                                (*(*h)
                                    ...
                                    .luma8x8
                                    .as_mut_ptr()
                                    .offset((i_2 + p_1 * 4) as isize))
                                .as_mut_ptr(),
                            );
                        } else {
                            x264_10_cabac_encode_decision_c(cb, ctxidxinc_1, 0);
                        }
                        i_2 += 1;
                    }
                    p_1 += 1;
                ...
                {
                    (*h).mb.cache.non_zero_count
                        [(x264_scan8[(16 * 0 + 0) as usize] as c_int - 1) as usize] = nnzbak[0][0];
                    (*h).mb.cache.non_zero_count
                        [(x264_scan8[(16 * 0 + 2) as usize] as c_int - 1) as usize] = nnzbak[0][1];
                    (*h).mb.cache.non_zero_count
                        [(x264_scan8[(16 * 1 + 0) as usize] as c_int - 1) as usize] = nnzbak[1][0];
                    (*h).mb.cache.non_zero_count
                        [(x264_scan8[(16 * 1 + 2) as usize] as c_int - 1) as usize] = nnzbak[1][1];
                    (*h).mb.cache.non_zero_count
                        [(x264_scan8[(16 * 2 + 0) as usize] as c_int - 1) as usize] = nnzbak[2][0];
                    (*h).mb.cache.non_zero_count
                        [(x264_scan8[(16 * 2 + 2) as usize] as c_int - 1) as usize] = nnzbak[2][1];
                }
                if (*h).mb.i_neighbour & MB_LEFT as c_int as c_uint != 0
                    && *(*h)
                        .mb
                ...
                {
                    (*h).mb.cache.non_zero_count
                        [(x264_scan8[(16 * 0 + 8) as usize] as c_int - 1) as usize] = nnzbak[0][2];
                    (*h).mb.cache.non_zero_count
                        [(x264_scan8[(16 * 0 + 10) as usize] as c_int - 1) as usize] = nnzbak[0][3];
                    (*h).mb.cache.non_zero_count
                        [(x264_scan8[(16 * 1 + 8) as usize] as c_int - 1) as usize] = nnzbak[1][2];
                    (*h).mb.cache.non_zero_count
                        [(x264_scan8[(16 * 1 + 10) as usize] as c_int - 1) as usize] = nnzbak[1][3];
                    (*h).mb.cache.non_zero_count
                        [(x264_scan8[(16 * 2 + 8) as usize] as c_int - 1) as usize] = nnzbak[2][2];
                    (*h).mb.cache.non_zero_count
                        [(x264_scan8[(16 * 2 + 10) as usize] as c_int - 1) as usize] = nnzbak[2][3];
                }
                if (*h).mb.i_neighbour & MB_TOP as c_int as c_uint != 0
                    && *(*h)
                        .mb
            ...
            while p_2 < plane_count {
                ...
                while msk_1 != 0 && {
                    ...
                    while i_4 < 4 {
                        ...
                        if (*h).mb.cache.non_zero_count
                            [x264_scan8[(i_4 + i8x8 * 4 + p_2 * 16) as usize] as usize]
                            != 0
                        {
                            x264_10_cabac_encode_decision_c(cb, ctxidxinc_2, 1);
                            cabac_block_residual(
                                h,
                                cb,
                                ...
                                (*(*h)
                                    ...
                                    .luma4x4
                                    .as_mut_ptr()
                                    .offset((i_4 + i8x8 * 4 + p_2 * 16) as isize))
                                .as_mut_ptr(),
                            );
                        } else {
                            x264_10_cabac_encode_decision_c(cb, ctxidxinc_2, 0);
                        }
                        i_4 += 1;
                    }
                    i8x8 += 1;
        ...
        if chroma != 0 && (*h).mb.i_cbp_chroma != 0 {
            if (*(*h).sps.as_mut_ptr()).i_chroma_format_idc == CHROMA_422 as c_int {
                ...
                if (*h).mb.cache.non_zero_count[x264_scan8[(49 + 0) as usize] as usize] != 0 {
                    x264_10_cabac_encode_decision_c(cb, ctxidxinc_3, 1);
                    ...
                    x264_10_cabac_encode_decision_c(cb, ctxidxinc_3, 0);
                }
                ...
                if (*h).mb.cache.non_zero_count[x264_scan8[(49 + 1) as usize] as usize] != 0 {
                    x264_10_cabac_encode_decision_c(cb, ctxidxinc_4, 1);
                    cabac_block_residual_422_dc(
                        h,
                        cb,
                        DCT_CHROMA_DC as c_int,
                    ...
                    x264_10_cabac_encode_decision_c(cb, ctxidxinc_4, 0);
                }
            } else {
                let mut ctxidxinc_5: c_int =
                    cabac_cbf_ctxidxinc(h, DCT_CHROMA_DC as c_int, 49 + 0, b_intra, 1);
                if (*h).mb.cache.non_zero_count[x264_scan8[(49 + 0) as usize] as usize] != 0 {
                    x264_10_cabac_encode_decision_c(cb, ctxidxinc_5, 1);
                    cabac_block_residual(
                        h,
                        cb,
                        DCT_CHROMA_DC as c_int,
                    ...
                    x264_10_cabac_encode_decision_c(cb, ctxidxinc_5, 0);
                }
                let mut ctxidxinc_6: c_int =
                    cabac_cbf_ctxidxinc(h, DCT_CHROMA_DC as c_int, 49 + 1, b_intra, 1);
                if (*h).mb.cache.non_zero_count[x264_scan8[(49 + 1) as usize] as usize] != 0 {
                    x264_10_cabac_encode_decision_c(cb, ctxidxinc_6, 1);
                    cabac_block_residual(
                        h,
                        cb,
                        DCT_CHROMA_DC as c_int,
                    ...
                    x264_10_cabac_encode_decision_c(cb, ctxidxinc_6, 0);
                }
            }
            if (*h).mb.i_cbp_chroma == 2 {
                let mut step: c_int = (8) << (*h).mb.chroma_v_shift;
                let mut i_5: c_int = 16;
                while i_5 < 3 * 16 {
                    let mut j_0: c_int = i_5;
                    while j_0 < i_5 + 4 {
                        let mut ctxidxinc_7: c_int =
                            cabac_cbf_ctxidxinc(h, DCT_CHROMA_AC as c_int, j_0, b_intra, 0);
                        if (*h).mb.cache.non_zero_count[x264_scan8[j_0 as usize] as usize] != 0 {
                            x264_10_cabac_encode_decision_c(cb, ctxidxinc_7, 1);
                            cabac_block_residual(
                                h,
                                cb,
                            ...
                            x264_10_cabac_encode_decision_c(cb, ctxidxinc_7, 0);
                        }
                        j_0 += 1;
                    }
                    i_5 += step;
