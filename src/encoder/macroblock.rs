...
pub mod macroblock_h {
    pub static mut x264_pred_i4x4_neighbors: [crate::stdlib::uint8_t; 12] = [
        ...
        (crate::src::common::macroblock::MB_LEFT as ::core::ffi::c_int
            | crate::src::common::macroblock::MB_TOP as ::core::ffi::c_int) as crate::stdlib::uint8_t,
    ...
    pub static mut block_idx_xy_fenc: [crate::stdlib::uint8_t; 16] = [
        (0i32 * 4i32 + 0i32 * 4i32 * crate::src::common::common::FENC_STRIDE) as crate::stdlib::uint8_t,
        (1i32 * 4i32 + 0i32 * 4i32 * crate::src::common::common::FENC_STRIDE) as crate::stdlib::uint8_t,
        (0i32 * 4i32 + 1i32 * 4i32 * crate::src::common::common::FENC_STRIDE) as crate::stdlib::uint8_t,
        (1i32 * 4i32 + 1i32 * 4i32 * crate::src::common::common::FENC_STRIDE) as crate::stdlib::uint8_t,
        (2i32 * 4i32 + 0i32 * 4i32 * crate::src::common::common::FENC_STRIDE) as crate::stdlib::uint8_t,
        (3i32 * 4i32 + 0i32 * 4i32 * crate::src::common::common::FENC_STRIDE) as crate::stdlib::uint8_t,
        (2i32 * 4i32 + 1i32 * 4i32 * crate::src::common::common::FENC_STRIDE) as crate::stdlib::uint8_t,
        (3i32 * 4i32 + 1i32 * 4i32 * crate::src::common::common::FENC_STRIDE) as crate::stdlib::uint8_t,
        (0i32 * 4i32 + 2i32 * 4i32 * crate::src::common::common::FENC_STRIDE) as crate::stdlib::uint8_t,
        (1i32 * 4i32 + 2i32 * 4i32 * crate::src::common::common::FENC_STRIDE) as crate::stdlib::uint8_t,
        (0i32 * 4i32 + 3i32 * 4i32 * crate::src::common::common::FENC_STRIDE) as crate::stdlib::uint8_t,
        (1i32 * 4i32 + 3i32 * 4i32 * crate::src::common::common::FENC_STRIDE) as crate::stdlib::uint8_t,
        (2i32 * 4i32 + 2i32 * 4i32 * crate::src::common::common::FENC_STRIDE) as crate::stdlib::uint8_t,
        (3i32 * 4i32 + 2i32 * 4i32 * crate::src::common::common::FENC_STRIDE) as crate::stdlib::uint8_t,
        (2i32 * 4i32 + 3i32 * 4i32 * crate::src::common::common::FENC_STRIDE) as crate::stdlib::uint8_t,
        (3i32 * 4i32 + 3i32 * 4i32 * crate::src::common::common::FENC_STRIDE) as crate::stdlib::uint8_t,
    ];
...
pub mod encoder_macroblock_h {
        ...
        unsafe {
            ...
            if (*h).mb.noise_reduction {
                (*h).quantf.denoise_dct.expect("non-null function pointer")(
                    ...
                    &raw mut *(*h).nr_offset.offset((0i32 + (p != 0) as ::core::ffi::c_int * 2i32) as isize)
            ...
            if (*h).mb.trellis {
                ...
                (*h).quantf.quant_4x4.expect("non-null function pointer")(
                    ...
                    .offset(i_qp as isize) as *mut crate::src::common::common::udctcoef,
            ...
            if (*h).mb.noise_reduction {
                (*h).quantf.denoise_dct.expect("non-null function pointer")(
                    ...
                    &raw mut *(*h)
                        ...
                        as *mut crate::stdlib::uint32_t,
                    &raw mut *(*h).nr_offset.offset((1i32 + (p != 0) as ::core::ffi::c_int * 2i32) as isize)
                        as *mut crate::src::common::common::udctcoef,
                    64i32,
                );
            }
    ...
    pub unsafe extern "C" fn x264_mb_encode_i4x4(
        ...
        unsafe {
            let mut nz = 0;
            let mut dct4x4 = [0; 16];
            let mut p_src = (*(&raw mut (*h).mb.pic.p_fenc as *mut *mut crate::src::common::common::pixel)
                .offset(p as isize))
            .offset(*(&raw const block_idx_xy_fenc as *const crate::stdlib::uint8_t).offset(idx as isize)
                as isize);
            let mut p_dst = (*(&raw mut (*h).mb.pic.p_fdec as *mut *mut crate::src::common::common::pixel)
                .offset(p as isize))
            .offset(*(&raw const block_idx_xy_fdec as *const crate::stdlib::uint16_t).offset(idx as isize)
                as isize);
            if b_predict != 0 {
                if (*h).mb.lossless {
            ...
            if (*h).mb.lossless {
                nz = (*h).zigzagf.sub_4x4.expect("non-null function pointer")(
                    &raw mut *(&raw mut (*h).dct.luma4x4 as *mut [crate::src::common::common::dctcoef; 16])
            ...
            nz = x264_quant_4x4(
                ...
                &raw mut dct4x4 as *mut crate::src::common::common::dctcoef,
                i_qp,
                ctx_cat_plane[crate::src::common::macroblock::DCT_LUMA_4x4 as ::core::ffi::c_int as usize]
        ...
        unsafe {
            ...
            if (*h).mb.lossless {
                nz = (*h).zigzagf.sub_8x8.expect("non-null function pointer")(
                    &raw mut *(&raw mut (*h).dct.luma8x8 as *mut [crate::src::common::common::dctcoef; 64])
                ...
                (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t).offset(
                    (*(&raw const x264_scan8 as *const crate::stdlib::uint8_t)
                        .offset((p * 16i32 + idx * 4i32) as isize) as ::core::ffi::c_int
                        + 0i32) as isize,
            ...
            nz = x264_quant_8x8(
                ...
                &raw mut dct8x8 as *mut crate::src::common::common::dctcoef,
                i_qp,
                ctx_cat_plane[crate::src::common::macroblock::DCT_LUMA_8x8 as ::core::ffi::c_int as usize]
                    [p as usize] as ::core::ffi::c_int,
                1i32,
                p,
                idx,
    ...
    use crate::src::encoder::macroblock::{
        base_h::x264_scan8,
        macroblock_h::{block_idx_xy_fdec, block_idx_xy_fenc, ctx_cat_plane, x264_pred_i4x4_neighbors},
        x264_8_predict_lossless_4x4, x264_8_predict_lossless_8x8,
    };
}
use crate::src::{
    common::{
    ...
    encoder::macroblock::{
        ...
        encoder_macroblock_h::{x264_mb_encode_i4x4, x264_mb_encode_i8x8, x264_quant_4x4, x264_quant_8x8},
        macroblock_h::{
            block_idx_x, block_idx_xy_1d, block_idx_xy_fdec, block_idx_xy_fenc, block_idx_y, block_idx_yx_1d,
            ctx_cat_plane,
        },
...
unsafe extern "C" fn idct_dequant_2x2_dc(
    ...
    unsafe {
        ...
        (*dct4x4.offset(0isize))[0usize] = (((d0 + d1) * dmf) >> 5i32) as crate::src::common::common::dctcoef;
        (*dct4x4.offset(1isize))[0usize] = (((d0 - d1) * dmf) >> 5i32) as crate::src::common::common::dctcoef;
        (*dct4x4.offset(2isize))[0usize] = (((d2 + d3) * dmf) >> 5i32) as crate::src::common::common::dctcoef;
        (*dct4x4.offset(3isize))[0usize] = (((d2 - d3) * dmf) >> 5i32) as crate::src::common::common::dctcoef;
    }
}
#[inline]
        ...
        if crate::osdep_h::WORD_SIZE == 8i32 {
            ...
            while i < i_count {
                ...
                i = (i as ::core::ffi::c_ulong).wrapping_add(
                    (8usize).wrapping_div(::core::mem::size_of::<crate::src::common::common::dctcoef>())
                        as ::core::ffi::c_ulong,
                ) as ::core::ffi::c_int;
            }
        } else {
            let mut i_0 = 0i32;
            while i_0 < i_count {
                if (*(v.offset(i_0 as isize) as *mut crate::src::common::base::x264_union32_t)).i != 0 {
                    return 1i32;
                }
                i_0 = (i_0 as ::core::ffi::c_ulong).wrapping_add(
                    (4usize).wrapping_div(::core::mem::size_of::<crate::src::common::common::dctcoef>())
                        as ::core::ffi::c_ulong,
                ) as ::core::ffi::c_int;
            }
        }
    ...
    unsafe {
        ...
        if (*h).mb.lossless {
            ...
            while i < 16i32 {
                ...
                nz = (*h).zigzagf.sub_4x4ac.expect("non-null function pointer")(
                    ...
                    (&raw mut dct_dc4x4 as *mut crate::src::common::common::dctcoef).offset(
                        *(&raw const block_idx_yx_1d as *const crate::stdlib::uint8_t).offset(i as isize)
                            as isize,
                    ),
                );
            ...
            (*h).mb.cache.non_zero_count
                ...
                array_non_zero(&raw mut dct_dc4x4 as *mut crate::src::common::common::dctcoef, 16i32)
                    as crate::stdlib::uint8_t;
            (*h).zigzagf.scan_4x4.expect("non-null function pointer")(
                &raw mut *(&raw mut (*h).dct.luma16x16_dc as *mut [crate::src::common::common::dctcoef; 16])
            ...
            while idx < 16i32 {
                (*h).quantf.denoise_dct.expect("non-null function pointer")(
                    &raw mut *(&raw mut dct4x4 as *mut [crate::src::common::common::dctcoef; 16])
                        .offset(idx as isize) as *mut crate::src::common::common::dctcoef,
                    &raw mut *(*h).nr_residual_sum.offset(0isize) as *mut crate::stdlib::uint32_t,
                    &raw mut *(*h).nr_offset.offset(0isize) as *mut crate::src::common::common::udctcoef,
                    16i32,
                );
                idx += 1;
            }
        ...
        if (*h).mb.trellis {
            ...
            while idx_1 < 16i32 {
                if crate::src::encoder::analyse::rdo_c::x264_8_quant_4x4_trellis(
                    ...
                    i_quant_cat,
                    i_qp,
                    ctx_cat_plane[crate::src::common::macroblock::DCT_LUMA_AC as ::core::ffi::c_int as usize]
                        [p as usize] as ::core::ffi::c_int,
                    1i32,
                    (p != 0) as ::core::ffi::c_int,
                    idx_1,
                ) != 0
                {
                    ...
                    if decimate_score < 6i32 {
                        decimate_score += (*h).quantf.decimate_score15.expect("non-null function pointer")(
                            &raw mut *(&raw mut (*h).dct.luma4x4
                                as *mut [crate::src::common::common::dctcoef; 16])
                                .offset((16i32 * p + idx_1) as isize)
                                as *mut crate::src::common::common::dctcoef,
                    ...
                    (*h).mb.cache.non_zero_count[x264_scan8[(16i32 * p + idx_1) as usize] as usize] = 1u8;
                }
                idx_1 += 1;
            }
        } else {
            ...
            while i8x8 < 4i32 {
                ...
                if nz != 0 {
                    ...
                    while msk != 0 && {
                        ...
                        if decimate_score < 6i32 {
                            decimate_score +=
                                (*h).quantf.decimate_score15.expect("non-null function pointer")(
                                    &raw mut *(&raw mut (*h).dct.luma4x4
                                        as *mut [crate::src::common::common::dctcoef; 16])
                                        .offset((16i32 * p + idx_2) as isize)
                                        as *mut crate::src::common::common::dctcoef,
                        ...
                        (*h).mb.cache.non_zero_count[x264_scan8[(16i32 * p + idx_2) as usize] as usize] = 1u8;
                        idx_2 += 1;
                    }
                }
                i8x8 += 1;
        ...
        if (*h).mb.trellis {
            nz = crate::src::encoder::analyse::rdo_c::x264_8_quant_luma_dc_trellis(
                ...
                i_quant_cat,
                i_qp,
                ctx_cat_plane[crate::src::common::macroblock::DCT_LUMA_DC as ::core::ffi::c_int as usize]
                    [p as usize] as ::core::ffi::c_int,
                1i32,
            ...
            nz = (*h).quantf.quant_4x4_dc.expect("non-null function pointer")(
                &raw mut dct_dc4x4 as *mut crate::src::common::common::dctcoef,
                (*(*h).quant4_mf[i_quant_cat as usize].offset(i_qp as isize))[0usize] as ::core::ffi::c_int
                    >> 1i32,
        ...
        (*h).mb.cache.non_zero_count[x264_scan8[(crate::src::common::base::LUMA_DC + p) as usize] as usize] =
            nz as crate::stdlib::uint8_t;
        if nz != 0 {
            (*h).zigzagf.scan_4x4.expect("non-null function pointer")(
                &raw mut *(&raw mut (*h).dct.luma16x16_dc as *mut [crate::src::common::common::dctcoef; 16])
            ...
            if block_cbp != 0 {
                let mut i_0 = 0i32;
                while i_0 < 16i32 {
                    dct4x4[i_0 as usize][0usize] = dct_dc4x4[block_idx_xy_1d[i_0 as usize] as usize];
                    i_0 += 1;
                }
            }
        }
...
unsafe extern "C" fn mb_encode_chroma_internal(
    ...
    unsafe {
        ...
        let mut dequant_mf =
            (*h).dequant4_mf[(crate::src::common::set::CQM_4IC as ::core::ffi::c_int + b_inter) as usize];
        (*h).mb.i_cbp_chroma = 0i32;
        let ref mut c2rust_fresh2 = *(*h).nr_count.offset(2isize);
        *c2rust_fresh2 = (*c2rust_fresh2)
            .wrapping_add(((*h).mb.noise_reduction as ::core::ffi::c_int * 4i32) as crate::stdlib::uint32_t);
        (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t)
            .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(16isize) as isize)
            as *mut crate::src::common::base::x264_union16_t))
            .i = 0u16;
        (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t)
            .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(18isize) as isize)
            as *mut crate::src::common::base::x264_union16_t))
            .i = 0u16;
        (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t)
            .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(32isize) as isize)
            as *mut crate::src::common::base::x264_union16_t))
            .i = 0u16;
        (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t)
            .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(34isize) as isize)
            as *mut crate::src::common::base::x264_union16_t))
            .i = 0u16;
        if chroma422 != 0 {
            (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t)
                .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(24isize) as isize)
                as *mut crate::src::common::base::x264_union16_t))
                .i = 0u16;
            (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t)
                .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(26isize) as isize)
                as *mut crate::src::common::base::x264_union16_t))
                .i = 0u16;
            (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t)
                .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(40isize) as isize)
                as *mut crate::src::common::base::x264_union16_t))
                .i = 0u16;
            (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t)
                .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(42isize) as isize)
                as *mut crate::src::common::base::x264_union16_t))
                .i = 0u16;
        }
        if b_decimate && i_qp >= (if (*h).mb.trellis { 12i32 } else { 18i32 }) && !(*h).mb.noise_reduction {
            let mut ssd = [0; 2];
            ...
            ) < thresh * 4i32
            {
                let mut ch = 0i32;
                (*h).mb.cache.non_zero_count
                    [x264_scan8[(crate::src::common::base::CHROMA_DC + 0i32) as usize] as usize] = 0u8;
                (*h).mb.cache.non_zero_count
                    [x264_scan8[(crate::src::common::base::CHROMA_DC + 1i32) as usize] as usize] = 0u8;
                while ch < 2i32 {
                    if ssd[ch as usize] > thresh {
                        ...
                        if (*h).mb.trellis {
                            ...
                            while i <= chroma422 {
                                nz_dc |= (*h).quantf.quant_2x2_dc.expect("non-null function pointer")(
                                    ...
                                    (*(*h).quant4_mf[(crate::src::common::set::CQM_4IC as ::core::ffi::c_int
                                        + b_inter)
                                        as usize]
                            ...
                            ) != 0)
                        {
                            let mut i_0 = 0i32;
                            (*h).mb.cache.non_zero_count
                                [x264_scan8[(crate::src::common::base::CHROMA_DC + ch) as usize] as usize] =
                                1u8;
                            if chroma422 != 0 {
                                zigzag_scan_2x4_dc(
                                ...
                                (*h).quantf.idct_dequant_2x4_dconly.expect("non-null function pointer")(
                                    &raw mut dct_dc as *mut crate::src::common::common::dctcoef,
                                    dequant_mf,
                                    i_qp + 3i32,
                                );
                            ...
                            while i_0 <= chroma422 {
                                (*h).dctf.add8x8_idct_dc.expect("non-null function pointer")(
                                    p_dst.offset(
                                        (8i32 * i_0 * crate::src::common::common::FDEC_STRIDE) as isize,
                                    ),
                                    (&raw mut dct_dc as *mut crate::src::common::common::dctcoef)
        ...
        while ch_0 < 2i32 {
            ...
            if (*h).mb.lossless {
                ...
                while i_1 < (if chroma422 != 0 { 8i32 } else { 4i32 }) {
                    let mut oe =
                        4i32 * (i_1 & 1i32) + 4i32 * (i_1 >> 1i32) * crate::src::common::common::FENC_STRIDE;
                    let mut od =
                        4i32 * (i_1 & 1i32) + 4i32 * (i_1 >> 1i32) * crate::src::common::common::FDEC_STRIDE;
                    nz = (*h).zigzagf.sub_4x4ac.expect("non-null function pointer")(
                        &raw mut *(&raw mut (*h).dct.luma4x4
                            as *mut [crate::src::common::common::dctcoef; 16])
                            .offset(
                    ...
                    (*h).mb.cache.non_zero_count[x264_scan8[(16i32
                        ...
                        + (if chroma422 != 0 { i_1 & 4i32 } else { 0i32 })
                        + ch_0 * 16i32) as usize]
                        as usize] = nz as crate::stdlib::uint8_t;
                ...
                while i_2 <= chroma422 {
                    (*h).dctf.sub8x8_dct.expect("non-null function pointer")(
                        ...
                        p_src_0.offset((8i32 * i_2 * crate::src::common::common::FENC_STRIDE) as isize),
                        p_dst_0.offset((8i32 * i_2 * crate::src::common::common::FDEC_STRIDE) as isize),
                    );
                    i_2 += 1;
                }
                if (*h).mb.noise_reduction {
                    ...
                    while i_3 < (if chroma422 != 0 { 8i32 } else { 4i32 }) {
                        (*h).quantf.denoise_dct.expect("non-null function pointer")(
                            &raw mut *(&raw mut dct4x4 as *mut [crate::src::common::common::dctcoef; 16])
                                .offset(i_3 as isize)
                                as *mut crate::src::common::common::dctcoef,
                            &raw mut *(*h).nr_residual_sum.offset(2isize) as *mut crate::stdlib::uint32_t,
                    ...
                    if (*h).mb.trellis {
                        ...
                        while i4x4 < 4i32 {
                            ...
                            ) != 0
                            {
                                ...
                                (*h).mb.cache.non_zero_count[x264_scan8[idx as usize] as usize] = 1u8;
                                nz_ac = 1i32;
                            }
                            i4x4 += 1;
                        }
                ...
                if i_decimate_score < 7i32 || nz_ac == 0 {
                    (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t).offset(
                        *(&raw const x264_scan8 as *const crate::stdlib::uint8_t)
                            .offset((16i32 + 16i32 * ch_0) as isize) as isize,
                    ) as *mut crate::src::common::base::x264_union16_t))
                        .i = 0u16;
                    (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t).offset(
                        *(&raw const x264_scan8 as *const crate::stdlib::uint8_t)
                            .offset((18i32 + 16i32 * ch_0) as isize) as isize,
                    ) as *mut crate::src::common::base::x264_union16_t))
                        .i = 0u16;
                    if chroma422 != 0 {
                        (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t).offset(
                            *(&raw const x264_scan8 as *const crate::stdlib::uint8_t)
                                .offset((24i32 + 16i32 * ch_0) as isize) as isize,
                        ) as *mut crate::src::common::base::x264_union16_t))
                            .i = 0u16;
                        (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t).offset(
                            *(&raw const x264_scan8 as *const crate::stdlib::uint8_t)
                                .offset((26i32 + 16i32 * ch_0) as isize) as isize,
                        ) as *mut crate::src::common::base::x264_union16_t))
                            .i = 0u16;
                    }
                    if nz_dc != 0 {
                        ...
                        ) == 0
                        {
                            ...
                            while i_5 <= chroma422 {
                                (*h).dctf.add8x8_idct_dc.expect("non-null function pointer")(
                                    p_dst_0.offset(
                                        (8i32 * i_5 * crate::src::common::common::FDEC_STRIDE) as isize,
                                    ),
                                    (&raw mut dct_dc as *mut crate::src::common::common::dctcoef)
                    ...
                    while i_6 <= chroma422 {
                        (*h).dctf.add8x8_idct.expect("non-null function pointer")(
                            p_dst_0.offset((8i32 * i_6 * crate::src::common::common::FDEC_STRIDE) as isize),
                            (&raw mut dct4x4 as *mut [crate::src::common::common::dctcoef; 16])
...
unsafe extern "C" fn macroblock_encode_skip(mut h: *mut crate::src::common::common::x264_t) {
    unsafe {
        ...
        (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t)
            ...
            .i = 0u32;
        (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t)
            .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset((16i32 + 0i32) as isize)
                as isize) as *mut crate::src::common::base::x264_union32_t))
            .i = 0u32;
        (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t)
            .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset((16i32 + 2i32) as isize)
                as isize) as *mut crate::src::common::base::x264_union32_t))
            .i = 0u32;
        (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t)
            .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset((32i32 + 0i32) as isize)
                as isize) as *mut crate::src::common::base::x264_union32_t))
            .i = 0u32;
        (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t)
            .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset((32i32 + 2i32) as isize)
                as isize) as *mut crate::src::common::base::x264_union32_t))
            .i = 0u32;
    ...
    unsafe {
        ...
        if i_mode == crate::src::common::predict::I_PRED_CHROMA_V as ::core::ffi::c_int {
            (*h).mc.copy[crate::src::common::pixel::PIXEL_8x8 as ::core::ffi::c_int as usize]
                ...
                (*h).mb.pic.p_fenc[1usize].offset(-(crate::src::common::common::FENC_STRIDE as isize)),
            ...
            (*h).mc.copy[crate::src::common::pixel::PIXEL_8x8 as ::core::ffi::c_int as usize]
                ...
                crate::src::common::common::FDEC_STRIDE as crate::stdlib::intptr_t,
                (*h).mb.pic.p_fenc[2usize].offset(-(crate::src::common::common::FENC_STRIDE as isize)),
                crate::src::common::common::FENC_STRIDE as crate::stdlib::intptr_t,
                height,
            );
            crate::stdlib::memcpy(
            ...
            crate::src::common::macroblock::x264_8_copy_column8(
                (*h).mb.pic.p_fdec[1usize].offset((4i32 * crate::src::common::common::FDEC_STRIDE) as isize),
                (*h).mb.pic.p_fdec[1usize]
                    .offset((4i32 * crate::src::common::common::FDEC_STRIDE) as isize)
                    .offset(-(1isize)),
            );
            crate::src::common::macroblock::x264_8_copy_column8(
                (*h).mb.pic.p_fdec[2usize].offset((4i32 * crate::src::common::common::FDEC_STRIDE) as isize),
                (*h).mb.pic.p_fdec[2usize]
                    .offset((4i32 * crate::src::common::common::FDEC_STRIDE) as isize)
                    .offset(-(1isize)),
            );
...
pub unsafe extern "C" fn x264_8_predict_lossless_4x4(
    ...
    unsafe {
        let mut stride = (*(*h).fenc).i_stride[p as usize] << (*h).mb.interlaced as ::core::ffi::c_int;
        ...
        if i_mode == crate::src::common::predict::I_PRED_4x4_V as ::core::ffi::c_int {
            ...
            crate::stdlib::memcpy(
                ...
                p_dst.offset(-(crate::src::common::common::FDEC_STRIDE as isize))
                    as *const ::core::ffi::c_void,
                (4i32 * crate::src::common::common::SIZEOF_PIXEL) as crate::__stddef_size_t_h::size_t,
            );
    ...
    unsafe {
        ...
        if (*h).mb.ty == MacroblockType::P_SKIP {
            if !(*h).mb.skip_mc {
                ...
                let mut mvx = x264_clip3(
                    (*h).mb.cache.mv[0usize][x264_scan8[0usize] as usize][0usize] as ::core::ffi::c_int,
                    (*h).mb.mv_min[0usize],
                    (*h).mb.mv_max[0usize],
                );
                let mut mvy = x264_clip3(
                    (*h).mb.cache.mv[0usize][x264_scan8[0usize] as usize][1usize] as ::core::ffi::c_int,
                    (*h).mb.mv_min[1usize],
                    (*h).mb.mv_max[1usize],
                );
                ...
                if chroma != 0 {
                    ...
                    if !(*h).sh.weight[0usize][1usize].weightfn.is_null() {
                        (*(*h).sh.weight[0usize][1usize].weightfn.offset((8i32 >> 2i32) as isize))
                            .expect("non-null function pointer")(
                            (*h).mb.pic.p_fdec[1usize],
                            crate::src::common::common::FDEC_STRIDE as crate::stdlib::intptr_t,
                            (*h).mb.pic.p_fdec[1usize],
                    ...
                    if !(*h).sh.weight[0usize][2usize].weightfn.is_null() {
                        (*(*h).sh.weight[0usize][2usize].weightfn.offset((8i32 >> 2i32) as isize))
                            .expect("non-null function pointer")(
                            (*h).mb.pic.p_fdec[2usize],
                            crate::src::common::common::FDEC_STRIDE as crate::stdlib::intptr_t,
                            (*h).mb.pic.p_fdec[2usize],
        ...
        if (*h).mb.ty == MacroblockType::I_16x16 {
            ...
            while p_3 < plane_count {
                let mut i = if p_3 == 0i32 && (*h).mb.i_skip_intra != 0 { 3i32 } else { 0i32 };
                while i < 4i32 {
            ...
            while p_4 < plane_count {
                let mut i_0 = if p_4 == 0i32 && (*h).mb.i_skip_intra != 0 { 15i32 } else { 0i32 };
                while i_0 < 16i32 {
                    let mut p_dst = (*(&raw mut (*h).mb.pic.p_fdec
                        as *mut *mut crate::src::common::common::pixel)
                        .offset(p_4 as isize))
                    .offset(
                        *(&raw const block_idx_xy_fdec as *const crate::stdlib::uint16_t).offset(i_0 as isize)
                            as isize,
                    );
                    let mut i_mode_0 = (*h).mb.cache.intra4x4_pred_mode[x264_scan8[i_0 as usize] as usize]
                        as ::core::ffi::c_int;
            ...
            if (*h).mb.lossless {
                        ...
                        while i4x4 < 16i32 {
                            nz = (*h).zigzagf.sub_4x4.expect("non-null function pointer")(
                                ...
                                (*h).mb.pic.p_fenc[p_6 as usize]
                                    .offset(block_idx_xy_fenc[i4x4 as usize] as ::core::ffi::c_int as isize),
                                (*h).mb.pic.p_fdec[p_6 as usize]
                                    .offset(block_idx_xy_fdec[i4x4 as usize] as ::core::ffi::c_int as isize),
                            );
                            (*h).mb.cache.non_zero_count
                ...
                while p_7 < plane_count {
                    ...
                    (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t).offset(
                        (*(&raw const x264_scan8 as *const crate::stdlib::uint8_t)
                            .offset((16i32 * p_7) as isize) as ::core::ffi::c_int
                            + 0i32 * 8i32) as isize,
                    ) as *mut crate::src::common::base::x264_union32_t))
                        .i = 0u32;
                    (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t).offset(
                    ...
                    let ref mut c2rust_fresh0 =
                        *(*h).nr_count.offset((1i32 + (p_7 != 0) as ::core::ffi::c_int * 2i32) as isize);
                    *c2rust_fresh0 = (*c2rust_fresh0).wrapping_add(
                    ...
                    while idx < 4i32 {
                        nz = x264_quant_8x8(
                            h,
                            &raw mut *(&raw mut dct8x8 as *mut [crate::src::common::common::dctcoef; 64])
                                .offset(idx as isize)
                                as *mut crate::src::common::common::dctcoef,
                            i_qp,
                            ctx_cat_plane
                                [crate::src::common::macroblock::DCT_LUMA_8x8 as ::core::ffi::c_int as usize]
                                [p_7 as usize] as ::core::ffi::c_int,
                            0i32,
                            p_7,
                            idx,
                        );
                    ...
                    if i_decimate_mb >= 6i32 || !b_decimate {
                        ...
                        while msk != 0 && {
                            ...
                            (*h).dctf.add8x8_idct8.expect("non-null function pointer")(
                                ...
                                .offset(
                                    (8i32 * (idx_0 & 1i32)
                                        + 8i32 * (idx_0 >> 1i32) * crate::src::common::common::FDEC_STRIDE)
                                        as isize,
                                ),
                                &raw mut *(&raw mut dct8x8 as *mut [crate::src::common::common::dctcoef; 64])
                                    .offset(idx_0 as isize)
                ...
                while p_8 < plane_count {
                    ...
                    (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t).offset(
                        (*(&raw const x264_scan8 as *const crate::stdlib::uint8_t)
                            .offset((16i32 * p_8) as isize) as ::core::ffi::c_int
                            + 0i32 * 8i32) as isize,
                    ) as *mut crate::src::common::base::x264_union32_t))
                        .i = 0u32;
                    (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t).offset(
                    ...
                    if (*h).mb.noise_reduction {
                        ...
                        let ref mut c2rust_fresh1 =
                            *(*h).nr_count.offset((0i32 + (p_8 != 0) as ::core::ffi::c_int * 2i32) as isize);
                            ...
                            while i4x4_0 < 4i32 {
                                ...
                                ) != 0
                                {
                                    ...
                                    if i_decimate_8x8_0 < 6i32 {
                                        i_decimate_8x8_0 +=
                                            (*h).quantf.decimate_score16.expect("non-null function pointer")(
                                                &raw mut *(&raw mut (*h).dct.luma4x4
                                                    as *mut [crate::src::common::common::dctcoef; 16])
                                                    .offset((p_8 * 16i32 + idx_2) as isize)
                                                    as *mut crate::src::common::common::dctcoef,
                    ...
                    if i_decimate_mb < 6i32 {
                        ...
                        while msk_1 != 0 && {
                            ...
                            (*h).dctf.add8x8_idct.expect("non-null function pointer")(
                                ...
                                .offset(
                                    ((i8x8_1 & 1i32) * 8i32
                                        + (i8x8_1 >> 1i32) * 8i32 * crate::src::common::common::FDEC_STRIDE)
                                        as isize,
                                ),
                                (&raw mut dct4x4 as *mut [crate::src::common::common::dctcoef; 16])
        ...
        if b_force_no_skip == 0 {
            if (*h).mb.ty == MacroblockType::P_L0
                ...
                && (*(&raw mut *(&raw mut *(&raw mut (*h).mb.cache.mv
                    ...
                    as *mut crate::src::common::base::x264_union32_t))
                    .i
                    == (*(&raw mut (*h).mb.cache.pskip_mv as *mut crate::src::common::base::x264_union32_t)).i
                && (*h).mb.cache.ref_0[0usize][x264_scan8[0usize] as usize] as ::core::ffi::c_int == 0i32
            {
                (*h).mb.ty = MacroblockType::P_SKIP;
            }
            if (*h).mb.ty == MacroblockType::B_DIRECT && (*h).mb.i_cbp_luma | (*h).mb.i_cbp_chroma == 0 {
    ...
    unsafe {
        ...
        while p < plane_count {
            ...
            if b_bidir == 0 {
                ...
                (*h).mc.mc_luma.expect("non-null function pointer")(
                    ...
                    (&raw mut *(&raw mut *(&raw mut (*h).mb.pic.p_fref
                        ...
                        .offset(0isize)
                        as *mut [*mut crate::src::common::common::pixel; 12])
                        .offset(0isize) as *mut *mut crate::src::common::common::pixel)
            ...
            while i8x8 < 4i32 {
                let mut idx = 0i32;
                let mut fenc_offset =
                    (i8x8 & 1i32) * 8i32 + (i8x8 >> 1i32) * crate::src::common::common::FENC_STRIDE * 8i32;
                let mut fdec_offset =
                    (i8x8 & 1i32) * 8i32 + (i8x8 >> 1i32) * crate::src::common::common::FDEC_STRIDE * 8i32;
                (*h).dctf.sub8x8_dct.expect("non-null function pointer")(
                    &raw mut dct4x4 as *mut [crate::src::common::common::dctcoef; 16],
        ...
        if chroma.is_420() || chroma.is_422() {
            ...
            while ch < 2i32 {
                ...
                let mut p_src = (*h).mb.pic.p_fenc[(1i32 + ch) as usize];
                let mut p_dst = (*h).mb.pic.p_fdec[(1i32 + ch) as usize];
                if b_bidir == 0 && !(*h).sh.weight[0usize][(1i32 + ch) as usize].weightfn.is_null() {
                    (*(*h).sh.weight[0usize][(1i32 + ch) as usize].weightfn.offset((8i32 >> 2i32) as isize))
                        .expect("non-null function pointer")(
                ...
                if ssd >= thresh {
                    ...
                    if (*h).mb.noise_reduction {
                        ...
                        while i <= chroma422 {
                            (*h).dctf.sub8x8_dct.expect("non-null function pointer")(
                                (&raw mut dct4x4 as *mut [crate::src::common::common::dctcoef; 16])
                                    .offset((4i32 * i) as isize),
                                p_src.offset((8i32 * i * crate::src::common::common::FENC_STRIDE) as isize),
                                p_dst.offset((8i32 * i * crate::src::common::common::FDEC_STRIDE) as isize),
                            );
                            i += 1;
                        }
                    ...
                    while i_0 <= chroma422 {
                        if (*h).quantf.quant_2x2_dc.expect("non-null function pointer")(
                            (&raw mut dct_dc as *mut crate::src::common::common::dctcoef)
                                .offset((4i32 * i_0) as isize),
                            (*(*h).quant4_mf[crate::src::common::set::CQM_4PC as ::core::ffi::c_int as usize]
                                .offset((i_qp + 3i32 * chroma422) as isize))[0usize]
                                as ::core::ffi::c_int
                                >> 1i32,
                            ((*(*h).quant4_bias
                    ...
                    if ssd >= thresh * 4i32 {
                        ...
                        if !(*h).mb.noise_reduction {
                            ...
                            while i_1 <= chroma422 {
                                (*h).dctf.sub8x8_dct.expect("non-null function pointer")(
                                    ...
                                    p_src.offset(
                                        (8i32 * i_1 * crate::src::common::common::FENC_STRIDE) as isize,
                                    ),
                                    p_dst.offset(
                                        (8i32 * i_1 * crate::src::common::common::FDEC_STRIDE) as isize,
                                    ),
                                );
                        ...
                        while i8x8_0 < (if chroma422 != 0 { 2i32 } else { 1i32 }) {
                            let mut nz_0 = (*h).quantf.quant_4x4x4.expect("non-null function pointer")(
                                (&raw mut dct4x4 as *mut [crate::src::common::common::dctcoef; 16])
                                    .offset((i8x8_0 * 4i32) as isize),
                                &raw mut *(*(&raw mut (*h).quant4_mf
                                    as *mut *mut [crate::src::common::common::udctcoef; 16])
                                    .offset(crate::src::common::set::CQM_4PC as ::core::ffi::c_int as isize))
                                .offset(i_qp as isize)
                                    as *mut crate::src::common::common::udctcoef,
                                &raw mut *(*(&raw mut (*h).quant4_bias
                                    as *mut *mut [crate::src::common::common::udctcoef; 16])
...
pub unsafe extern "C" fn x264_8_noise_reduction_update(mut h: *mut crate::src::common::common::x264_t) {
    unsafe {
        let mut cat = 0i32;
        (*h).nr_offset = &raw mut (*h).nr_offset_denoise as *mut [crate::src::common::common::udctcoef; 64];
        ...
        while cat < 3i32 + ((*h).sps.i_chroma_format_idc.is_444()) as ::core::ffi::c_int {
            ...
            let mut weight = if dct8x8 != 0 {
                &raw const crate::src::common::tables::x264_dct8_weight2_tab as *const crate::stdlib::uint32_t
            } else {
                &raw const crate::src::common::tables::x264_dct4_weight2_tab as *const crate::stdlib::uint32_t
            };
            if *(*h).nr_count.offset(cat as isize)
                > (if dct8x8 != 0 { (1i32) << 16i32 } else { (1i32) << 18i32 }) as crate::stdlib::uint32_t
            {
                let mut i = 0i32;
                while i < size {
            ...
            while i_0 < size {
                (*(*h).nr_offset.offset(cat as isize))[i_0 as usize] =
                    ((*h).param.analyse.i_noise_reduction as crate::stdlib::uint64_t)
                        .wrapping_mul(*(*h).nr_count.offset(cat as isize) as crate::stdlib::uint64_t)
                        .wrapping_add(
                            (*(*h).nr_residual_sum.offset(cat as isize))[i_0 as usize].wrapping_div(2u32)
        ...
        if (*h).mb.lossless {
            ...
            while p < plane_count {
                ...
                if (*h).mb.transform_8x8 {
                    ...
                    while i4 < i8 * 4i32 + 4i32 {
                        ...
                        (*h).mb.cache.non_zero_count[x264_scan8[(16i32 * p + i4) as usize] as usize] =
                            nz as crate::stdlib::uint8_t;
                        nnz8x8 |= nz;
                        i4 += 1;
                    }
            ...
            if chroma.is_420() || chroma.is_422() {
                ...
                while ch < 2i32 {
                    let mut i4x4 = 0i32;
                    let mut p_fenc_0 =
                        (*h).mb.pic.p_fenc[(1i32 + ch) as usize].offset((4i32 * x) as isize).offset(
                            ((if chroma422 != 0 { 8i32 } else { 4i32 })
                                * y
                    ...
                    let mut p_fdec_0 =
                        (*h).mb.pic.p_fdec[(1i32 + ch) as usize].offset((4i32 * x) as isize).offset(
                            ((if chroma422 != 0 { 8i32 } else { 4i32 })
                                * y
                    ...
                    while i4x4 <= chroma422 {
                        let mut dc = 0;
                        let mut offset = if chroma422 != 0 { 8i32 * y + 2i32 * i4x4 + x } else { i8 };
                        nz = (*h).zigzagf.sub_4x4ac.expect("non-null function pointer")(
                            &raw mut *(&raw mut (*h).dct.luma4x4
                                as *mut [crate::src::common::common::dctcoef; 16])
                                .offset((16i32 + offset + ch * 16i32) as isize)
                                as *mut crate::src::common::common::dctcoef,
                            p_fenc_0.offset((4i32 * i4x4 * crate::src::common::common::FENC_STRIDE) as isize),
                            p_fdec_0.offset((4i32 * i4x4 * crate::src::common::common::FDEC_STRIDE) as isize),
                            &raw mut dc,
                        );
                        (*h).mb.cache.non_zero_count
            ...
            if (*h).mb.transform_8x8 {
                ...
                while p_0 < plane_count {
                    ...
                    let mut nnz8x8_0 = x264_quant_8x8(
                        ...
                        ctx_cat_plane
                            [crate::src::common::macroblock::DCT_LUMA_8x8 as ::core::ffi::c_int as usize]
                            [p_0 as usize] as ::core::ffi::c_int,
                        0i32,
                        p_0,
                        i8,
                    );
                    ...
                    if (*h).mb.noise_reduction {
                        ...
                        while idx < 4i32 {
                            (*h).quantf.denoise_dct.expect("non-null function pointer")(
                                ...
                                &raw mut *(*h)
                                    .nr_residual_sum
                                    .offset((0i32 + (p_1 != 0) as ::core::ffi::c_int * 2i32) as isize)
                                    as *mut crate::stdlib::uint32_t,
                                &raw mut *(*h)
                                    .nr_offset
                                    .offset((0i32 + (p_1 != 0) as ::core::ffi::c_int * 2i32) as isize)
                    ...
                    if (*h).mb.trellis {
                        ...
                        while i4x4_0 < 4i32 {
                            ...
                            ) != 0
                            {
                                ...
                                (*h).mb.cache.non_zero_count
                                    [x264_scan8[(p_1 * 16i32 + i8 * 4i32 + i4x4_0) as usize] as usize] = 1u8;
                                nnz8x8_1 = 1i32;
                            }
                            i4x4_0 += 1;
                        }
                        ...
                        if nz != 0 {
                            ...
                            while msk != 0 && {
                                ...
                                (*h).mb.cache.non_zero_count
                                    [x264_scan8[(p_1 * 16i32 + i8 * 4i32 + i4x4_1) as usize] as usize] = 1u8;
                                i4x4_1 += 1;
                            }
                        }
                    }
            ...
            if chroma.is_420() || chroma.is_422() {
                ...
                while ch_0 < 2i32 {
                    let mut i4x4_2 = 0i32;
                    let mut p_fenc_3 =
                        (*h).mb.pic.p_fenc[(1i32 + ch_0) as usize].offset((4i32 * x) as isize).offset(
                            ((if chroma422 != 0 { 8i32 } else { 4i32 })
                                * y
                                * crate::src::common::common::FENC_STRIDE)
                                as isize,
                    ...
                    let mut p_fdec_3 =
                        (*h).mb.pic.p_fdec[(1i32 + ch_0) as usize].offset((4i32 * x) as isize).offset(
                            ((if chroma422 != 0 { 8i32 } else { 4i32 })
                                * y
                                * crate::src::common::common::FDEC_STRIDE)
                                as isize,
                    ...
                    while i4x4_2 <= chroma422 {
                        ...
                        (*h).dctf.sub4x4_dct.expect("non-null function pointer")(
                            &raw mut *(&raw mut dct4x4_0 as *mut [crate::src::common::common::dctcoef; 16])
                                .offset(i4x4_2 as isize)
                                as *mut crate::src::common::common::dctcoef,
                            p_fenc_3
                                .offset((4i32 * i4x4_2 * crate::src::common::common::FENC_STRIDE) as isize),
                            p_fdec_3
                                .offset((4i32 * i4x4_2 * crate::src::common::common::FDEC_STRIDE) as isize),
                        );
                        if (*h).mb.noise_reduction {
                            (*h).quantf.denoise_dct.expect("non-null function pointer")(
                        ...
                        let mut offset_0 =
                            if chroma422 != 0 { ((5i32 * i8) & 0x9i32) + 2i32 * i4x4_2 } else { i8 };
                        (*h).mb.cache.non_zero_count
...
unsafe extern "C" fn macroblock_encode_p4x4_internal(
    ...
    unsafe {
        ...
        while p < plane_count {
            ...
            let mut p_fenc = (*(&raw mut (*h).mb.pic.p_fenc as *mut *mut crate::src::common::common::pixel)
                .offset(p as isize))
            .offset(
                *(&raw const block_idx_xy_fenc as *const crate::stdlib::uint8_t).offset(i4 as isize) as isize
            );
            let mut p_fdec = (*(&raw mut (*h).mb.pic.p_fdec as *mut *mut crate::src::common::common::pixel)
                .offset(p as isize))
