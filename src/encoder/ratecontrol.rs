...
pub mod base_h {
    ...
    use crate::src::common::tables::x264_exp2_lut;
    use crate::src::common::tables::x264_log2_lut;
    use crate::src::common::tables::x264_log2_lz_lut;
...
pub use crate::src::common::base::x264_reduce_fraction64;
...
pub use crate::src::encoder::ratecontrol::base_h::slice_type_to_char;
pub use crate::src::encoder::ratecontrol::base_h::x264_clip3;
pub use crate::src::encoder::ratecontrol::base_h::x264_clip3f;
pub use crate::src::encoder::ratecontrol::base_h::x264_exp2fix8;
pub use crate::src::encoder::ratecontrol::base_h::x264_log2;
...
pub use crate::src::common::macroblock::x264_8_prefetch_fenc;
...
pub use crate::src::common::mc::x264_mc_functions_t_20;
pub use crate::src::common::mc::x264_weight_t;
pub use crate::src::encoder::ratecontrol::osdep_h::x264_is_regular_file;
use crate::stdlib::ceil;
use crate::stdlib::exp;
use crate::stdlib::fabs;
use crate::stdlib::log;
use crate::stdlib::log2;
...
use crate::src::encoder::analyse::slicetype_c::x264_8_rc_analyse_slice;
use crate::src::encoder::encoder::x264_8_encoder_reconfig_apply;
use crate::stdlib::fstat;
...
pub use crate::src::common::base::x264_param_parse;
...
pub use crate::x264_h::X264_AQ_AUTOVARIANCE_BIASED;
...
unsafe extern "C" fn ac_energy_mb(
    ...
    unsafe {
        ...
        if (*h).mb.b_adaptive_mbaff != 0 {
            let mut var_interlaced: crate::stdlib::uint32_t = 0;
            let mut var_progressive: crate::stdlib::uint32_t = 0;
...
unsafe extern "C" fn macroblock_tree_rescale(
    ...
    unsafe {
        let mut input: *mut ::core::ffi::c_float = ::core::ptr::null_mut::<::core::ffi::c_float>();
        let mut output: *mut ::core::ffi::c_float = ::core::ptr::null_mut::<::core::ffi::c_float>();
                ...
                if !(*rc).pred_b_from_p.is_null() {
                    ...
                    if (*h).param.rc.b_stat_read != 0 {
                        ...
                        let mut stats_in: *mut ::core::ffi::c_char =
                            ::core::ptr::null_mut::<::core::ffi::c_char>();
                        let mut stats_buf: *mut ::core::ffi::c_char =
                            ::core::ptr::null_mut::<::core::ffi::c_char>();
                        '_c2rust_label: {
                        ...
                        *stats_in = '\0' as i32 as ::core::ffi::c_char;
                        ...
                        res_factor_bits = crate::stdlib::powf(res_factor, 0.7f32);
                            ...
                            if (*rc).entry_out.is_null() {
                                ...
                                while i_2 < (*rc).num_entries {
                                    let mut rce_0: *mut ratecontrol_entry_t =
                                        ::core::ptr::null_mut::<ratecontrol_entry_t>();
                                    ...
                                    rce_0 = (*rc).entry.offset(frame_number as isize)
                                        as *mut ratecontrol_entry_t;
                    ...
                    match c2rust_current_block {
                        ...
                        _ => {
                            if (*h).param.rc.b_stat_write != 0 {
                                ...
                                p_0 = crate::src::common::base::x264_param2string(
...
unsafe extern "C" fn parse_zones(
    ...
    unsafe {
        ...
        if !(*h).param.rc.psz_zones.is_null() && (*h).param.rc.i_zones == 0 {
            let mut psz_zones: *mut ::core::ffi::c_char =
                ::core::ptr::null_mut::<::core::ffi::c_char>();
            let mut p: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
            psz_zones = crate::src::common::base::x264_malloc(
...
unsafe extern "C" fn vbv_pass2(
    ...
    unsafe {
        let mut rcc: *mut x264_ratecontrol_t = (*h).rc;
        let mut fills: *mut ::core::ffi::c_double =
        ...
        fills = crate::src::common::base::x264_malloc(
...
unsafe extern "C" fn init_pass2(
    ...
    unsafe {
        ...
        let mut qscale: *mut ::core::ffi::c_double =
            ::core::ptr::null_mut::<::core::ffi::c_double>();
        ...
        qscale = crate::src::common::base::x264_malloc(
