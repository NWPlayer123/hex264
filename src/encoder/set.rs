pub mod bitstream_h {
    ...
    use crate::src::encoder::set::osdep_h::{endian_fix, endian_fix32};
}
pub mod osdep_h {
    #[inline(always)]
...
pub mod macroblock_h {
    ...
    pub static mut x264_zigzag_scan8: [[crate::stdlib::uint8_t; 64]; 2] = [
        [
            0u8, 8u8, 1u8, 2u8, 9u8, 16u8, 24u8, 17u8, 10u8, 3u8, 4u8, 11u8, 18u8, 25u8, 32u8, 40u8, 33u8,
            26u8, 19u8, 12u8, 5u8, 6u8, 13u8, 20u8, 27u8, 34u8, 41u8, 48u8, 56u8, 49u8, 42u8, 35u8, 28u8,
            21u8, 14u8, 7u8, 15u8, 22u8, 29u8, 36u8, 43u8, 50u8, 57u8, 58u8, 51u8, 44u8, 37u8, 30u8, 23u8,
            31u8, 38u8, 45u8, 52u8, 59u8, 60u8, 53u8, 46u8, 39u8, 47u8, 54u8, 61u8, 62u8, 55u8, 63u8,
        ],
        [
            0u8, 1u8, 2u8, 8u8, 9u8, 3u8, 4u8, 10u8, 16u8, 11u8, 5u8, 6u8, 7u8, 12u8, 17u8, 24u8, 18u8, 13u8,
            14u8, 15u8, 19u8, 25u8, 32u8, 26u8, 20u8, 21u8, 22u8, 23u8, 27u8, 33u8, 40u8, 34u8, 28u8, 29u8,
            30u8, 31u8, 35u8, 41u8, 48u8, 42u8, 36u8, 37u8, 38u8, 39u8, 43u8, 49u8, 50u8, 44u8, 45u8, 46u8,
            47u8, 51u8, 56u8, 57u8, 52u8, 53u8, 54u8, 55u8, 58u8, 59u8, 60u8, 61u8, 62u8, 63u8,
        ],
    ];
}
use crate::{
    src::{
        common::base::ChromaFormat,
        encoder::set::{
            bitstream_h::{
                bs_align_10, bs_flush, bs_init, bs_pos, bs_rbsp_trailing, bs_realign, bs_size_se, bs_write,
                bs_write_se, bs_write_ue_big, bs_write1, bs_write32,
            },
            macroblock_h::{x264_zigzag_scan4, x264_zigzag_scan8},
        },
    },
    x264_h::X264_CSP_BGR,
};
...
static mut num_clock_ts: [crate::stdlib::uint8_t; 10] = [0u8, 1u8, 1u8, 1u8, 2u8, 2u8, 3u8, 3u8, 2u8, 3u8];
static mut avcintra_uuid: [crate::stdlib::uint8_t; 16] = [
    0xF7u8, 0x49u8, 0x3Eu8, 0xB3u8, 0xD4u8, 0u8, 0x47u8, 0x96u8, 0x86u8, 0x86u8, 0xC9u8, 0x70u8, 0x7Bu8,
    0x64u8, 0x37u8, 0x2Au8,
];
...
unsafe extern "C" fn scaling_list_write(
    ...
    unsafe {
        ...
        let mut zigzag = if idx < 4i32 {
            &raw const *(&raw const x264_zigzag_scan4 as *const [crate::stdlib::uint8_t; 16]).offset(0isize)
                as *const crate::stdlib::uint8_t
        } else {
            &raw const *(&raw const x264_zigzag_scan8 as *const [crate::stdlib::uint8_t; 64]).offset(0isize)
                as *const crate::stdlib::uint8_t
        };
        ...
        let mut def_list = if idx == crate::src::common::set::CQM_4IC as ::core::ffi::c_int {
            ...
            sps.scaling_list[(crate::src::common::set::CQM_8IY as ::core::ffi::c_int + 4i32) as usize]
        } else if idx == crate::src::common::set::CQM_8PC as ::core::ffi::c_int + 4i32 {
            sps.scaling_list[(crate::src::common::set::CQM_8PY as ::core::ffi::c_int + 4i32) as usize]
        } else {
        ...
        ) == 0
        {
            ...
            let mut run = len;
            while run > 1i32 {
                if *list.offset(*zigzag.offset((run - 1i32) as isize) as isize) as ::core::ffi::c_int
                    != *list.offset(*zigzag.offset((run - 2i32) as isize) as isize) as ::core::ffi::c_int
                {
                    break;
                }
                run -= 1;
            ...
            while j < run {
                bs_write_se(
                    ...
                    (*list.offset(*zigzag.offset(j as isize) as isize) as ::core::ffi::c_int
                        - (if j > 0i32 {
                            *list.offset(*zigzag.offset((j - 1i32) as isize) as isize) as ::core::ffi::c_int
                        } else {
                            8i32
                        })) as crate::stdlib::int8_t as ::core::ffi::c_int,
                );
...
pub unsafe extern "C" fn x264_8_sei_write(
    ...
    unsafe {
        ...
        while i < payload_size {
            bs_write(s, 8i32, *payload.offset(i as isize) as crate::stdlib::uint32_t);
            i += 1;
        }
        bs_rbsp_trailing(s);
        bs_flush(s);
...
pub unsafe extern "C" fn x264_8_sps_init(
    ...
    unsafe {
        ...
        sps.qpprime_y_zero_transform_bypass =
        ...
        if sps.qpprime_y_zero_transform_bypass || sps.i_chroma_format_idc.is_444() {
            sps.i_profile_idc = crate::src::common::base::PROFILE_HIGH444_PREDICTIVE as ::core::ffi::c_int;
        ...
        sps.i_num_ref_frames = if (16i32)
            < (if (*param).i_frame_reference
                > (if 1i32 + sps.vui.i_num_reorder_frames
                    > (if (if (*param).i_bframe_pyramid != 0 { 4i32 } else { 1i32 }) > (*param).i_dpb_size {
                        if (*param).i_bframe_pyramid != 0 { 4i32 } else { 1i32 }
                    } else {
                        (*param).i_dpb_size
                    })
                {
        ...
        {
            1i32 + sps.vui.i_num_reorder_frames
        } else if (if (*param).i_bframe_pyramid != 0 { 4i32 } else { 1i32 }) > (*param).i_dpb_size {
            if (*param).i_bframe_pyramid != 0 { 4i32 } else { 1i32 }
        } else {
            (*param).i_dpb_size
        };
        ...
        sps.i_num_ref_frames -=
            ((*param).i_bframe_pyramid == crate::x264_h::X264_B_PYRAMID_STRICT) as ::core::ffi::c_int;
        if (*param).i_keyint_max == 1i32 {
        ...
        if (*param).intra_refresh {
            let mut time_to_recovery = (if (sps.i_mb_width - 1i32) < (*param).i_keyint_max {
                ...
                - 1i32;
            max_frame_num =
                if max_frame_num > time_to_recovery + 1i32 { max_frame_num } else { time_to_recovery + 1i32 };
        }
        sps.i_log2_max_frame_num = 4i32;
        while (1i32) << sps.i_log2_max_frame_num <= max_frame_num {
            sps.i_log2_max_frame_num += 1;
        }
        sps.i_poc_type = if (*param).i_bframe != 0 || (*param).interlaced || (*param).i_avcintra_class != 0 {
            0i32
        } else {
            2i32
        };
        ...
        sps.vui.overscan_info_present = (*param).vui.i_overscan > 0i32 && (*param).vui.i_overscan <= 2i32;
        if sps.vui.overscan_info_present {
            sps.vui.overscan_info = if (*param).vui.i_overscan == 2i32 { true } else { false };
        }
        sps.vui.signal_type_present = false;
        sps.vui.i_vidformat = if (*param).vui.i_vidformat >= 0i32 && (*param).vui.i_vidformat <= 5i32 {
            (*param).vui.i_vidformat
        } else {
            5i32
        };
        sps.vui.fullrange = (*param).vui.fullrange.unwrap_or_else(|| csp >= X264_CSP_BGR);
        sps.vui.color_description_present = false;
        sps.vui.i_colorprim = if (*param).vui.i_colorprim >= 0i32 && (*param).vui.i_colorprim <= 12i32 {
        ...
        sps.vui.i_colmatrix = if (*param).vui.i_colmatrix >= 0i32 && (*param).vui.i_colmatrix <= 14i32 {
        ...
        sps.vui.timing_info_present = (*param).i_timebase_num > 0u32 && (*param).i_timebase_den > 0u32;
...
pub unsafe extern "C" fn x264_8_sps_init_reconfigurable(
    ...
    unsafe {
        ...
        sps.crop.i_bottom = (*param).crop_rect.i_bottom + sps.i_mb_height * 16i32 - (*param).i_height;
        sps.has_crop =
            sps.crop.i_left != 0 || sps.crop.i_top != 0 || sps.crop.i_right != 0 || sps.crop.i_bottom != 0;
    ...
    unsafe {
        match sps.i_cqm_preset {
            crate::x264_h::X264_CQM_FLAT => {
                let mut i = 0i32;
                while i < 8i32 {
                    sps.scaling_list[i as usize] = &raw const crate::src::common::tables::x264_cqm_flat16
                        as *const crate::stdlib::uint8_t;
                    i += 1;
                }
            }
            crate::x264_h::X264_CQM_JVT_1 => {
                let mut i_0 = 0i32;
                while i_0 < 8i32 {
                    sps.scaling_list[i_0 as usize] = crate::src::common::tables::x264_cqm_jvt[i_0 as usize];
                    i_0 += 1;
                }
            }
            crate::x264_h::X264_CQM_CUSTOM_1 => {
                let mut i_1 = 0i32;
                transpose(&raw mut (*param).cqm_4iy as *mut crate::stdlib::uint8_t, 4i32);
                transpose(&raw mut (*param).cqm_4py as *mut crate::stdlib::uint8_t, 4i32);
                transpose(&raw mut (*param).cqm_4ic as *mut crate::stdlib::uint8_t, 4i32);
                transpose(&raw mut (*param).cqm_4pc as *mut crate::stdlib::uint8_t, 4i32);
                transpose(&raw mut (*param).cqm_8iy as *mut crate::stdlib::uint8_t, 8i32);
                transpose(&raw mut (*param).cqm_8py as *mut crate::stdlib::uint8_t, 8i32);
                transpose(&raw mut (*param).cqm_8ic as *mut crate::stdlib::uint8_t, 8i32);
                transpose(&raw mut (*param).cqm_8pc as *mut crate::stdlib::uint8_t, 8i32);
                sps.scaling_list[crate::src::common::set::CQM_4IY as ::core::ffi::c_int as usize] =
                ...
                sps.scaling_list[(crate::src::common::set::CQM_8IC as ::core::ffi::c_int + 4i32) as usize] =
                    &raw mut (*param).cqm_8ic as *mut crate::stdlib::uint8_t;
                sps.scaling_list[(crate::src::common::set::CQM_8PC as ::core::ffi::c_int + 4i32) as usize] =
                    &raw mut (*param).cqm_8pc as *mut crate::stdlib::uint8_t;
                while i_1 < 8i32 {
                    let mut j = 0i32;
                    while j < (if i_1 < 4i32 { 16i32 } else { 64i32 }) {
                        if *sps.scaling_list[i_1 as usize].offset(j as isize) as ::core::ffi::c_int == 0i32 {
...
pub unsafe extern "C" fn x264_8_sps_write(
    ...
    unsafe {
        ...
        if sps.i_profile_idc >= crate::src::common::base::PROFILE_HIGH as ::core::ffi::c_int {
            ...
            bs_write_ue_big(s, (crate::internal::BIT_DEPTH - 8i32) as ::core::ffi::c_uint);
            bs_write_ue_big(s, (crate::internal::BIT_DEPTH - 8i32) as ::core::ffi::c_uint);
            bs_write1(s, sps.qpprime_y_zero_transform_bypass as crate::stdlib::uint32_t);
            bs_write1(s, sps.avcintra_hd as crate::stdlib::uint32_t);
            if sps.avcintra_hd {
                scaling_list_write(s, sps, crate::src::common::set::CQM_4IY as ::core::ffi::c_int);
                scaling_list_write(s, sps, crate::src::common::set::CQM_4IC as ::core::ffi::c_int);
                scaling_list_write(s, sps, crate::src::common::set::CQM_4IC as ::core::ffi::c_int);
                bs_write1(s, 0u32);
                bs_write1(s, 0u32);
                bs_write1(s, 0u32);
                scaling_list_write(s, sps, crate::src::common::set::CQM_8IY as ::core::ffi::c_int + 4i32);
                bs_write1(s, 0u32);
                if sps.i_chroma_format_idc.is_444() {
                    scaling_list_write(s, sps, crate::src::common::set::CQM_8IC as ::core::ffi::c_int + 4i32);
                    bs_write1(s, 0u32);
                    scaling_list_write(s, sps, crate::src::common::set::CQM_8IC as ::core::ffi::c_int + 4i32);
                    bs_write1(s, 0u32);
                }
        ...
        bs_write1(s, sps.gaps_in_frame_num_value_allowed as crate::stdlib::uint32_t);
        bs_write_ue_big(s, (sps.i_mb_width - 1i32) as ::core::ffi::c_uint);
        bs_write_ue_big(
            s,
            ((sps.i_mb_height >> (!sps.frame_mbs_only) as ::core::ffi::c_int) - 1i32) as ::core::ffi::c_uint,
        );
        ...
        if sps.has_crop {
            let mut h_shift =
                (sps.i_chroma_format_idc.is_420() || sps.i_chroma_format_idc.is_422()) as ::core::ffi::c_int;
        ...
        if sps.has_vui {
            bs_write1(s, sps.vui.aspect_ratio_info_present as crate::stdlib::uint32_t);
            if sps.vui.aspect_ratio_info_present {
                let mut i = 0i32;
                static mut sar: [C2Rust_Unnamed_24; 17] = [
                    C2Rust_Unnamed_24 { w: 1u8, h: 1u8, sar: 1u8 },
                    C2Rust_Unnamed_24 { w: 12u8, h: 11u8, sar: 2u8 },
                    C2Rust_Unnamed_24 { w: 10u8, h: 11u8, sar: 3u8 },
                    C2Rust_Unnamed_24 { w: 16u8, h: 11u8, sar: 4u8 },
                    C2Rust_Unnamed_24 { w: 40u8, h: 33u8, sar: 5u8 },
                    C2Rust_Unnamed_24 { w: 24u8, h: 11u8, sar: 6u8 },
                    C2Rust_Unnamed_24 { w: 20u8, h: 11u8, sar: 7u8 },
                    C2Rust_Unnamed_24 { w: 32u8, h: 11u8, sar: 8u8 },
                    C2Rust_Unnamed_24 { w: 80u8, h: 33u8, sar: 9u8 },
                    C2Rust_Unnamed_24 { w: 18u8, h: 11u8, sar: 10u8 },
                    C2Rust_Unnamed_24 { w: 15u8, h: 11u8, sar: 11u8 },
                    C2Rust_Unnamed_24 { w: 64u8, h: 33u8, sar: 12u8 },
                    C2Rust_Unnamed_24 { w: 160u8, h: 99u8, sar: 13u8 },
                    C2Rust_Unnamed_24 { w: 4u8, h: 3u8, sar: 14u8 },
                    C2Rust_Unnamed_24 { w: 3u8, h: 2u8, sar: 15u8 },
                    C2Rust_Unnamed_24 { w: 2u8, h: 1u8, sar: 16u8 },
                    C2Rust_Unnamed_24 { w: 0u8, h: 0u8, sar: 255u8 },
                ];
            ...
            if sps.vui.signal_type_present {
                ...
                bs_write1(s, sps.vui.color_description_present as crate::stdlib::uint32_t);
            ...
            bs_write1(s, sps.vui.chroma_loc_info_present as crate::stdlib::uint32_t);
            if sps.vui.chroma_loc_info_present {
            ...
            bs_write1(s, sps.vui.nal_hrd_parameters_present as crate::stdlib::uint32_t);
            if sps.vui.nal_hrd_parameters_present {
                bs_write_ue_big(s, (sps.vui.hrd.i_cpb_cnt - 1i32) as ::core::ffi::c_uint);
                bs_write(s, 4i32, sps.vui.hrd.i_bit_rate_scale as crate::stdlib::uint32_t);
                bs_write(s, 4i32, sps.vui.hrd.i_cpb_size_scale as crate::stdlib::uint32_t);
                bs_write_ue_big(s, (sps.vui.hrd.i_bit_rate_value - 1i32) as ::core::ffi::c_uint);
                bs_write_ue_big(s, (sps.vui.hrd.i_cpb_size_value - 1i32) as ::core::ffi::c_uint);
                bs_write1(s, sps.vui.hrd.cbr_hrd as crate::stdlib::uint32_t);
                bs_write(
                    s,
                    5i32,
                    (sps.vui.hrd.i_initial_cpb_removal_delay_length - 1i32) as crate::stdlib::uint32_t,
                );
                bs_write(s, 5i32, (sps.vui.hrd.i_cpb_removal_delay_length - 1i32) as crate::stdlib::uint32_t);
                bs_write(s, 5i32, (sps.vui.hrd.i_dpb_output_delay_length - 1i32) as crate::stdlib::uint32_t);
                bs_write(s, 5i32, sps.vui.hrd.i_time_offset_length as crate::stdlib::uint32_t);
            }
            bs_write1(s, sps.vui.vcl_hrd_parameters_present as crate::stdlib::uint32_t);
            ...
            if sps.vui.bitstream_restriction {
                bs_write1(s, sps.vui.motion_vectors_over_pic_boundaries as crate::stdlib::uint32_t);
                ...
                bs_write_ue_big(s, sps.vui.i_log2_max_mv_length_horizontal as ::core::ffi::c_uint);
                bs_write_ue_big(s, sps.vui.i_log2_max_mv_length_vertical as ::core::ffi::c_uint);
...
pub unsafe extern "C" fn x264_8_pps_init(
    ...
    unsafe {
        ...
        (*pps).weighted_bipred = if (*param).analyse.weighted_bipred { 2i32 } else { 0i32 };
        (*pps).i_pic_init_qp = if (*param).rc.i_rc_method == crate::x264_h::X264_RC_ABR || (*param).stitchable
        {
...
pub unsafe extern "C" fn x264_8_pps_write(
    ...
    unsafe {
        ...
        bs_write_ue_big(s, ((*pps).i_num_ref_idx_l0_default_active - 1i32) as ::core::ffi::c_uint);
        bs_write_ue_big(s, ((*pps).i_num_ref_idx_l1_default_active - 1i32) as ::core::ffi::c_uint);
        bs_write1(s, (*pps).weighted_pred as crate::stdlib::uint32_t);
        bs_write(s, 2i32, (*pps).weighted_bipred as crate::stdlib::uint32_t);
        bs_write_se(s, (*pps).i_pic_init_qp - 26i32 - crate::src::common::common::QP_BD_OFFSET);
        bs_write_se(s, (*pps).i_pic_init_qs - 26i32 - crate::src::common::common::QP_BD_OFFSET);
        bs_write_se(s, (*pps).i_chroma_qp_index_offset);
        bs_write1(s, (*pps).deblocking_filter_control as crate::stdlib::uint32_t);
        ...
        let mut b_scaling_list = !sps.avcintra_hd && sps.i_cqm_preset != crate::x264_h::X264_CQM_FLAT;
        if (*pps).transform_8x8_mode || b_scaling_list {
            ...
            if b_scaling_list {
                ...
                if sps.avcintra_4k {
                    ...
                    bs_write1(s, 0u32);
                    scaling_list_write(s, sps, crate::src::common::set::CQM_4PY as ::core::ffi::c_int);
                    scaling_list_write(s, sps, crate::src::common::set::CQM_4PC as ::core::ffi::c_int);
                    bs_write1(s, 0u32);
                }
...
pub unsafe extern "C" fn x264_8_sei_recovery_point_write(
    ...
    unsafe {
        ...
        bs_init(&raw mut q, &raw mut tmp_buf as *mut ::core::ffi::c_void, 100i32);
...
pub unsafe extern "C" fn x264_8_sei_version_write(
    ...
    unsafe {
        static mut uuid: [crate::stdlib::uint8_t; 16] = [
            0xDCu8, 0x45u8, 0xE9u8, 0xBDu8, 0xE6u8, 0xD9u8, 0x48u8, 0xB7u8, 0x96u8, 0x2Cu8, 0xD8u8, 0x20u8,
            0xD9u8, 0x23u8, 0xEEu8, 0xEFu8,
        ];
...
pub unsafe extern "C" fn x264_8_sei_pic_timing_write(
    ...
    unsafe {
        ...
        if (*h).sps.vui.pic_struct_present {
            let mut i = 0i32;
            bs_write(&raw mut q, 4i32, ((*(*h).fenc).i_pic_struct - 1i32) as crate::stdlib::uint32_t);
...
pub unsafe extern "C" fn x264_8_sei_frame_packing_write(
    ...
    unsafe {
        ...
        bs_write1(&raw mut q, 0u32);
        bs_write(&raw mut q, 7i32, (*h).param.i_frame_packing as crate::stdlib::uint32_t);
        bs_write1(&raw mut q, quincunx_sampling_flag as crate::stdlib::uint32_t);
        bs_write(&raw mut q, 6i32, ((*h).param.i_frame_packing != 6i32) as crate::stdlib::uint32_t);
        bs_write1(&raw mut q, 0u32);
        bs_write1(&raw mut q, 0u32);
        bs_write1(&raw mut q, 0u32);
        bs_write1(
        ...
        bs_write_ue_big(&raw mut q, ((*h).param.i_frame_packing != 5i32) as ::core::ffi::c_uint);
        bs_write1(&raw mut q, 0u32);
        bs_align_10(&raw mut q);
        x264_8_sei_write(
            s,
...
pub unsafe extern "C" fn x264_8_sei_mastering_display_write(
    ...
    unsafe {
        ...
        bs_init(&raw mut q, &raw mut tmp_buf as *mut ::core::ffi::c_void, 100i32);
        bs_realign(&raw mut q);
        bs_write(&raw mut q, 16i32, (*h).param.mastering_display.i_green_x as crate::stdlib::uint32_t);
        bs_write(&raw mut q, 16i32, (*h).param.mastering_display.i_green_y as crate::stdlib::uint32_t);
        bs_write(&raw mut q, 16i32, (*h).param.mastering_display.i_blue_x as crate::stdlib::uint32_t);
        bs_write(&raw mut q, 16i32, (*h).param.mastering_display.i_blue_y as crate::stdlib::uint32_t);
        bs_write(&raw mut q, 16i32, (*h).param.mastering_display.i_red_x as crate::stdlib::uint32_t);
        bs_write(&raw mut q, 16i32, (*h).param.mastering_display.i_red_y as crate::stdlib::uint32_t);
        bs_write(&raw mut q, 16i32, (*h).param.mastering_display.i_white_x as crate::stdlib::uint32_t);
        bs_write(&raw mut q, 16i32, (*h).param.mastering_display.i_white_y as crate::stdlib::uint32_t);
        bs_write32(&raw mut q, (*h).param.mastering_display.i_display_max as crate::stdlib::uint32_t);
        bs_write32(&raw mut q, (*h).param.mastering_display.i_display_min as crate::stdlib::uint32_t);
        bs_align_10(&raw mut q);
        x264_8_sei_write(
            s,
            &raw mut tmp_buf as *mut crate::stdlib::uint8_t,
...
pub unsafe extern "C" fn x264_8_sei_content_light_level_write(
    ...
    unsafe {
        ...
        bs_init(&raw mut q, &raw mut tmp_buf as *mut ::core::ffi::c_void, 100i32);
        bs_realign(&raw mut q);
        bs_write(&raw mut q, 16i32, (*h).param.content_light_level.i_max_cll as crate::stdlib::uint32_t);
        bs_write(&raw mut q, 16i32, (*h).param.content_light_level.i_max_fall as crate::stdlib::uint32_t);
        bs_align_10(&raw mut q);
        x264_8_sei_write(
            s,
            &raw mut tmp_buf as *mut crate::stdlib::uint8_t,
...
pub unsafe extern "C" fn x264_8_sei_alternative_transfer_write(
    ...
    unsafe {
        ...
        bs_init(&raw mut q, &raw mut tmp_buf as *mut ::core::ffi::c_void, 100i32);
        bs_realign(&raw mut q);
        bs_write(&raw mut q, 8i32, (*h).param.i_alternative_transfer as crate::stdlib::uint32_t);
        bs_align_10(&raw mut q);
        x264_8_sei_write(
            s,
            &raw mut tmp_buf as *mut crate::stdlib::uint8_t,
...
pub unsafe extern "C" fn x264_8_sei_dec_ref_pic_marking_write(
    ...
    unsafe {
        ...
        bs_write1(&raw mut q, ((*sh).i_mmco_command_count > 0i32) as crate::stdlib::uint32_t);
...
pub unsafe extern "C" fn x264_8_sei_avcintra_umid_write(
    ...
    unsafe {
        ...
        crate::stdlib::memcpy(
            (&raw mut data as *mut crate::stdlib::uint8_t).offset(16isize) as *mut ::core::ffi::c_void,
...
pub unsafe extern "C" fn x264_8_validate_levels(
    ...
    unsafe {
        ...
        let mut l = &raw const crate::src::common::tables::x264_levels as *const crate::x264_h::x264_level_t;
