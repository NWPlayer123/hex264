...
pub struct fix_vfr_pts_hnd_t {
    ...
    pub holder_frame: ::core::ffi::c_int,
    pub holder_ret: ::core::ffi::c_int,
    pub pts: int64_t,
...
unsafe extern "C" fn init(
    ...
    (*h).holder_frame = -(1 as ::core::ffi::c_int);
    (*h).prev_hnd = *handle;
...
unsafe extern "C" fn get_frame(
    ...
    if frame == (*h).holder_frame {
        ...
        if (*h).holder_frame > 0 as ::core::ffi::c_int && (*h).holder_frame < frame
            && (*h)
                .prev_filter
                .release_frame
                .expect(
    ...
    if (*h).holder.duration == 0 {
        ...
        (*h).holder_frame = frame + 1 as ::core::ffi::c_int;
...
unsafe extern "C" fn release_frame(
    ...
    let mut h: *mut fix_vfr_pts_hnd_t = handle as *mut fix_vfr_pts_hnd_t;
    if frame == (*h).holder_frame - 1 as ::core::ffi::c_int {
        return 0 as ::core::ffi::c_int;
    }
    return (*h)
        .prev_filter
...
pub static mut fix_vfr_pts_filter: cli_vid_filter_t = unsafe {
    {
        let mut init = cli_vid_filter_t {
            name: b"fix_vfr_pts\0" as *const u8 as *const ::core::ffi::c_char,
            help: None,
            init: Some(
                init
