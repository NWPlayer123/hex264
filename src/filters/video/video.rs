...
pub use self::input_h::{cli_image_t, cli_pic_t, video_info_t};
...
pub use self::x264_h::{
    ...
    C2RustUnnamed_2, C2RustUnnamed_3, C2RustUnnamed_4, X264_LOG_ERROR,
};
...
pub unsafe extern "C" fn x264_register_vid_filters() {
    extern "C" {
        pub static mut source_filter: cli_vid_filter_t;
    }
    first_filter = &mut source_filter;
    extern "C" {
        pub static mut cache_8_filter: cli_vid_filter_t;
    }
    register_vid_filter(&mut cache_8_filter);
    extern "C" {
        pub static mut depth_8_filter: cli_vid_filter_t;
    }
    register_vid_filter(&mut depth_8_filter);
    extern "C" {
        pub static mut cache_10_filter: cli_vid_filter_t;
    }
    register_vid_filter(&mut cache_10_filter);
    extern "C" {
        pub static mut depth_10_filter: cli_vid_filter_t;
    }
    register_vid_filter(&mut depth_10_filter);
    extern "C" {
        pub static mut crop_filter: cli_vid_filter_t;
    }
    register_vid_filter(&mut crop_filter);
    extern "C" {
        pub static mut fix_vfr_pts_filter: cli_vid_filter_t;
    }
    register_vid_filter(&mut fix_vfr_pts_filter);
    extern "C" {
        pub static mut resize_filter: cli_vid_filter_t;
    }
    register_vid_filter(&mut resize_filter);
    extern "C" {
        pub static mut select_every_filter: cli_vid_filter_t;
    }
...
#[no_mangle]
#[c2rust::src_loc = "78:1"]
pub unsafe extern "C" fn x264_vid_filter_help(mut longhelp: ::core::ffi::c_int) {
    let mut filter_i: *mut cli_vid_filter_t = first_filter;
