use crate::x264_h::{
    X264_CPU_AVX, X264_CPU_AVX2, X264_CPU_AVX512, X264_CPU_BMI1, X264_CPU_BMI2, X264_CPU_CACHELINE_32,
    X264_CPU_CACHELINE_64, X264_CPU_FMA3, X264_CPU_FMA4, X264_CPU_LZCNT, X264_CPU_MMX, X264_CPU_MMX2,
    X264_CPU_SLOW_ATOM, X264_CPU_SLOW_PALIGNR, X264_CPU_SLOW_PSHUFB, X264_CPU_SLOW_SHUFFLE, X264_CPU_SSE,
...
pub unsafe extern "C" fn x264_cpu_num_processors() -> ::core::ffi::c_int {
    unsafe {
        ...
        crate::stdlib::__sched_cpucount(::core::mem::size_of::<crate::stdlib::cpu_set_t>(), &raw mut p_aff)
    }
}
