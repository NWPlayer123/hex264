...
pub use self::frame_h::{
    ...
    x264_10_sync_frame_list_pop, x264_10_sync_frame_list_push, x264_deblock_function_t,
    x264_deblock_inter_t, x264_deblock_intra_t, x264_frame, x264_frame_t, x264_sync_frame_list_t,
};
