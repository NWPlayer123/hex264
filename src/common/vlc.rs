...
pub use self::bitstream_h::{
    bs_s, bs_t, vlc_large_t, x264_bitstream_function_t, x264_run_level_t, LEVEL_TABLE_SIZE,
};
...
pub unsafe extern "C" fn x264_10_cavlc_init(mut h: *mut x264_t) {
    ...
    while i_suffix < 7 as ::core::ffi::c_int {
        let mut level: int16_t = (-LEVEL_TABLE_SIZE / 2 as ::core::ffi::c_int) as int16_t;
        while (level as ::core::ffi::c_int) < LEVEL_TABLE_SIZE / 2 as ::core::ffi::c_int {
            ...
            .as_mut_ptr()
            .offset(
                (level as ::core::ffi::c_int + LEVEL_TABLE_SIZE / 2 as ::core::ffi::c_int) as isize,
            ) as *mut vlc_large_t;
            if i_level_code >> i_suffix < 14 as ::core::ffi::c_int {
                (*vlc).i_size =
                    ((i_level_code >> i_suffix) + 1 as ::core::ffi::c_int + i_suffix) as uint8_t;
                (*vlc).i_bits = (((1 as ::core::ffi::c_int) << i_suffix)
                    + (i_level_code
                        & ((1 as ::core::ffi::c_int) << i_suffix) - 1 as ::core::ffi::c_int))
                    as uint16_t;
            } else if i_suffix == 0 as ::core::ffi::c_int && i_level_code < 30 as ::core::ffi::c_int
            {
    ...
    while i < ((1 as ::core::ffi::c_int) << 16 as ::core::ffi::c_int) as uint32_t {
        ...
        while j < 16 as ::core::ffi::c_int {
            dct[j as usize] = (i & ((1 as ::core::ffi::c_int) << j) as uint32_t) as dctcoef;
            j += 1;
        }
        let mut total: ::core::ffi::c_int =
            (*h).quantf.coeff_level_run[DCT_LUMA_4x4 as ::core::ffi::c_int as usize]
        ...
        let mut mask_0: uint32_t = i << i.leading_zeros() as i32 + 1 as ::core::ffi::c_int;
        ...
        while j_0 < total - 1 as ::core::ffi::c_int && zeros > 0 as ::core::ffi::c_int {
            ...
            let mut len: ::core::ffi::c_int =
                x264_run_before_init[idx as usize][run as usize].i_size as ::core::ffi::c_int;
            size += len;
            bits <<= len;
            bits |= x264_run_before_init[idx as usize][run as usize].i_bits as ::core::ffi::c_int;
            zeros -= run;
            mask_0 <<= run + 1 as ::core::ffi::c_int;
            j_0 += 1;
        }
        x264_10_run_before[i as usize] = ((bits << 5 as ::core::ffi::c_int) + size) as uint32_t;
        i = i.wrapping_add(1);
    }
}
