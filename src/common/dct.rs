...
unsafe extern "C" fn dct2x4dc(mut dct: *mut dctcoef, mut dct4x4: *mut [dctcoef; 16]) {
    ...
    *dct.offset(0 as ::core::ffi::c_int as isize) = (b0 + b1) as dctcoef;
    *dct.offset(1 as ::core::ffi::c_int as isize) = (b2 + b3) as dctcoef;
    *dct.offset(2 as ::core::ffi::c_int as isize) = (b0 - b1) as dctcoef;
    *dct.offset(3 as ::core::ffi::c_int as isize) = (b2 - b3) as dctcoef;
    *dct.offset(4 as ::core::ffi::c_int as isize) = (b4 - b5) as dctcoef;
...
unsafe extern "C" fn sub8x8_dct(
    ...
    sub4x4_dct(
        (*dct.offset(0 as ::core::ffi::c_int as isize)).as_mut_ptr(),
        &mut *pix1.offset(0 as ::core::ffi::c_int as isize),
        &mut *pix2.offset(0 as ::core::ffi::c_int as isize),
    );
    sub4x4_dct(
        (*dct.offset(1 as ::core::ffi::c_int as isize)).as_mut_ptr(),
        &mut *pix1.offset(4 as ::core::ffi::c_int as isize),
        &mut *pix2.offset(4 as ::core::ffi::c_int as isize),
    );
    sub4x4_dct(
...
unsafe extern "C" fn sub16x16_dct(
    ...
    sub8x8_dct(
        ...
        &mut *pix1.offset(8 as ::core::ffi::c_int as isize),
        &mut *pix2.offset(8 as ::core::ffi::c_int as isize),
    );
    sub8x8_dct(
...
unsafe extern "C" fn sub8x8_dct_dc(
    ...
    *dct.offset(3 as ::core::ffi::c_int as isize) = sub4x4_dct_dc(
    ...
    let mut d3: ::core::ffi::c_int = *dct.offset(2 as ::core::ffi::c_int as isize)
        - *dct.offset(3 as ::core::ffi::c_int as isize);
    *dct.offset(0 as ::core::ffi::c_int as isize) = (d0 + d1) as dctcoef;
    *dct.offset(1 as ::core::ffi::c_int as isize) = (d0 - d1) as dctcoef;
    *dct.offset(2 as ::core::ffi::c_int as isize) = (d2 + d3) as dctcoef;
    *dct.offset(3 as ::core::ffi::c_int as isize) = (d2 - d3) as dctcoef;
}
...
unsafe extern "C" fn sub8x16_dct_dc(
    ...
    a6 = b4 - b5;
    a7 = b6 - b7;
    *dct.offset(0 as ::core::ffi::c_int as isize) = (a0 + a1) as dctcoef;
    *dct.offset(1 as ::core::ffi::c_int as isize) = (a2 + a3) as dctcoef;
    *dct.offset(2 as ::core::ffi::c_int as isize) = (a0 - a1) as dctcoef;
    *dct.offset(3 as ::core::ffi::c_int as isize) = (a2 - a3) as dctcoef;
    *dct.offset(4 as ::core::ffi::c_int as isize) = (a4 - a5) as dctcoef;
    *dct.offset(5 as ::core::ffi::c_int as isize) = (a6 - a7) as dctcoef;
    *dct.offset(6 as ::core::ffi::c_int as isize) = (a4 + a5) as dctcoef;
    *dct.offset(7 as ::core::ffi::c_int as isize) = (a6 + a7) as dctcoef;
}
        ...
        while x < 4 as ::core::ffi::c_int {
            *p_dst.offset(x as isize) = x264_clip_pixel(
                *p_dst.offset(x as isize) as ::core::ffi::c_int
                    + d[(y * 4 as ::core::ffi::c_int + x) as usize],
            );
            x += 1;
        }
...
unsafe extern "C" fn add8x8_idct(mut p_dst: *mut pixel, mut dct: *mut [dctcoef; 16]) {
    add4x4_idct(
        &mut *p_dst.offset(0 as ::core::ffi::c_int as isize),
        (*dct.offset(0 as ::core::ffi::c_int as isize)).as_mut_ptr(),
    );
    add4x4_idct(
        &mut *p_dst.offset(4 as ::core::ffi::c_int as isize),
        (*dct.offset(1 as ::core::ffi::c_int as isize)).as_mut_ptr(),
    );
    add4x4_idct(
        &mut *p_dst
...
unsafe extern "C" fn add16x16_idct(mut p_dst: *mut pixel, mut dct: *mut [dctcoef; 16]) {
    ...
    add8x8_idct(
        &mut *p_dst.offset(8 as ::core::ffi::c_int as isize),
        &mut *dct.offset(4 as ::core::ffi::c_int as isize),
    );
    add8x8_idct(
        &mut *p_dst
...
unsafe extern "C" fn add8x8_idct8(mut dst: *mut pixel, mut dct: *mut dctcoef) {
    let ref mut fresh0 = *dct.offset(0 as ::core::ffi::c_int as isize);
    *fresh0 = (*fresh0 as ::core::ffi::c_int + 32 as ::core::ffi::c_int) as dctcoef;
    let mut i: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    while i < 8 as ::core::ffi::c_int {
...
unsafe extern "C" fn add16x16_idct8(mut dst: *mut pixel, mut dct: *mut [dctcoef; 64]) {
    add8x8_idct8(
        &mut *dst.offset(0 as ::core::ffi::c_int as isize),
        (*dct.offset(0 as ::core::ffi::c_int as isize)).as_mut_ptr(),
    );
    add8x8_idct8(
        &mut *dst.offset(8 as ::core::ffi::c_int as isize),
        (*dct.offset(1 as ::core::ffi::c_int as isize)).as_mut_ptr(),
    );
    add8x8_idct8(
        &mut *dst
...
unsafe extern "C" fn add4x4_idct_dc(mut p_dst: *mut pixel, mut dc: dctcoef) {
    dc = dc + 32 as dctcoef >> 6 as ::core::ffi::c_int;
    let mut i: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    while i < 4 as ::core::ffi::c_int {
...
unsafe extern "C" fn add16x16_idct_dc(mut p_dst: *mut pixel, mut dct: *mut dctcoef) {
    ...
    while i < 4 as ::core::ffi::c_int {
        ...
        add4x4_idct_dc(
            &mut *p_dst.offset(12 as ::core::ffi::c_int as isize),
            *dct.offset(3 as ::core::ffi::c_int as isize),
        );
        i += 1;
        dct = dct.offset(4 as ::core::ffi::c_int as isize);
        p_dst = p_dst.offset((4 as ::core::ffi::c_int * FDEC_STRIDE) as isize);
    }
}
#[no_mangle]
...
pub unsafe extern "C" fn x264_10_zigzag_init(
    mut cpu: uint32_t,
