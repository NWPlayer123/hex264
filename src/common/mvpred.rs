    ...
    if idx & 3 as c_int >= 2 as c_int + (i_width & 1 as c_int) || i_refc == -(2 as c_int) {
                    ...
                    as c_int
        {
            if idx == 2 as c_int {
                ...
                .as_mut_ptr();
                i_refc = (*h).mb.cache.topright_ref[i_list as usize][0 as c_int as usize] as c_int;
                ...
                .as_mut_ptr();
                i_refc = (*h).mb.cache.topright_ref[i_list as usize][1 as c_int as usize] as c_int;
                ...
                .as_mut_ptr();
                i_refc = (*h).mb.cache.topright_ref[i_list as usize][2 as c_int as usize] as c_int;
            }
        }
    }
...
unsafe extern "C" fn x264_10_mb_predict_mv_pskip(mut h: *mut x264_t, mut mv: *mut int16_t) {
    let mut i_refa: c_int =
        (*h).mb.cache.ref_0[0 as c_int as usize][(X264_SCAN8_0 - 1 as c_int) as usize] as c_int;
    let mut i_refb: c_int =
        (*h).mb.cache.ref_0[0 as c_int as usize][(X264_SCAN8_0 - 8 as c_int) as usize] as c_int;
    let mut mv_a: *mut int16_t = (*(*(*h).mb.cache.mv.as_mut_ptr().offset(0 as c_int as isize))
        .as_mut_ptr()
        .offset((X264_SCAN8_0 - 1 as c_int) as isize))
    .as_mut_ptr();
    let mut mv_b: *mut int16_t = (*(*(*h).mb.cache.mv.as_mut_ptr().offset(0 as c_int as isize))
        .as_mut_ptr()
        .offset((X264_SCAN8_0 - 8 as c_int) as isize))
    .as_mut_ptr();
...
unsafe extern "C" fn mb_predict_mv_direct16x16_temporal(mut h: *mut x264_t) -> c_int {
    ...
    (*h).mb.i_partition = partition_col[0 as c_int as usize];
            ...
            != (*h).mb.b_interlaced
    {
        if (*h).mb.b_interlaced != 0 {
            ...
            type_col[0 as c_int as usize] = *(*(*h).fref[1 as c_int as usize][0 as c_int as usize])
                .mb_type
                .offset(mb_xy as isize) as c_int;
            type_col[1 as c_int as usize] = *(*(*h).fref[1 as c_int as usize][0 as c_int as usize])
                .mb_type
                .offset((mb_xy + (*h).mb.i_mb_stride) as isize)
                as c_int;
            partition_col[0 as c_int as usize] = *(*(*h).fref[1 as c_int as usize]
                [0 as c_int as usize])
                .mb_partition
                .offset(mb_xy as isize) as c_int;
            partition_col[1 as c_int as usize] =
                *(*(*h).fref[1 as c_int as usize][0 as c_int as usize])
                    .mb_partition
                    .offset((mb_xy + (*h).mb.i_mb_stride) as isize) as c_int;
            preshift = 0 as c_int;
            yshift = 0 as c_int;
            if (type_col[0 as c_int as usize] == I_4x4 as c_int
                || type_col[0 as c_int as usize] == I_8x8 as c_int
                || type_col[0 as c_int as usize] == I_16x16 as c_int
                || type_col[0 as c_int as usize] == I_PCM as c_int
                || partition_col[0 as c_int as usize] == D_16x16 as c_int)
                && (type_col[1 as c_int as usize] == I_4x4 as c_int
                    || type_col[1 as c_int as usize] == I_8x8 as c_int
                    || type_col[1 as c_int as usize] == I_16x16 as c_int
                    || type_col[1 as c_int as usize] == I_PCM as c_int
                    || partition_col[1 as c_int as usize] == D_16x16 as c_int)
                && partition_col[0 as c_int as usize] != D_8x8 as c_int
            {
            ...
            let mut col_parity: c_int =
                (abs((*(*h).fref[1 as c_int as usize][0 as c_int as usize]).i_poc
                    + (*(*h).fref[1 as c_int as usize][0 as c_int as usize]).i_delta_poc
                        [0 as c_int as usize]
                    - cur_poc)
                    >= abs((*(*h).fref[1 as c_int as usize][0 as c_int as usize]).i_poc
                        + (*(*h).fref[1 as c_int as usize][0 as c_int as usize]).i_delta_poc
            ...
            type_col[1 as c_int as usize] = *(*(*h).fref[1 as c_int as usize][0 as c_int as usize])
                .mb_type
                .offset(mb_xy as isize) as c_int;
            type_col[0 as c_int as usize] = type_col[1 as c_int as usize];
            partition_col[1 as c_int as usize] = *(*(*h).fref[1 as c_int as usize]
                [0 as c_int as usize])
                .mb_partition
                .offset(mb_xy as isize) as c_int;
            partition_col[0 as c_int as usize] = partition_col[1 as c_int as usize];
            preshift = 1 as c_int;
            yshift = 2 as c_int;
            (*h).mb.i_partition = partition_col[0 as c_int as usize];
        }
    ...
    while i8 < max_i8 {
            ...
            || type_col[y8 as usize] == I_PCM as c_int
        {
            ...
            let mut i_ref1_ref: c_int = *(*(*h).fref[1 as c_int as usize][0 as c_int as usize])
                .ref_0[0 as c_int as usize]
                .offset(i_part_8x8 as isize) as c_int;
            let mut i_ref: c_int =
            ...
            if i_ref >= 0 as c_int {
                let mut dist_scale_factor: c_int =
                    (*(*h).mb.dist_scale_factor.offset(i_ref as isize))[0 as c_int as usize]
                        as c_int;
                let mut mv_col: *mut int16_t =
                    (*(*(**(*(*h).fref.as_mut_ptr().offset(1 as c_int as isize))
                        .as_mut_ptr()
                        .offset(0 as c_int as isize))
                    .mv
                    .as_mut_ptr()
                    ...
                    .as_mut_ptr();
                let mut mv_y: int16_t = (*mv_col.offset(1 as c_int as isize) as c_int
                    * ((1 as c_int) << yshift)
                    / 2 as c_int) as int16_t;
                let mut l0x: c_int =
                    dist_scale_factor * *mv_col.offset(0 as c_int as isize) as c_int + 128 as c_int
                        >> 8 as c_int;
                let mut l0y: c_int = dist_scale_factor * mv_y as c_int + 128 as c_int >> 8 as c_int;
                if (*h).param.i_threads > 1 as c_int
                    && (l0y > (*h).mb.mv_max_spel[1 as c_int as usize]
                        || l0y - mv_y as c_int > (*h).mb.mv_max_spel[1 as c_int as usize])
                {
                    return 0 as c_int;
                }
                x264_macroblock_cache_ref(
                ...
                x264_macroblock_cache_mv(
                    ...
                    1 as c_int,
                    pack16to32_mask(
                        l0x - *mv_col.offset(0 as c_int as isize) as c_int,
                        l0y - mv_y as c_int,
                    ),
                );
            } else {
...
unsafe extern "C" fn mb_predict_mv_direct16x16_spatial(
    ...
    let mut l1ref0: *mut int8_t = &mut *(*(**(*(*h).fref.as_mut_ptr().offset(1 as c_int as isize))
        .as_mut_ptr()
        .offset(0 as c_int as isize))
    .ref_0
    .as_mut_ptr()
    ...
    let mut l1ref1: *mut int8_t = &mut *(*(**(*(*h).fref.as_mut_ptr().offset(1 as c_int as isize))
        .as_mut_ptr()
        .offset(0 as c_int as isize))
    .ref_0
    .as_mut_ptr()
    ...
    let mut l1mv: [*mut [int16_t; 2]; 2] = [
        &mut *(*(**(*(*h).fref.as_mut_ptr().offset(1 as c_int as isize))
            .as_mut_ptr()
            .offset(0 as c_int as isize))
        .mv
        .as_mut_ptr()
    ...
    if (*h).param.i_threads > 1 as c_int
        && (mv[0 as c_int as usize][1 as c_int as usize] as c_int
            > (*h).mb.mv_max_spel[1 as c_int as usize]
            || mv[1 as c_int as usize][1 as c_int as usize] as c_int
                > (*h).mb.mv_max_spel[1 as c_int as usize])
    {
        return 0 as c_int;
    }
    if (*(mv.as_mut_ptr() as *mut x264_union64_t)).i == 0
        || b_interlaced == 0
            && (type_col[0 as c_int as usize] == I_4x4 as c_int
                || type_col[0 as c_int as usize] == I_8x8 as c_int
                || type_col[0 as c_int as usize] == I_16x16 as c_int
                || type_col[0 as c_int as usize] == I_PCM as c_int)
        || ref_0[0 as c_int as usize] as c_int != 0 && ref_0[1 as c_int as usize] as c_int != 0
    {
        return 1 as c_int;
    }
    let mut max_i8: c_int = D_16x16 as c_int - (*h).mb.i_partition + 1 as c_int;
    ...
    while i8 < max_i8 {
                ...
                || type_col[y8 as usize] == I_PCM as c_int))
        {
            ...
            match current_block_59 {
                1423531122933789233 => {}
                _ => {
                    if abs((*l1mv[idx as usize].offset(o4 as isize))[0 as c_int as usize] as c_int)
                        <= 1 as c_int
                        && abs(
                            (*l1mv[idx as usize].offset(o4 as isize))[1 as c_int as usize] as c_int,
                        ) <= 1 as c_int
                    {
                        if ref_0[0 as c_int as usize] as c_int == 0 as c_int {
                            x264_macroblock_cache_mv(
                                h,
                                2 as c_int * x8,
                                2 as c_int * y8,
                        ...
                        if ref_0[1 as c_int as usize] as c_int == 0 as c_int {
                            x264_macroblock_cache_mv(
                                h,
                                2 as c_int * x8,
                                2 as c_int * y8,
...
unsafe extern "C" fn x264_10_mb_predict_mv_direct16x16(
    ...
    if !b_changed.is_null() && b_available != 0 {
        ...
        .as_mut_ptr() as *mut x264_union32_t))
            ...
            .as_mut_ptr() as *mut x264_union32_t))
                .i) as c_int;
        changed |= (*h).mb.cache.direct_ref[0 as c_int as usize][0 as c_int as usize] as c_int
            ^ (*h).mb.cache.ref_0[0 as c_int as usize][x264_scan8[0 as c_int as usize] as usize]
                as c_int;
        changed |= (*h).mb.cache.direct_ref[1 as c_int as usize][0 as c_int as usize] as c_int
            ^ (*h).mb.cache.ref_0[1 as c_int as usize][x264_scan8[0 as c_int as usize] as usize]
                as c_int;
        if changed == 0 && (*h).mb.i_partition != D_16x16 as c_int {
            ...
            .as_mut_ptr() as *mut x264_union32_t))
                ...
                .as_mut_ptr() as *mut x264_union32_t))
                    .i) as c_int;
            changed |= (*h).mb.cache.direct_ref[0 as c_int as usize][3 as c_int as usize] as c_int
                ^ (*h).mb.cache.ref_0[0 as c_int as usize]
                    [x264_scan8[12 as c_int as usize] as usize] as c_int;
            changed |= (*h).mb.cache.direct_ref[1 as c_int as usize][3 as c_int as usize] as c_int
        ...
        if changed == 0 && (*h).mb.i_partition == D_8x8 as c_int {
            ...
            .as_mut_ptr() as *mut x264_union32_t))
                ...
                .as_mut_ptr() as *mut x264_union32_t))
                    .i) as c_int;
            changed |= (*h).mb.cache.direct_ref[0 as c_int as usize][1 as c_int as usize] as c_int
                ^ (*h).mb.cache.ref_0[0 as c_int as usize][x264_scan8[4 as c_int as usize] as usize]
                    as c_int;
            changed |= (*h).mb.cache.direct_ref[1 as c_int as usize][1 as c_int as usize] as c_int
                ^ (*h).mb.cache.ref_0[1 as c_int as usize][x264_scan8[4 as c_int as usize] as usize]
                    as c_int;
            changed |= (*h).mb.cache.direct_ref[0 as c_int as usize][2 as c_int as usize] as c_int
                ^ (*h).mb.cache.ref_0[0 as c_int as usize][x264_scan8[8 as c_int as usize] as usize]
                    as c_int;
            changed |= (*h).mb.cache.direct_ref[1 as c_int as usize][2 as c_int as usize] as c_int
                ^ (*h).mb.cache.ref_0[1 as c_int as usize][x264_scan8[8 as c_int as usize] as usize]
                    as c_int;
        }
        *b_changed = changed;
        if changed == 0 {
    ...
    if b_available != 0 {
        ...
        while l < 2 as c_int {
            ...
            .as_mut_ptr() as *mut x264_union32_t))
                .i;
            (*h).mb.cache.direct_ref[l as usize][0 as c_int as usize] =
                (*h).mb.cache.ref_0[l as usize][x264_scan8[0 as c_int as usize] as usize];
            (*h).mb.cache.direct_ref[l as usize][1 as c_int as usize] =
                (*h).mb.cache.ref_0[l as usize][x264_scan8[4 as c_int as usize] as usize];
            (*h).mb.cache.direct_ref[l as usize][2 as c_int as usize] =
                (*h).mb.cache.ref_0[l as usize][x264_scan8[8 as c_int as usize] as usize];
            (*h).mb.cache.direct_ref[l as usize][3 as c_int as usize] =
                (*h).mb.cache.ref_0[l as usize][x264_scan8[12 as c_int as usize] as usize];
...
unsafe extern "C" fn x264_10_mb_predict_mv_ref16x16(
    ...
    if (*h).sh.i_type == SLICE_TYPE_B as c_int
        && (*h).mb.cache.ref_0[i_list as usize][x264_scan8[12 as c_int as usize] as usize] as c_int
            == i_ref
    {
    ...
    if i_ref == 0 as c_int && (*h).frames.b_have_lowres != 0 {
        let mut idx: c_int = if i_list != 0 {
            (*(*h).fref[1 as c_int as usize][0 as c_int as usize]).i_frame
                - (*(*h).fenc).i_frame
                - 1 as c_int
        } else {
            (*(*h).fenc).i_frame
        ...
        if idx <= (*h).param.i_bframe {
            ...
            if (*lowres_mv.offset(0 as c_int as isize))[0 as c_int as usize] as c_int
                != 0x7fff as c_int
            {
                (*((*mvc.offset(i as isize)).as_mut_ptr() as *mut x264_union32_t)).i =
    ...
    if (*h).sh.b_mbaff != 0 {
        if (*h).mb.i_mb_left_xy[0 as c_int as usize] >= 0 as c_int {
            ...
            .as_mut_ptr();
            (*mvc.offset(i as isize))[0 as c_int as usize] = *mvp.offset(0 as c_int as isize);
            (*mvc.offset(i as isize))[1 as c_int as usize] =
                (*mvp.offset(1 as c_int as isize) as c_int * 2 as c_int >> shift) as int16_t;
            i += 1;
        }
        if (*h).mb.i_mb_top_xy >= 0 as c_int {
            ...
            .as_mut_ptr();
            (*mvc.offset(i as isize))[0 as c_int as usize] = *mvp_0.offset(0 as c_int as isize);
            (*mvc.offset(i as isize))[1 as c_int as usize] =
                (*mvp_0.offset(1 as c_int as isize) as c_int * 2 as c_int >> shift_0) as int16_t;
            i += 1;
        }
        if (*h).mb.i_mb_topleft_xy >= 0 as c_int {
            ...
            .as_mut_ptr();
            (*mvc.offset(i as isize))[0 as c_int as usize] = *mvp_1.offset(0 as c_int as isize);
            (*mvc.offset(i as isize))[1 as c_int as usize] =
                (*mvp_1.offset(1 as c_int as isize) as c_int * 2 as c_int >> shift_1) as int16_t;
            i += 1;
        }
        if (*h).mb.i_mb_topright_xy >= 0 as c_int {
            ...
            .as_mut_ptr();
            (*mvc.offset(i as isize))[0 as c_int as usize] = *mvp_2.offset(0 as c_int as isize);
            (*mvc.offset(i as isize))[1 as c_int as usize] =
                (*mvp_2.offset(1 as c_int as isize) as c_int * 2 as c_int >> shift_2) as int16_t;
            i += 1;
        }
    } else {
    ...
    if (*(*h).fref[0 as c_int as usize][0 as c_int as usize]).i_ref[0 as c_int as usize]
        > 0 as c_int
    {
        let mut l0: *mut x264_frame_t = (*h).fref[0 as c_int as usize][0 as c_int as usize];
        ...
        (*mvc.offset(i as isize))[0 as c_int as usize] = x264_clip3(
            (*(*l0).mv16x16.offset(mb_index as isize))[0 as c_int as usize] as c_int * scale
                + 128 as c_int
                >> 8 as c_int,
            INT16_MIN,
            INT16_MAX,
        ) as int16_t;
        (*mvc.offset(i as isize))[1 as c_int as usize] = x264_clip3(
            (*(*l0).mv16x16.offset(mb_index as isize))[1 as c_int as usize] as c_int * scale
                + 128 as c_int
                >> 8 as c_int,
            INT16_MIN,
            INT16_MAX,
        ...
        if (*h).mb.i_mb_x < (*h).mb.i_mb_width - 1 as c_int {
            ...
            (*mvc.offset(i as isize))[0 as c_int as usize] = x264_clip3(
                (*(*l0).mv16x16.offset(mb_index_0 as isize))[0 as c_int as usize] as c_int
                    * scale_0
                    + 128 as c_int
                    >> 8 as c_int,
                INT16_MIN,
            ...
            (*mvc.offset(i as isize))[1 as c_int as usize] = x264_clip3(
                (*(*l0).mv16x16.offset(mb_index_0 as isize))[1 as c_int as usize] as c_int
                    * scale_0
                    + 128 as c_int
                    >> 8 as c_int,
                INT16_MIN,
        ...
        if (*h).mb.i_mb_y < (*h).mb.i_mb_height - 1 as c_int {
            ...
            let mut scale_1: c_int = (curpoc - refpoc)
                * (*l0).inv_ref_poc[((*h).mb.b_interlaced & field) as usize] as c_int;
            (*mvc.offset(i as isize))[0 as c_int as usize] = x264_clip3(
                (*(*l0).mv16x16.offset(mb_index_1 as isize))[0 as c_int as usize] as c_int
                    * scale_1
                    + 128 as c_int
                    >> 8 as c_int,
                INT16_MIN,
            ...
            (*mvc.offset(i as isize))[1 as c_int as usize] = x264_clip3(
                (*(*l0).mv16x16.offset(mb_index_1 as isize))[1 as c_int as usize] as c_int
                    * scale_1
                    + 128 as c_int
                    >> 8 as c_int,
                INT16_MIN,
