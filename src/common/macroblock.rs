...
#[derive(
    Clone, Copy, Debug, PartialEq, Eq, PartialOrd, Ord, strum::EnumCount, strum::EnumIter, strum::FromRepr,
)]
#[repr(u8)]
pub enum Partition {
    D_L0_4x4 = 0,
...
pub mod macroblock_h {
    ...
    pub unsafe extern "C" fn pack8to32(
        ...
        a.wrapping_add(b << 8i32).wrapping_add(c << 16i32).wrapping_add(d << 24i32)
    }
}
pub mod rectangle_h {
    #[inline(always)]
...
use crate::src::common::macroblock::{
    base_h::{x264_clip3, x264_scan8},
    macroblock_h::{pack8to32, pack16to32},
    pixel_h::x264_size2pixel,
    predict_h::x264_mb_chroma_pred_mode_fix,
    rectangle_h::x264_macroblock_cache_skip,
};
#[inline(never)]
unsafe extern "C" fn mb_mc_0xywh(
    ...
    unsafe {
        ...
        (*h).mc.mc_luma.expect("non-null function pointer")(
            (*(&raw mut (*h).mb.pic.p_fdec as *mut *mut crate::src::common::common::pixel).offset(0isize))
            ...
            (&raw mut *(&raw mut *(&raw mut (*h).mb.pic.p_fref
                ...
                .offset(0isize) as *mut [*mut crate::src::common::common::pixel; 12])
            ...
            4i32 * height,
            if 0i32 != 0 {
                &raw mut crate::src::common::tables::x264_zero as *const crate::src::common::mc::x264_weight_t
            } else {
                (&raw mut *(&raw mut (*h).sh.weight as *mut [crate::src::common::mc::x264_weight_t; 3])
                    .offset(i_ref as isize) as *mut crate::src::common::mc::x264_weight_t)
        ...
        if (*h).sps.i_chroma_format_idc.is_444() {
            (*h).mc.mc_luma.expect("non-null function pointer")(
                ...
                if 0i32 != 0 {
                    ...
                    (&raw mut *(&raw mut (*h).sh.weight as *mut [crate::src::common::mc::x264_weight_t; 3])
                        ...
                        .offset(1isize) as *const crate::src::common::mc::x264_weight_t
                },
            );
            (*h).mc.mc_luma.expect("non-null function pointer")(
                (*(&raw mut (*h).mb.pic.p_fdec as *mut *mut crate::src::common::common::pixel)
                ...
                if 0i32 != 0 {
                    ...
                    (&raw mut *(&raw mut (*h).sh.weight as *mut [crate::src::common::mc::x264_weight_t; 3])
                        .offset(i_ref as isize)
                        as *mut crate::src::common::mc::x264_weight_t)
                        .offset(2isize) as *const crate::src::common::mc::x264_weight_t
                },
            );
            ...
            let mut offset = ((4i32 * crate::src::common::common::FDEC_STRIDE) >> v_shift) * y + 2i32 * x;
            ...
            if !(*h).sh.weight[i_ref as usize][1usize].weightfn.is_null() {
                (*(*h).sh.weight[i_ref as usize][1usize].weightfn.offset((width >> 1i32) as isize))
            ...
            if !(*h).sh.weight[i_ref as usize][2usize].weightfn.is_null() {
                (*(*h).sh.weight[i_ref as usize][2usize].weightfn.offset((width >> 1i32) as isize))
                    .expect("non-null function pointer")(
                    (*(&raw mut (*h).mb.pic.p_fdec as *mut *mut crate::src::common::common::pixel)
                        .offset(2isize))
                    .offset(offset as isize),
...
unsafe extern "C" fn mb_mc_1xywh(
    ...
    unsafe {
        ...
        (*h).mc.mc_luma.expect("non-null function pointer")(
            ...
            (&raw mut *(&raw mut *(&raw mut (*h).mb.pic.p_fref
                as *mut [[*mut crate::src::common::common::pixel; 12]; 32])
                .offset(1isize) as *mut [*mut crate::src::common::common::pixel; 12])
                .offset(i_ref as isize) as *mut *mut crate::src::common::common::pixel)
                .offset((0i32 * 4i32) as isize),
            (*h).mb.pic.i_stride[0usize] as crate::stdlib::intptr_t,
            mvx,
    ...
    unsafe {
        ...
        let mut src0 = (*h).mc.get_ref.expect("non-null function pointer")(
            ...
            (&raw mut *(&raw mut *(&raw mut (*h).mb.pic.p_fref
                as *mut [[*mut crate::src::common::common::pixel; 12]; 32])
                .offset(0isize) as *mut [*mut crate::src::common::common::pixel; 12])
                .offset(i_ref0 as isize) as *mut *mut crate::src::common::common::pixel)
                .offset((0i32 * 4i32) as isize),
            (*h).mb.pic.i_stride[0usize] as crate::stdlib::intptr_t,
            mvx0,
            mvy0,
        ...
        let mut src1 = (*h).mc.get_ref.expect("non-null function pointer")(
            ...
            (&raw mut *(&raw mut *(&raw mut (*h).mb.pic.p_fref
                as *mut [[*mut crate::src::common::common::pixel; 12]; 32])
                .offset(1isize) as *mut [*mut crate::src::common::common::pixel; 12])
                .offset(i_ref1 as isize) as *mut *mut crate::src::common::common::pixel)
                .offset((0i32 * 4i32) as isize),
            (*h).mb.pic.i_stride[0usize] as crate::stdlib::intptr_t,
            mvx1,
            mvy1,
...
pub unsafe extern "C" fn x264_8_mb_mc(mut h: *mut crate::src::common::common::x264_t) {
    unsafe {
        if (*h).mb.i_partition == Partition::D_8x8 {
            ...
            let mut ref0a = (*h).mb.cache.ref_0[0usize][x264_scan8[0usize] as usize] as ::core::ffi::c_int;
            let mut ref0b = (*h).mb.cache.ref_0[0usize][x264_scan8[12usize] as usize] as ::core::ffi::c_int;
            let mut ref1a = (*h).mb.cache.ref_0[1usize][x264_scan8[0usize] as usize] as ::core::ffi::c_int;
            let mut ref1b = (*h).mb.cache.ref_0[1usize][x264_scan8[12usize] as usize] as ::core::ffi::c_int;
...
pub unsafe extern "C" fn x264_8_macroblock_cache_allocate(
    ...
    unsafe {
        ...
        prealloc_size += ((i_mb_count as usize).wrapping_mul(::core::mem::size_of::<crate::stdlib::int8_t>())
        ...
        prealloc_idx += 1;
        preallocs[c2rust_fresh1 as usize] = &raw mut (*h).mb.cbp as *mut *mut crate::stdlib::uint8_t;
        prealloc_size += ((i_mb_count as usize).wrapping_mul(::core::mem::size_of::<crate::stdlib::int16_t>())
            as crate::stdlib::int64_t
            + (64i32 - 1i32) as crate::stdlib::int64_t)
            & !(64i32 - 1i32) as crate::stdlib::int64_t;
        ...
        prealloc_idx += 1;
        preallocs[c2rust_fresh3 as usize] = &raw mut (*h).mb.slice_table as *mut *mut crate::stdlib::uint8_t;
        prealloc_size += ((i_mb_count as usize).wrapping_mul(::core::mem::size_of::<crate::stdlib::int32_t>())
            as crate::stdlib::int64_t
            + (64i32 - 1i32) as crate::stdlib::int64_t)
            & !(64i32 - 1i32) as crate::stdlib::int64_t;
        ...
        if (*h).param.cabac {
            ...
            prealloc_idx += 1;
            preallocs[c2rust_fresh6 as usize] = &raw mut (*h).mb.skipbp as *mut *mut crate::stdlib::uint8_t;
            ...
            if (*h).param.i_bframe != 0 {
                ...
                preallocs[c2rust_fresh9 as usize] =
                    (&raw mut (*h).mb.mvd as *mut *mut [[crate::stdlib::uint8_t; 2]; 8]).offset(1isize)
                        as *mut *mut crate::stdlib::uint8_t;
                prealloc_size += ((i_mb_count as usize)
                    .wrapping_mul(::core::mem::size_of::<[[crate::stdlib::uint8_t; 2]; 8]>())
                    as crate::stdlib::int64_t
        ...
        while i < 2i32 {
            ...
            while j < i_refs {
                (*h).mb.mvr[i as usize][j as usize] = prealloc_size as *mut [crate::stdlib::int16_t; 2];
                let c2rust_fresh10 = prealloc_idx;
                prealloc_idx += 1;
                preallocs[c2rust_fresh10 as usize] =
                    (&raw mut *(&raw mut (*h).mb.mvr as *mut [*mut [crate::stdlib::int16_t; 2]; 32])
                        .offset(i as isize) as *mut *mut [crate::stdlib::int16_t; 2])
                        .offset(j as isize) as *mut *mut crate::stdlib::uint8_t;
                ...
                luma_plane_size = (*(*h).fdec).i_stride[0usize]
                    * ((*h).mb.i_mb_height
                        * ((16i32) << (*h).sps.i_chroma_format_idc.is_422() as ::core::ffi::c_int)
                        + 2i32 * i_padv);
                if (*h).param.analyse.i_weighted_pred == crate::x264_h::X264_WEIGHTP_SMART {
                    numweightbuf = 1i32 + (crate::internal::BIT_DEPTH == 8i32) as ::core::ffi::c_int;
                } else {
                    numweightbuf = 1i32;
                }
            }
            while i_0 < numweightbuf {
                (*h).mb.p_weight_buf[i_0 as usize] = prealloc_size as *mut crate::src::common::common::pixel;
        ...
        (*h).mb.base = crate::src::common::base::x264_malloc(prealloc_size) as *mut crate::stdlib::uint8_t;
...
pub unsafe extern "C" fn x264_8_macroblock_cache_free(mut h: *mut crate::src::common::common::x264_t) {
    unsafe {
    ...
    unsafe {
        ...
        if b_lookahead == 0 {
            's_5: loop {
                ...
                while j < (if (*h).sps.i_chroma_format_idc.is_444() { 3i32 } else { 2i32 }) {
                    (*h).intra_border_backup[i as usize][j as usize] = crate::src::common::base::x264_malloc(
        ...
        match c2rust_current_block {
            5783071609795492627 => {
                ...
                scratch_size = 0i32;
                if b_lookahead == 0 {
                    let mut buf_hpel = (((*(*(*h).thread[0usize]).fdec).i_width[0usize] + 48i32 + 32i32)
                        as usize)
                        .wrapping_mul(::core::mem::size_of::<crate::stdlib::int16_t>())
                        as ::core::ffi::c_int;
                    let mut buf_ssim = (((*h).param.analyse.ssim as ::core::ffi::c_int
                        ...
                        * ((*h).param.i_width / 4i32 + 3i32))
                        ...
                        as ::core::ffi::c_int;
                    let mut me_range = if (*h).param.analyse.i_me_range < (*h).param.analyse.i_mv_range {
                        (*h).param.analyse.i_me_range
                    } else {
                        (*h).param.analyse.i_mv_range
                    };
                    let mut buf_tesa = (((*h).param.analyse.i_me_method >= crate::x264_h::X264_ME_ESA)
                        as ::core::ffi::c_int as usize)
                        .wrapping_mul(
                            ((me_range * 2i32 + 24i32) as usize)
                                .wrapping_mul(::core::mem::size_of::<crate::stdlib::int16_t>())
                                .wrapping_add(
                                    (((me_range + 4i32) * (me_range + 1i32) * 4i32) as usize).wrapping_mul(
                                        ::core::mem::size_of::<crate::src::common::common::mvsad_t>(),
                                    ),
                                ),
                        ) as ::core::ffi::c_int;
                    scratch_size = if buf_hpel > (if buf_ssim > buf_tesa { buf_ssim } else { buf_tesa }) {
                        buf_hpel
                ...
                scratch_size = if scratch_size > buf_mbtree { scratch_size } else { buf_mbtree };
                if scratch_size != 0 {
                    (*h).scratch_buffer =
                        crate::src::common::base::x264_malloc(scratch_size as crate::stdlib::int64_t);
...
pub unsafe extern "C" fn slice_init(mut h: *mut crate::src::common::common::x264_t) {
    unsafe {
        ...
        (*h).mb.types = (*(*h).fdec).mb_types.as_mut_ptr().add((*h).sh.i_first_mb as usize);
        (*h).mb.partition = (*(*h).fdec).mb_partition.as_mut_ptr().add((*h).sh.i_first_mb as usize);
        ...
        if (*h).sh.i_type == crate::src::common::base::SLICE_TYPE_B as ::core::ffi::c_int {
            ...
            while i_0 < (*h).i_ref[1usize] {
                (*(*h).fdec).ref_poc[1usize][i_0 as usize] = (*(*h).fref[1usize][i_0 as usize]).i_poc;
                i_0 += 1;
            }
            ...
            while i_1 < (*(*h).fref[1usize][0usize]).i_ref[0usize] {
                ...
                while j < (*h).i_ref[0usize] {
                    if (*(*h).fref[0usize][j as usize]).i_poc == poc {
                        (*h).mb.map_col_to_list0[(i_1 + 2i32) as usize] = j as crate::stdlib::int8_t;
                        break;
                    } else {
                        j += 1;
                    }
            ...
            && (*h).sh.i_disable_deblocking_filter_idc != 1i32
            ...
            while i_2 < (*h).i_ref[0usize] << (*h).sh.mbaff as ::core::ffi::c_int {
                if !(*h).mb.interlaced {
                    (*h).mb.deblock_ref_table[(i_2 + 2i32) as usize] =
                        ((*(*h).fref[0usize][i_2 as usize]).i_frame_num & 63i32) as crate::stdlib::int8_t;
                } else {
                    (*h).mb.deblock_ref_table[(i_2 + 2i32) as usize] =
                        ((((*(*h).fref[0usize][(i_2 >> 1i32) as usize]).i_frame_num & 63i32) << 1i32)
                            + (i_2 & 1i32)) as crate::stdlib::int8_t;
                }
                i_2 += 1;
            }
        }
        ...
        (*h).mb.i_neighbour4[14usize] = (crate::src::common::macroblock::MB_LEFT as ::core::ffi::c_int
        ...
        (*h).mb.i_neighbour8[3usize] = (crate::src::common::macroblock::MB_LEFT as ::core::ffi::c_int
            | crate::src::common::macroblock::MB_TOP as ::core::ffi::c_int
            | crate::src::common::macroblock::MB_TOPLEFT as ::core::ffi::c_int)
            as ::core::ffi::c_uint;
...
pub unsafe extern "C" fn x264_8_macroblock_thread_init(mut h: *mut crate::src::common::common::x264_t) {
    unsafe {
        ...
        (*h).mb.dct_decimate = (*h).sh.i_type == crate::src::common::base::SLICE_TYPE_B as ::core::ffi::c_int
            || (*h).param.analyse.dct_decimate
                && (*h).sh.i_type != crate::src::common::base::SLICE_TYPE_I as ::core::ffi::c_int;
        (*h).mb.i_mb_prev_xy = -(1i32);
        (*h).mb.pic.p_fenc[0usize] = &raw mut (*h).mb.pic.fenc_buf as *mut crate::src::common::common::pixel;
...
pub unsafe extern "C" fn x264_8_prefetch_fenc(
    ...
    unsafe {
        ...
        let mut off_uv = 16i32 * i_mb_x
            + ((16i32 * i_mb_y * stride_uv) >> (*h).sps.i_chroma_format_idc.is_420() as ::core::ffi::c_int);
...
unsafe extern "C" fn macroblock_load_pic_pointers(
    ...
    unsafe {
        ...
        let mut plane_fdec = (*(&raw mut (*(*h).fdec).plane as *mut *mut crate::src::common::common::pixel)
            .offset(i as isize))
        ...
        if b_chroma != 0 {
            ...
            crate::stdlib::memcpy(
                (*h).mb.pic.p_fdec[1usize].offset(-(crate::src::common::common::FDEC_STRIDE as isize))
                    as *mut ::core::ffi::c_void,
                intra_fdec as *const ::core::ffi::c_void,
                (8i32 * crate::src::common::common::SIZEOF_PIXEL) as crate::__stddef_size_t_h::size_t,
            );
            crate::stdlib::memcpy(
                (*h).mb.pic.p_fdec[2usize].offset(-(crate::src::common::common::FDEC_STRIDE as isize))
                    as *mut ::core::ffi::c_void,
                intra_fdec.offset(8isize) as *const ::core::ffi::c_void,
                (8i32 * crate::src::common::common::SIZEOF_PIXEL) as crate::__stddef_size_t_h::size_t,
            );
            *(*h).mb.pic.p_fdec[1usize].offset((-crate::src::common::common::FDEC_STRIDE - 1i32) as isize) =
                *intra_fdec.offset((-(1i32) - 8i32) as isize);
            *(*h).mb.pic.p_fdec[2usize].offset((-crate::src::common::common::FDEC_STRIDE - 1i32) as isize) =
            ...
            crate::stdlib::memcpy(
                (*h).mb.pic.p_fdec[i as usize].offset(-(crate::src::common::common::FDEC_STRIDE as isize))
                    as *mut ::core::ffi::c_void,
                intra_fdec as *const ::core::ffi::c_void,
                (24i32 * crate::src::common::common::SIZEOF_PIXEL) as crate::__stddef_size_t_h::size_t,
            );
        ...
        while j_0 < (*h).mb.pic.i_fref[0usize] {
            ...
            if b_chroma == 0 {
                if (*h).param.analyse.i_subpel_refine != 0 {
                    let mut k = 1i32;
                    while k < 4i32 {
                        (*h).mb.pic.p_fref[0usize][j_0 as usize][(i * 4i32 + k) as usize] = (*filtered_src
                            .offset(k as isize))
                ...
                if i == 0 {
                    if !(*h).sh.weight[j_0 as usize][0usize].weightfn.is_null() {
                        ...
                        (*h).mb.pic.p_fref_w[j_0 as usize] = (*h).mb.pic.p_fref[0usize][j_0 as usize][0usize];
                    }
                }
            }
            j_0 += 1;
        ...
        if (*h).sh.i_type == crate::src::common::base::SLICE_TYPE_B as ::core::ffi::c_int {
            ...
            while j_1 < (*h).mb.pic.i_fref[1usize] {
                ...
                if b_chroma == 0 && (*h).param.analyse.i_subpel_refine != 0 {
                    let mut k_0 = 1i32;
                    while k_0 < 4i32 {
                        (*h).mb.pic.p_fref[1usize][j_1 as usize][(i * 4i32 + k_0) as usize] = (*filtered_src
                            .offset(k_0 as isize))
...
unsafe extern "C" fn macroblock_cache_load_neighbours(
    ...
    unsafe {
        ...
        (*h).mb.left_index_table =
            (&raw const left_indices as *const crate::src::common::common::x264_left_table_t).offset(3isize);
        ...
        if b_interlaced != 0 {
            ...
            if mb_y & 1i32 != 0 {
                ...
                if mb_interlaced != 0 && top >= 0i32 {
                    ...
                    if mb_x != 0 {
                        topleft_y +=
                            (*(*h).mb.field.offset(((*h).mb.i_mb_stride * topleft_y + mb_x - 1i32) as isize)
                                == 0) as ::core::ffi::c_int;
                    }
                    if mb_x < (*h).mb.i_mb_width - 1i32 {
                        topright_y +=
                            (*(*h).mb.field.offset(((*h).mb.i_mb_stride * topright_y + mb_x + 1i32) as isize)
                                == 0) as ::core::ffi::c_int;
                    }
                }
                if mb_x != 0
        ...
        if mb_x > 0i32 {
            ...
            (*h).mb.i_mb_type_left[0usize] =
                Some(*(*h).mb.types.add(((*h).mb.i_mb_left_xy[0usize] - (*h).sh.i_first_mb) as usize));
            (*h).mb.i_mb_type_left[1usize] =
                Some(*(*h).mb.types.add(((*h).mb.i_mb_left_xy[1usize] - (*h).sh.i_first_mb) as usize));
        ...
        if (*h).i_threadslice_start >> mb_interlaced != mb_y >> mb_interlaced {
            if top >= 0i32 {
                ...
                (*h).mb.i_mb_type_top =
                    Some(*(*h).mb.types.add(((*h).mb.i_mb_top_xy - (*h).sh.i_first_mb) as usize));
            ...
            if mb_x > 0i32 && topleft_y >= 0i32 {
                ...
                (*h).mb.i_mb_type_topleft =
                    Some(*(*h).mb.types.add(((*h).mb.i_mb_topleft_xy - (*h).sh.i_first_mb) as usize));
            ...
            if mb_x < (*h).mb.i_mb_width - 1i32 && topright_y >= 0i32 {
                ...
                (*h).mb.i_mb_type_topright =
                    Some(*(*h).mb.types.add(((*h).mb.i_mb_topright_xy - (*h).sh.i_first_mb) as usize));
                if *(*h).mb.slice_table.offset((*h).mb.i_mb_topright_xy as isize) == (*h).sh.i_first_mb {
...
unsafe extern "C" fn macroblock_cache_load(
    ...
    unsafe {
        ...
        .offset((if (*h).param.sliced_threads { (*h).mb.i_mb_xy } else { mb_x }) as isize)
        ...
        if (*h).mb.i_neighbour & crate::src::common::macroblock::MB_TOP != 0 {
            ...
            (*((&raw mut (*h).mb.cache.intra4x4_pred_mode as *mut crate::stdlib::int8_t).offset(
                ...
                .i = (*((&raw mut *i4x4.offset(top as isize) as *mut crate::stdlib::int8_t).offset(0isize)
                as *mut crate::src::common::base::x264_union32_t))
                .i;
            (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t).offset(
                ...
                .i = (*((&raw mut *nnz.offset(top as isize) as *mut crate::stdlib::uint8_t).offset(12isize)
                as *mut crate::src::common::base::x264_union32_t))
                .i;
            (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t).offset(
                ...
                (16i32 - 4i32 + (16i32 >> (*h).sps.i_chroma_format_idc.is_420() as ::core::ffi::c_int))
                    as isize,
            ) as *mut crate::src::common::base::x264_union32_t))
                .i;
            (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t).offset(
                ...
                .i = (*((&raw mut *nnz.offset(top as isize) as *mut crate::stdlib::uint8_t).offset(
                (32i32 - 4i32 + (16i32 >> ((*h).sps.i_chroma_format_idc.is_420()) as ::core::ffi::c_int))
                    as isize,
            ) as *mut crate::src::common::base::x264_union32_t))
                .i;
        } else {
        ...
        if (*h).mb.i_neighbour & crate::src::common::macroblock::MB_LEFT != 0 {
            ...
            let mut lbot = if b_mbaff != 0 { *left.offset(LBOT as isize) } else { ltop };
            if b_mbaff != 0 {
                ...
                let bot_luma = (*cbp.offset(lbot as isize) as ::core::ffi::c_int
                    ...
                    & 2i32) as crate::stdlib::int16_t;
                (*h).mb.cache.i_cbp_left = *cbp.offset(ltop as isize) as ::core::ffi::c_int & 0xFFF0i32
            ...
            (*h).mb.cache.intra4x4_pred_mode[(x264_scan8[0usize] as ::core::ffi::c_int - 1i32) as usize] =
                (*i4x4.offset(ltop as isize))[(*left_index_table).intra[0usize] as usize];
            (*h).mb.cache.intra4x4_pred_mode[(x264_scan8[2usize] as ::core::ffi::c_int - 1i32) as usize] =
                (*i4x4.offset(ltop as isize))[(*left_index_table).intra[1usize] as usize];
            (*h).mb.cache.intra4x4_pred_mode[(x264_scan8[8usize] as ::core::ffi::c_int - 1i32) as usize] =
                (*i4x4.offset(lbot as isize))[(*left_index_table).intra[2usize] as usize];
            (*h).mb.cache.intra4x4_pred_mode[(x264_scan8[10usize] as ::core::ffi::c_int - 1i32) as usize] =
                (*i4x4.offset(lbot as isize))[(*left_index_table).intra[3usize] as usize];
            (*h).mb.cache.non_zero_count[(x264_scan8[0usize] as ::core::ffi::c_int - 1i32) as usize] =
                (*nnz.offset(ltop as isize))[(*left_index_table).nnz[0usize] as usize];
            (*h).mb.cache.non_zero_count[(x264_scan8[2usize] as ::core::ffi::c_int - 1i32) as usize] =
                (*nnz.offset(ltop as isize))[(*left_index_table).nnz[1usize] as usize];
            (*h).mb.cache.non_zero_count[(x264_scan8[8usize] as ::core::ffi::c_int - 1i32) as usize] =
                (*nnz.offset(lbot as isize))[(*left_index_table).nnz[2usize] as usize];
            (*h).mb.cache.non_zero_count[(x264_scan8[10usize] as ::core::ffi::c_int - 1i32) as usize] =
            ...
            if (*h).sps.i_chroma_format_idc.is_422() || (*h).sps.i_chroma_format_idc.is_444() {
                ...
                (*h).mb.cache.non_zero_count
                    [(x264_scan8[(16i32 + 0i32) as usize] as ::core::ffi::c_int - 1i32) as usize] = (*nnz
                    .offset(ltop as isize))
                    [((*left_index_table).nnz[0usize] as ::core::ffi::c_int + 16i32 + offset) as usize];
                (*h).mb.cache.non_zero_count
                    [(x264_scan8[(16i32 + 2i32) as usize] as ::core::ffi::c_int - 1i32) as usize] = (*nnz
                    .offset(ltop as isize))
                    [((*left_index_table).nnz[1usize] as ::core::ffi::c_int + 16i32 + offset) as usize];
                (*h).mb.cache.non_zero_count
                    [(x264_scan8[(16i32 + 8i32) as usize] as ::core::ffi::c_int - 1i32) as usize] = (*nnz
                    .offset(lbot as isize))
                    [((*left_index_table).nnz[2usize] as ::core::ffi::c_int + 16i32 + offset) as usize];
                (*h).mb.cache.non_zero_count
                    [(x264_scan8[(16i32 + 10i32) as usize] as ::core::ffi::c_int - 1i32) as usize] = (*nnz
                    .offset(lbot as isize))
                    [((*left_index_table).nnz[3usize] as ::core::ffi::c_int + 16i32 + offset) as usize];
                (*h).mb.cache.non_zero_count
                    [(x264_scan8[(32i32 + 0i32) as usize] as ::core::ffi::c_int - 1i32) as usize] = (*nnz
                    .offset(ltop as isize))
                    [((*left_index_table).nnz[0usize] as ::core::ffi::c_int + 32i32 + offset) as usize];
                (*h).mb.cache.non_zero_count
                    [(x264_scan8[(32i32 + 2i32) as usize] as ::core::ffi::c_int - 1i32) as usize] = (*nnz
                    .offset(ltop as isize))
                    [((*left_index_table).nnz[1usize] as ::core::ffi::c_int + 32i32 + offset) as usize];
                (*h).mb.cache.non_zero_count
                    [(x264_scan8[(32i32 + 8i32) as usize] as ::core::ffi::c_int - 1i32) as usize] = (*nnz
                    .offset(lbot as isize))
                    [((*left_index_table).nnz[2usize] as ::core::ffi::c_int + 32i32 + offset) as usize];
                (*h).mb.cache.non_zero_count
                    [(x264_scan8[(32i32 + 10i32) as usize] as ::core::ffi::c_int - 1i32) as usize] = (*nnz
                    .offset(lbot as isize))
                    [((*left_index_table).nnz[3usize] as ::core::ffi::c_int + 32i32 + offset) as usize];
            } else {
                (*h).mb.cache.non_zero_count
            ...
            (*h).mb.cache.intra4x4_pred_mode[(x264_scan8[0usize] as ::core::ffi::c_int - 1i32) as usize] =
                (*h).mb.cache.intra4x4_pred_mode[(x264_scan8[2usize] as ::core::ffi::c_int - 1i32) as usize];
            (*h).mb.cache.non_zero_count
                [(x264_scan8[(32i32 + 2i32) as usize] as ::core::ffi::c_int - 1i32) as usize] = 0x80u8;
            (*h).mb.cache.non_zero_count
                [(x264_scan8[(32i32 + 0i32) as usize] as ::core::ffi::c_int - 1i32) as usize] =
                (*h).mb.cache.non_zero_count
                    [(x264_scan8[(32i32 + 2i32) as usize] as ::core::ffi::c_int - 1i32) as usize];
            ...
            if (*h).sps.i_chroma_format_idc.is_422() || (*h).sps.i_chroma_format_idc.is_444() {
                (*h).mb.cache.non_zero_count
                    [(x264_scan8[(32i32 + 10i32) as usize] as ::core::ffi::c_int - 1i32) as usize] = 0x80u8;
                (*h).mb.cache.non_zero_count
                    [(x264_scan8[(32i32 + 8i32) as usize] as ::core::ffi::c_int - 1i32) as usize] =
                    (*h).mb.cache.non_zero_count
                        [(x264_scan8[(32i32 + 10i32) as usize] as ::core::ffi::c_int - 1i32) as usize];
                (*h).mb.cache.non_zero_count
                    [(x264_scan8[(16i32 + 10i32) as usize] as ::core::ffi::c_int - 1i32) as usize] =
                    (*h).mb.cache.non_zero_count
                        [(x264_scan8[(32i32 + 8i32) as usize] as ::core::ffi::c_int - 1i32) as usize];
                (*h).mb.cache.non_zero_count
        ...
        if (*(&raw mut (*h).pps as *mut crate::src::common::set::x264_pps_t)).transform_8x8_mode {
            (*h).mb.cache.i_neighbour_transform_size =
                ((*h).mb.i_neighbour & crate::src::common::macroblock::MB_LEFT != 0
                    && *(*h).mb.mb_transform_size.offset(*left.offset(0isize) as isize) as ::core::ffi::c_int
                        != 0) as ::core::ffi::c_int
        ...
        if b_mbaff != 0 {
            (*h).mb.pic.i_fref[0usize] = (*h).i_ref[0usize] << (*h).mb.interlaced as ::core::ffi::c_int;
            (*h).mb.pic.i_fref[1usize] = (*h).i_ref[1usize] << (*h).mb.interlaced as ::core::ffi::c_int;
        }
        if b_mbaff == 0 {
            x264_8_copy_column8(
        ...
        if !(*(*h).fdec).integral.is_null() {
            ...
            while list < 2i32 {
                ...
                while i < (*h).mb.pic.i_fref[list as usize] {
                    (*h).mb.pic.p_integral[list as usize][i as usize] = (**(&raw mut *(&raw mut (*h).fref
                        as *mut [*mut crate::src::common::frame::x264_frame_t; 19])
        ...
        while l_0 < lists {
            ...
            if (*h).mb.i_neighbour & crate::src::common::macroblock::MB_TOP != 0 {
                ...
                (*((&raw mut *(&raw mut (*h).mb.cache.ref_0 as *mut [crate::stdlib::int8_t; 40])
                    ...
                    as *mut crate::src::common::base::x264_union32_t))
                    .i =
                    (-(2i32) as crate::stdlib::uint8_t as ::core::ffi::c_uint).wrapping_mul(0x1010101u32);
            }
                ...
                if b_mbaff != 0 {
                    ...
                    (*(&raw mut *(&raw mut *(&raw mut (*h).mb.cache.mv
                        ...
                        (*(&raw mut (*h).mb.left_b4 as *mut ::core::ffi::c_int).offset(0isize)
                            + 3i32
                            + s4x4
                                * *(&raw const (*left_index_table).mv as *const crate::stdlib::uint8_t)
                                    .offset(0isize) as ::core::ffi::c_int) as isize,
                    ) as *mut crate::src::common::base::x264_union32_t))
                        .i;
                    (*(&raw mut *(&raw mut *(&raw mut (*h).mb.cache.mv
                        as *mut [[crate::stdlib::int16_t; 2]; 40])
                        ...
                        (*(&raw mut (*h).mb.left_b4 as *mut ::core::ffi::c_int).offset(0isize)
                            ...
                            + s4x4
                                * *(&raw const (*left_index_table).mv as *const crate::stdlib::uint8_t)
                                    .offset(1isize) as ::core::ffi::c_int) as isize,
                    ) as *mut crate::src::common::base::x264_union32_t))
                        .i;
                    (*(&raw mut *(&raw mut *(&raw mut (*h).mb.cache.mv
                        as *mut [[crate::stdlib::int16_t; 2]; 40])
                        ...
                        (*(&raw mut (*h).mb.left_b4 as *mut ::core::ffi::c_int).offset(1isize)
                            ...
                            + s4x4
                                * *(&raw const (*left_index_table).mv as *const crate::stdlib::uint8_t)
                                    .offset(2isize) as ::core::ffi::c_int) as isize,
                    ) as *mut crate::src::common::base::x264_union32_t))
                        .i;
                    (*(&raw mut *(&raw mut *(&raw mut (*h).mb.cache.mv
                        as *mut [[crate::stdlib::int16_t; 2]; 40])
                        ...
                        (*(&raw mut (*h).mb.left_b4 as *mut ::core::ffi::c_int).offset(1isize)
                            ...
                            + s4x4
                                * *(&raw const (*left_index_table).mv as *const crate::stdlib::uint8_t)
                                    .offset(3isize) as ::core::ffi::c_int) as isize,
                    ) as *mut crate::src::common::base::x264_union32_t))
                        .i;
                } else {
            ...
            if b_mbaff != 0 && (*h).mb.i_neighbour & crate::src::common::macroblock::MB_LEFT != 0 {
                if (*h).mb.interlaced && *(*h).mb.field.offset(((*h).mb.i_mb_xy - 1i32) as isize) == 0 {
                    ...
                    && *(*h).mb.field.offset(((*h).mb.i_mb_xy - 1i32) as isize) as ::core::ffi::c_int != 0
                {
            ...
            if (*h).param.cabac {
                ...
                if (*h).mb.i_neighbour & crate::src::common::macroblock::MB_LEFT != 0
                    && (b_mbaff == 0
                        || (*h).mb.cache.ref_0[l_0 as usize]
                            [(x264_scan8[0usize] as ::core::ffi::c_int - 1i32 + 2i32 * 8i32) as usize]
                            as ::core::ffi::c_int
                            >= 0i32)
                {
                    (*(&raw mut *(&raw mut *(&raw mut (*h).mb.cache.mvd
            ...
            if b_mbaff != 0 {
                if (*h).mb.interlaced {
                    if (*h).mb.i_mb_topleft_xy >= 0i32
                        ...
                        && (*h).mb.cache.ref_0[l_0 as usize]
                            [(x264_scan8[0usize] as ::core::ffi::c_int - 1i32 - 1i32 * 8i32) as usize]
                            as ::core::ffi::c_int
                            >= 0i32
                    {
                        (*h).mb.cache.ref_0[l_0 as usize]
                            ...
                            (((*h).mb.cache.ref_0[l_0 as usize]
                                [(x264_scan8[0usize] as ::core::ffi::c_int - 1i32 - 1i32 * 8i32) as usize]
                                as ::core::ffi::c_int)
                                << 1i32) as crate::stdlib::int8_t;
                        (*h).mb.cache.mv[l_0 as usize]
                            [(x264_scan8[0usize] as ::core::ffi::c_int - 1i32 - 1i32 * 8i32) as usize]
                            [1usize] = ((*h).mb.cache.mv[l_0 as usize]
                            [(x264_scan8[0usize] as ::core::ffi::c_int - 1i32 - 1i32 * 8i32) as usize][1usize]
                            as ::core::ffi::c_int
                            / 2i32) as crate::stdlib::int16_t;
                        (*h).mb.cache.mvd[l_0 as usize]
                            [(x264_scan8[0usize] as ::core::ffi::c_int - 1i32 - 1i32 * 8i32) as usize]
                            [1usize] = ((*h).mb.cache.mvd[l_0 as usize]
                            [(x264_scan8[0usize] as ::core::ffi::c_int - 1i32 - 1i32 * 8i32) as usize][1usize]
                            as ::core::ffi::c_int
                    ...
                    if top >= 0i32 && *(*h).mb.field.offset(top as isize) == 0 {
                        if (*h).mb.cache.ref_0[l_0 as usize]
                            [(x264_scan8[0usize] as ::core::ffi::c_int + 0i32 - 1i32 * 8i32) as usize]
                            as ::core::ffi::c_int
                            >= 0i32
                        {
                            (*h).mb.cache.ref_0[l_0 as usize]
                        ...
                        if (*h).mb.cache.ref_0[l_0 as usize]
                            [(x264_scan8[0usize] as ::core::ffi::c_int + 2i32 - 1i32 * 8i32) as usize]
                            as ::core::ffi::c_int
                            >= 0i32
                        {
                            (*h).mb.cache.ref_0[l_0 as usize]
                        ...
                        if (*h).mb.cache.ref_0[l_0 as usize]
                            [(x264_scan8[0usize] as ::core::ffi::c_int + 3i32 - 1i32 * 8i32) as usize]
                            as ::core::ffi::c_int
                            >= 0i32
                        {
                            (*h).mb.cache.ref_0[l_0 as usize]
                    ...
                    if (*h).mb.i_mb_topright_xy >= 0i32
                        ...
                        && (*h).mb.cache.ref_0[l_0 as usize]
                            [(x264_scan8[0usize] as ::core::ffi::c_int + 4i32 - 1i32 * 8i32) as usize]
                            as ::core::ffi::c_int
                            >= 0i32
                    {
                        (*h).mb.cache.ref_0[l_0 as usize]
                        ...
                        (*h).mb.cache.mv[l_0 as usize]
                            [(x264_scan8[0usize] as ::core::ffi::c_int + 4i32 - 1i32 * 8i32) as usize]
                            [1usize] = ((*h).mb.cache.mv[l_0 as usize]
                            [(x264_scan8[0usize] as ::core::ffi::c_int + 4i32 - 1i32 * 8i32) as usize][1usize]
                            as ::core::ffi::c_int
                            / 2i32) as crate::stdlib::int16_t;
                        (*h).mb.cache.mvd[l_0 as usize]
                            [(x264_scan8[0usize] as ::core::ffi::c_int + 4i32 - 1i32 * 8i32) as usize]
                    ...
                    {
                        if (*h).mb.cache.ref_0[l_0 as usize]
                            [(x264_scan8[0usize] as ::core::ffi::c_int - 1i32 + 0i32 * 8i32) as usize]
                            as ::core::ffi::c_int
                            >= 0i32
                        {
                            (*h).mb.cache.ref_0[l_0 as usize]
                        ...
                        if (*h).mb.cache.ref_0[l_0 as usize]
                            [(x264_scan8[0usize] as ::core::ffi::c_int - 1i32 + 3i32 * 8i32) as usize]
                            as ::core::ffi::c_int
                            >= 0i32
                        {
                            (*h).mb.cache.ref_0[l_0 as usize]
                        ...
                        if (*h).mb.cache.topright_ref[l_0 as usize][0usize] as ::core::ffi::c_int >= 0i32 {
                            (*h).mb.cache.topright_ref[l_0 as usize][0usize] =
                                (((*h).mb.cache.topright_ref[l_0 as usize][0usize] as ::core::ffi::c_int)
                                    << 1i32) as crate::stdlib::int8_t;
                            (*h).mb.cache.topright_mv[l_0 as usize][0usize][1usize] =
                                ((*h).mb.cache.topright_mv[l_0 as usize][0usize][1usize]
                                    as ::core::ffi::c_int
                                    / 2i32) as crate::stdlib::int16_t;
                            (*h).mb.cache.mvd[l_0 as usize][0usize][1usize] =
                                ((*h).mb.cache.mvd[l_0 as usize][0usize][1usize] as ::core::ffi::c_int
                                    >> 1i32) as crate::stdlib::uint8_t;
                        }
                        if (*h).mb.cache.topright_ref[l_0 as usize][1usize] as ::core::ffi::c_int >= 0i32 {
                            (*h).mb.cache.topright_ref[l_0 as usize][1usize] =
                                (((*h).mb.cache.topright_ref[l_0 as usize][1usize] as ::core::ffi::c_int)
                                    << 1i32) as crate::stdlib::int8_t;
                            (*h).mb.cache.topright_mv[l_0 as usize][1usize][1usize] =
                                ((*h).mb.cache.topright_mv[l_0 as usize][1usize][1usize]
                                    as ::core::ffi::c_int
                                    / 2i32) as crate::stdlib::int16_t;
                            (*h).mb.cache.mvd[l_0 as usize][1usize][1usize] =
                                ((*h).mb.cache.mvd[l_0 as usize][1usize][1usize] as ::core::ffi::c_int
                                    >> 1i32) as crate::stdlib::uint8_t;
                        }
                        if (*h).mb.cache.topright_ref[l_0 as usize][2usize] as ::core::ffi::c_int >= 0i32 {
                            (*h).mb.cache.topright_ref[l_0 as usize][2usize] =
                                (((*h).mb.cache.topright_ref[l_0 as usize][2usize] as ::core::ffi::c_int)
                                    << 1i32) as crate::stdlib::int8_t;
                            (*h).mb.cache.topright_mv[l_0 as usize][2usize][1usize] =
                                ((*h).mb.cache.topright_mv[l_0 as usize][2usize][1usize]
                                    as ::core::ffi::c_int
                                    / 2i32) as crate::stdlib::int16_t;
                            (*h).mb.cache.mvd[l_0 as usize][2usize][1usize] =
                                ((*h).mb.cache.mvd[l_0 as usize][2usize][1usize] as ::core::ffi::c_int
                                    >> 1i32) as crate::stdlib::uint8_t;
                        }
                    }
                } else {
                    if (*h).mb.i_mb_topleft_xy >= 0i32
                        && *(*h).mb.field.offset((*h).mb.i_mb_topleft_xy as isize) as ::core::ffi::c_int != 0
                        && (*h).mb.cache.ref_0[l_0 as usize]
                            [(x264_scan8[0usize] as ::core::ffi::c_int - 1i32 - 1i32 * 8i32) as usize]
                            as ::core::ffi::c_int
                            >= 0i32
                    ...
                    if (*h).mb.i_mb_topright_xy >= 0i32
                        && *(*h).mb.field.offset((*h).mb.i_mb_topright_xy as isize) as ::core::ffi::c_int != 0
                        && (*h).mb.cache.ref_0[l_0 as usize]
                            [(x264_scan8[0usize] as ::core::ffi::c_int + 4i32 - 1i32 * 8i32) as usize]
                            as ::core::ffi::c_int
                            >= 0i32
                    ...
                    if *left.offset(0isize) >= 0i32
                        && *(*h).mb.field.offset(*left.offset(0isize) as isize) as ::core::ffi::c_int != 0
                    {
                        if (*h).mb.cache.ref_0[l_0 as usize]
                            [(x264_scan8[0usize] as ::core::ffi::c_int - 1i32 + 0i32 * 8i32) as usize]
                            as ::core::ffi::c_int
        ...
        if (*h).param.cabac {
            if b_mbaff != 0 {
                ...
                (*h).mb.cache.i_neighbour_skip =
                    ((*h).mb.i_neighbour & crate::src::common::macroblock::MB_LEFT != 0
                        && !(*h).mb.i_mb_type_left[0usize]
                            .is_some_and(|t| matches!(t, MacroblockType::P_SKIP | MacroblockType::B_SKIP)))
                        as ::core::ffi::c_int
                        + ((*h).mb.i_neighbour & crate::src::common::macroblock::MB_TOP != 0
                            && !(*h).mb.i_mb_type_top.is_some_and(|t| {
            ...
            if (*h).param.cabac {
                ...
                if b_mbaff != 0 {
                    skipbp = (if (*h).mb.i_neighbour & crate::src::common::macroblock::MB_LEFT != 0 {
                        *(*h).mb.skipbp.offset(*left.offset(LTOP as isize) as isize) as ::core::ffi::c_int
                    } else {
                        0i32
                    }) as crate::stdlib::uint8_t;
                    (*h).mb.cache.skip[(x264_scan8[0usize] as ::core::ffi::c_int - 1i32) as usize] =
                        (skipbp as ::core::ffi::c_int
                            >> (1i32 + ((*left_index_table).mv[0usize] as ::core::ffi::c_int & !(1i32)))
                            & 1i32) as crate::stdlib::int8_t;
                    skipbp = (if (*h).mb.i_neighbour & crate::src::common::macroblock::MB_LEFT != 0 {
                        *(*h).mb.skipbp.offset(*left.offset(LBOT as isize) as isize) as ::core::ffi::c_int
                    } else {
                        0i32
                    }) as crate::stdlib::uint8_t;
                    (*h).mb.cache.skip[(x264_scan8[8usize] as ::core::ffi::c_int - 1i32) as usize] =
                        (skipbp as ::core::ffi::c_int
        ...
        (*h).mb.i_neighbour4[1usize] = (crate::src::common::macroblock::MB_LEFT as ::core::ffi::c_int
            | (if (*h).mb.i_neighbour_intra & crate::src::common::macroblock::MB_TOP != 0 {
                crate::src::common::macroblock::MB_TOP as ::core::ffi::c_int
                    | crate::src::common::macroblock::MB_TOPLEFT as ::core::ffi::c_int
                    | crate::src::common::macroblock::MB_TOPRIGHT as ::core::ffi::c_int
        ...
        (*h).mb.i_neighbour8[2usize] = (crate::src::common::macroblock::MB_TOP as ::core::ffi::c_int
            | crate::src::common::macroblock::MB_TOPRIGHT as ::core::ffi::c_int
    ...
    unsafe {
                ...
                != (*h).mb.interlaced as ::core::ffi::c_int
        {
            ...
            static mut offset: [[[crate::stdlib::uint8_t; 8]; 2]; 2] = [
                [[0u8, 0u8, 0u8, 0u8, 1u8, 1u8, 1u8, 1u8], [2u8, 2u8, 2u8, 2u8, 3u8, 3u8, 3u8, 3u8]],
                [[0u8, 1u8, 2u8, 3u8, 0u8, 1u8, 2u8, 3u8], [0u8, 1u8, 2u8, 3u8, 0u8, 1u8, 2u8, 3u8]],
            ];
            ...
            while i < 8i32 {
                let mut left =
                    (*h).mb.i_mb_left_xy[(if (*h).mb.interlaced { i >> 2i32 } else { i & 1i32 }) as usize];
                    ...
                    && (*(&raw mut (*h).pps as *mut crate::src::common::set::x264_pps_t)).transform_8x8_mode
                {
                    ...
                    if *(*h).mb.mb_transform_size.offset(left as isize) != 0 {
                        nnz_left = ((*((&raw mut *nnz.offset(left as isize) as *mut crate::stdlib::uint8_t)
                            .offset((2i32 + 4i32 * j) as isize)
                            as *mut crate::src::common::base::x264_union16_t))
                            .i as ::core::ffi::c_int
                            | (*((&raw mut *nnz.offset(left as isize) as *mut crate::stdlib::uint8_t)
                ...
                tmpbs[i as usize] =
                    (if nnz_left != 0 || nnz_this != 0 { 2i32 } else { 1i32 }) as crate::stdlib::uint8_t;
                i += 1;
            }
            if (*h).mb.interlaced {
                ...
                while i_1 < 4i32 {
                    (*bs.offset(0isize))[4usize][i_1 as usize] = tmpbs[(1i32 + 2i32 * i_1) as usize];
                    i_1 += 1;
                }
            }
        }
...
pub unsafe extern "C" fn x264_8_macroblock_deblock_strength(mut h: *mut crate::src::common::common::x264_t) {
    unsafe {
        ...
        if (*h).mb.transform_8x8 && !((*h).sps.i_chroma_format_idc.is_444()) {
            let mut cbp_mask = 0xFi32 >> ((*h).sps.i_chroma_format_idc.is_420()) as ::core::ffi::c_int;
        ...
        if (*h).sh.i_disable_deblocking_filter_idc != 2i32 {
            neighbour_changed = ((*h).mb.i_neighbour_frame & !(*h).mb.i_neighbour) as ::core::ffi::c_int;
        ...
        if neighbour_changed != 0 {
            ...
            if neighbour_changed & crate::src::common::macroblock::MB_LEFT as ::core::ffi::c_int != 0 {
                let mut left = &raw mut (*h).mb.i_mb_left_xy as *mut ::core::ffi::c_int;
                (*h).mb.cache.non_zero_count[(x264_scan8[0usize] as ::core::ffi::c_int - 1i32) as usize] =
                    (*nnz.offset(*left.offset(0isize) as isize))[(*left_index_table).nnz[0usize] as usize];
                (*h).mb.cache.non_zero_count[(x264_scan8[2usize] as ::core::ffi::c_int - 1i32) as usize] =
                    (*nnz.offset(*left.offset(0isize) as isize))[(*left_index_table).nnz[1usize] as usize];
                (*h).mb.cache.non_zero_count[(x264_scan8[8usize] as ::core::ffi::c_int - 1i32) as usize] =
                    (*nnz.offset(*left.offset(1isize) as isize))[(*left_index_table).nnz[2usize] as usize];
                (*h).mb.cache.non_zero_count[(x264_scan8[10usize] as ::core::ffi::c_int - 1i32) as usize] =
                    (*nnz.offset(*left.offset(1isize) as isize))[(*left_index_table).nnz[3usize] as usize];
            }
            while l
                <= ((*h).sh.i_type == crate::src::common::base::SLICE_TYPE_B as ::core::ffi::c_int)
                    as ::core::ffi::c_int
            ...
            && (*h).sh.i_type == crate::src::common::base::SLICE_TYPE_P as ::core::ffi::c_int
        {
            ...
            (*h).mb.cache.ref_0[0usize][(i8_0 + 1i32) as usize] = (*h).mb.deblock_ref_table
                [((*h).mb.cache.ref_0[0usize][(i8_0 + 0i32) as usize] as ::core::ffi::c_int + 2i32) as usize];
            (*h).mb.cache.ref_0[0usize][(i8_0 + 0i32) as usize] =
                (*h).mb.cache.ref_0[0usize][(i8_0 + 1i32) as usize];
            (*h).mb.cache.ref_0[0usize][(i8_0 + 3i32) as usize] = (*h).mb.deblock_ref_table
                [((*h).mb.cache.ref_0[0usize][(i8_0 + 2i32) as usize] as ::core::ffi::c_int + 2i32) as usize];
            ...
            (*h).mb.cache.ref_0[0usize][(i8_0 + 1i32 * 8i32) as usize] =
                (*h).mb.deblock_ref_table[((*h).mb.cache.ref_0[0usize][(i8_0 + 0i32 * 8i32) as usize]
                    as ::core::ffi::c_int
                    + 2i32) as usize];
            (*h).mb.cache.ref_0[0usize][(i8_0 + 0i32 * 8i32) as usize] =
                (*h).mb.cache.ref_0[0usize][(i8_0 + 1i32 * 8i32) as usize];
            (*h).mb.cache.ref_0[0usize][(i8_0 + 3i32 * 8i32) as usize] =
                (*h).mb.deblock_ref_table[((*h).mb.cache.ref_0[0usize][(i8_0 + 2i32 * 8i32) as usize]
                    as ::core::ffi::c_int
                    + 2i32) as usize];
            (*h).mb.cache.ref_0[0usize][(i8_0 + 2i32 * 8i32) as usize] =
                (*h).mb.cache.ref_0[0usize][(i8_0 + 3i32 * 8i32) as usize];
            let mut ref0 = (*h).mb.deblock_ref_table[((*h).mb.cache.ref_0[0usize][x264_scan8[0usize] as usize]
                as ::core::ffi::c_int
                + 2i32) as usize] as ::core::ffi::c_int;
            let mut ref1 = (*h).mb.deblock_ref_table[((*h).mb.cache.ref_0[0usize][x264_scan8[4usize] as usize]
                as ::core::ffi::c_int
                + 2i32) as usize] as ::core::ffi::c_int;
            let mut ref2 = (*h).mb.deblock_ref_table[((*h).mb.cache.ref_0[0usize][x264_scan8[8usize] as usize]
                as ::core::ffi::c_int
                + 2i32) as usize] as ::core::ffi::c_int;
            ...
            .wrapping_mul(0x101u32);
            (*((&raw mut *(&raw mut (*h).mb.cache.ref_0 as *mut [crate::stdlib::int8_t; 40]).offset(0isize)
            ...
            && (*(&raw mut (*h).pps as *mut crate::src::common::set::x264_pps_t)).transform_8x8_mode
        {
                ...
                && *(*h).mb.mb_transform_size.offset(top as isize) as ::core::ffi::c_int != 0
            {
                ...
                let mut nnz_top0 = (*((&raw mut *nnz_0.offset(top as isize) as *mut crate::stdlib::uint8_t)
                    .offset(8isize)
                    as *mut crate::src::common::base::x264_union16_t))
                    .i as ::core::ffi::c_int
                    | (*((&raw mut *nnz_0.offset(top as isize) as *mut crate::stdlib::uint8_t).offset(12isize)
                        as *mut crate::src::common::base::x264_union16_t))
                        .i as ::core::ffi::c_int;
                let mut nnz_top1 = (*((&raw mut *nnz_0.offset(top as isize) as *mut crate::stdlib::uint8_t)
                    .offset(10isize)
                    as *mut crate::src::common::base::x264_union16_t))
                    .i as ::core::ffi::c_int
                    | (*((&raw mut *nnz_0.offset(top as isize) as *mut crate::stdlib::uint8_t).offset(14isize)
                        as *mut crate::src::common::base::x264_union16_t))
                        .i as ::core::ffi::c_int;
            ...
            if (*h).mb.i_neighbour & crate::src::common::macroblock::MB_LEFT != 0 {
                ...
                if *(*h).mb.mb_transform_size.offset(*left_0.offset(0isize) as isize) != 0 {
                ...
                if *(*h).mb.mb_transform_size.offset(*left_0.offset(1isize) as isize) != 0 {
            ...
            if (*h).mb.transform_8x8 {
                let mut nnz0 = (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t)
                    .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(0isize) as isize)
                    as *mut crate::src::common::base::x264_union16_t))
                    .i as ::core::ffi::c_int
                    | (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t).offset(
                        *(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(2isize) as isize,
                        ...
                        .i as ::core::ffi::c_int;
                let mut nnz1 = (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t)
                    .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(4isize) as isize)
                    as *mut crate::src::common::base::x264_union16_t))
                    .i as ::core::ffi::c_int
                    | (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t).offset(
                        *(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(6isize) as isize,
                    ) as *mut crate::src::common::base::x264_union16_t))
                        .i as ::core::ffi::c_int;
                let mut nnz2 = (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t)
                    .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(8isize) as isize)
                    as *mut crate::src::common::base::x264_union16_t))
                    .i as ::core::ffi::c_int
                    | (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t)
                        .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(10isize)
                            as isize)
                        as *mut crate::src::common::base::x264_union16_t))
                        .i as ::core::ffi::c_int;
                let mut nnz3 =
                    (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t)
                        .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(12isize)
                            as isize)
                        as *mut crate::src::common::base::x264_union16_t))
                        .i as ::core::ffi::c_int
                        | (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t)
                            .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(14isize)
                                as isize)
                            as *mut crate::src::common::base::x264_union16_t))
                            .i as ::core::ffi::c_int;
    ...
    unsafe {
        ...
        crate::stdlib::memcpy(
            (*(&raw mut *(&raw mut (*h).intra_border_backup
                as *mut [*mut crate::src::common::common::pixel; 3])
                .offset(backup_dst as isize) as *mut *mut crate::src::common::common::pixel)
                .offset(0isize))
            .offset((mb_x * 16i32) as isize) as *mut ::core::ffi::c_void,
            (*h).mb.pic.p_fdec[0usize].offset((crate::src::common::common::FDEC_STRIDE * 15i32) as isize)
        ...
        if (*h).sps.i_chroma_format_idc.is_444() {
            crate::stdlib::memcpy(
                (*(&raw mut *(&raw mut (*h).intra_border_backup
                    ...
                    .offset(1isize))
                .offset((mb_x * 16i32) as isize) as *mut ::core::ffi::c_void,
                (*h).mb.pic.p_fdec[1usize].offset((crate::src::common::common::FDEC_STRIDE * 15i32) as isize)
                    as *const ::core::ffi::c_void,
                (16i32 * crate::src::common::common::SIZEOF_PIXEL) as crate::__stddef_size_t_h::size_t,
            );
            crate::stdlib::memcpy(
                (*(&raw mut *(&raw mut (*h).intra_border_backup
                    ...
                    .offset(2isize))
                .offset((mb_x * 16i32) as isize) as *mut ::core::ffi::c_void,
                (*h).mb.pic.p_fdec[2usize].offset((crate::src::common::common::FDEC_STRIDE * 15i32) as isize)
                    as *const ::core::ffi::c_void,
                (16i32 * crate::src::common::common::SIZEOF_PIXEL) as crate::__stddef_size_t_h::size_t,
            );
        } else if !(*h).sps.i_chroma_format_idc.is_400() {
            let mut backup_src = (15i32 >> ((*h).sps.i_chroma_format_idc.is_420()) as ::core::ffi::c_int)
            ...
            crate::stdlib::memcpy(
                (*(&raw mut *(&raw mut (*h).intra_border_backup
                    ...
                    .offset(1isize))
                .offset((mb_x * 16i32) as isize) as *mut ::core::ffi::c_void,
                (*h).mb.pic.p_fdec[1usize].offset(backup_src as isize) as *const ::core::ffi::c_void,
                (8i32 * crate::src::common::common::SIZEOF_PIXEL) as crate::__stddef_size_t_h::size_t,
            );
            crate::stdlib::memcpy(
                (*(&raw mut *(&raw mut (*h).intra_border_backup
                ...
                (*h).mb.pic.p_fdec[2usize].offset(backup_src as isize) as *const ::core::ffi::c_void,
                (8i32 * crate::src::common::common::SIZEOF_PIXEL) as crate::__stddef_size_t_h::size_t,
            );
        }
        if b_mbaff != 0 && mb_y & 1i32 != 0 {
            let mut backup_src_0 =
                (if (*h).mb.interlaced { 7i32 } else { 14i32 }) * crate::src::common::common::FDEC_STRIDE;
            ...
            crate::stdlib::memcpy(
                (*(&raw mut *(&raw mut (*h).intra_border_backup
                    ...
                    .offset(0isize))
                .offset((mb_x * 16i32) as isize) as *mut ::core::ffi::c_void,
                (*h).mb.pic.p_fdec[0usize].offset(backup_src_0 as isize) as *const ::core::ffi::c_void,
                (16i32 * crate::src::common::common::SIZEOF_PIXEL) as crate::__stddef_size_t_h::size_t,
            );
            if (*h).sps.i_chroma_format_idc.is_444() {
                crate::stdlib::memcpy(
                    (*(&raw mut *(&raw mut (*h).intra_border_backup
                        ...
                        .offset(1isize))
                    .offset((mb_x * 16i32) as isize) as *mut ::core::ffi::c_void,
                    (*h).mb.pic.p_fdec[1usize].offset(backup_src_0 as isize) as *const ::core::ffi::c_void,
                    (16i32 * crate::src::common::common::SIZEOF_PIXEL) as crate::__stddef_size_t_h::size_t,
                );
                crate::stdlib::memcpy(
                    (*(&raw mut *(&raw mut (*h).intra_border_backup
                        ...
                        .offset(2isize))
                    .offset((mb_x * 16i32) as isize) as *mut ::core::ffi::c_void,
                    (*h).mb.pic.p_fdec[2usize].offset(backup_src_0 as isize) as *const ::core::ffi::c_void,
                    (16i32 * crate::src::common::common::SIZEOF_PIXEL) as crate::__stddef_size_t_h::size_t,
                );
            } else if !(*h).sps.i_chroma_format_idc.is_400() {
...
pub unsafe extern "C" fn x264_8_macroblock_cache_save(mut h: *mut crate::src::common::common::x264_t) {
    unsafe {
        ...
        let mut i4x4 =
            &raw mut *(*h).mb.intra4x4_pred_mode.offset(i_mb_xy as isize) as *mut crate::stdlib::int8_t;
        let mut nnz =
            &raw mut *(*h).mb.non_zero_count.offset(i_mb_xy as isize) as *mut crate::stdlib::uint8_t;
        if (*h).sh.mbaff {
        ...
        *(*h).mb.partition.add((i_mb_xy - (*h).sh.i_first_mb) as usize) = if i_mb_type
            == MacroblockType::I_4x4
        ...
        if i_mb_type == MacroblockType::I_4x4 {
            (*(i4x4.offset(0isize) as *mut crate::src::common::base::x264_union32_t)).i = (*((&raw mut (*h)
                .mb
                .cache
                .intra4x4_pred_mode
                as *mut crate::stdlib::int8_t)
                .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(10isize) as isize)
                as *mut crate::src::common::base::x264_union32_t))
                .i;
            (*(i4x4.offset(4isize) as *mut crate::src::common::base::x264_union32_t)).i = pack8to32(
                (*h).mb.cache.intra4x4_pred_mode[x264_scan8[5usize] as usize] as crate::stdlib::uint32_t,
                (*h).mb.cache.intra4x4_pred_mode[x264_scan8[7usize] as usize] as crate::stdlib::uint32_t,
                (*h).mb.cache.intra4x4_pred_mode[x264_scan8[13usize] as usize] as crate::stdlib::uint32_t,
                0u32,
            );
                ...
                || i_mb_type == MacroblockType::I_PCM)
        {
            ...
            (*(i4x4 as *mut crate::src::common::base::x264_union64_t)).i = (-(1i32) as crate::stdlib::uint8_t
                as ::core::ffi::c_ulonglong)
                .wrapping_mul(0x101010101010101u64);
        }
        if i_mb_type == MacroblockType::I_PCM {
            ...
            *(*h).mb.qp.offset(i_mb_xy as isize) = 0i8;
            ...
            (*h).mb.i_cbp_chroma = if (*h).sps.i_chroma_format_idc.is_444() { 0i32 } else { 2i32 };
            (*h).mb.i_cbp_luma = 0xFi32;
            *(*h).mb.cbp.offset(i_mb_xy as isize) =
                ((*h).mb.i_cbp_chroma << 4i32 | (*h).mb.i_cbp_luma | 0x1700i32) as crate::stdlib::int16_t;
        ...
        (*(nnz.offset((0i32 + 0i32 * 4i32) as isize) as *mut crate::src::common::base::x264_union32_t)).i =
            (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t)
                .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(0isize) as isize)
                as *mut crate::src::common::base::x264_union32_t))
                .i;
        (*(nnz.offset((0i32 + 1i32 * 4i32) as isize) as *mut crate::src::common::base::x264_union32_t)).i =
            (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t)
                .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(2isize) as isize)
                as *mut crate::src::common::base::x264_union32_t))
                .i;
        (*(nnz.offset((0i32 + 2i32 * 4i32) as isize) as *mut crate::src::common::base::x264_union32_t)).i =
            (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t)
                .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(8isize) as isize)
                as *mut crate::src::common::base::x264_union32_t))
                .i;
        (*(nnz.offset((0i32 + 3i32 * 4i32) as isize) as *mut crate::src::common::base::x264_union32_t)).i =
            (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t)
                .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(10isize) as isize)
                as *mut crate::src::common::base::x264_union32_t))
                .i;
        (*(nnz.offset((16i32 + 0i32 * 4i32) as isize) as *mut crate::src::common::base::x264_union32_t)).i =
            (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t).offset(
                *(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset((16i32 + 0i32) as isize)
                    as isize,
            ) as *mut crate::src::common::base::x264_union32_t))
                .i;
        (*(nnz.offset((16i32 + 1i32 * 4i32) as isize) as *mut crate::src::common::base::x264_union32_t)).i =
            (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t).offset(
                *(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset((16i32 + 2i32) as isize)
                    as isize,
            ) as *mut crate::src::common::base::x264_union32_t))
                .i;
        (*(nnz.offset((32i32 + 0i32 * 4i32) as isize) as *mut crate::src::common::base::x264_union32_t)).i =
            (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t).offset(
                *(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset((32i32 + 0i32) as isize)
                    as isize,
            ) as *mut crate::src::common::base::x264_union32_t))
                .i;
        (*(nnz.offset((32i32 + 1i32 * 4i32) as isize) as *mut crate::src::common::base::x264_union32_t)).i =
            (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t).offset(
                *(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset((32i32 + 2i32) as isize)
                    as isize,
            ) as *mut crate::src::common::base::x264_union32_t))
                .i;
        if (*h).sps.i_chroma_format_idc.is_422() || (*h).sps.i_chroma_format_idc.is_444() {
            (*(nnz.offset((16i32 + 2i32 * 4i32) as isize)
                ...
                *(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset((16i32 + 8i32) as isize)
                    as isize,
            ) as *mut crate::src::common::base::x264_union32_t))
                .i;
            (*(nnz.offset((16i32 + 3i32 * 4i32) as isize)
                as *mut crate::src::common::base::x264_union32_t))
                .i = (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t).offset(
                *(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset((16i32 + 10i32) as isize)
                    as isize,
            ) as *mut crate::src::common::base::x264_union32_t))
                .i;
            (*(nnz.offset((32i32 + 2i32 * 4i32) as isize)
                as *mut crate::src::common::base::x264_union32_t))
                .i = (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t).offset(
                *(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset((32i32 + 8i32) as isize)
                    as isize,
            ) as *mut crate::src::common::base::x264_union32_t))
                .i;
            (*(nnz.offset((32i32 + 3i32 * 4i32) as isize)
                as *mut crate::src::common::base::x264_union32_t))
                .i = (*((&raw mut (*h).mb.cache.non_zero_count as *mut crate::stdlib::uint8_t).offset(
                *(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset((32i32 + 10i32) as isize)
                    as isize,
            ) as *mut crate::src::common::base::x264_union32_t))
                .i;
        }
        ...
        *(*h).mb.mb_transform_size.offset(i_mb_xy as isize) = (*h).mb.transform_8x8 as crate::stdlib::int8_t;
        if (*h).sh.i_type != crate::src::common::base::SLICE_TYPE_I as ::core::ffi::c_int {
            let mut mv0 = (*(&raw mut (*h).mb.mv as *mut *mut [crate::stdlib::int16_t; 2]).offset(0isize))
                .offset(i_mb_4x4 as isize);
            let mut ref0 = (*(&raw mut (*h).mb.ref_0 as *mut *mut crate::stdlib::int8_t).offset(0isize))
                ...
                || i_mb_type == MacroblockType::I_PCM)
            {
                ...
                *ref0.offset((1i32 + 1i32 * s8x8) as isize) =
                ...
                (*(mv0.offset((0i32 * s4x4) as isize) as *mut crate::src::common::base::x264_union128_t)).i =
                    (*(&raw mut *(&raw mut *(&raw mut (*h).mb.cache.mv
                        as *mut [[crate::stdlib::int16_t; 2]; 40])
                        ...
                        .i;
                (*(mv0.offset((1i32 * s4x4) as isize) as *mut crate::src::common::base::x264_union128_t)).i =
                    (*(&raw mut *(&raw mut *(&raw mut (*h).mb.cache.mv
                        as *mut [[crate::stdlib::int16_t; 2]; 40])
                        .offset(0isize) as *mut [crate::stdlib::int16_t; 2])
                        .offset(
                        ...
                        .i;
                (*(mv0.offset((2i32 * s4x4) as isize) as *mut crate::src::common::base::x264_union128_t)).i =
                    (*(&raw mut *(&raw mut *(&raw mut (*h).mb.cache.mv
                        as *mut [[crate::stdlib::int16_t; 2]; 40])
                        .offset(0isize) as *mut [crate::stdlib::int16_t; 2])
                        .offset(
                        ...
                        .i;
                (*(mv0.offset((3i32 * s4x4) as isize) as *mut crate::src::common::base::x264_union128_t)).i =
                    (*(&raw mut *(&raw mut *(&raw mut (*h).mb.cache.mv
                        as *mut [[crate::stdlib::int16_t; 2]; 40])
                        .offset(0isize) as *mut [crate::stdlib::int16_t; 2])
                        .offset(
                ...
                (*(ref0.offset((0i32 * s8x8) as isize) as *mut crate::src::common::base::x264_union16_t)).i =
                    (-(1i32) as crate::stdlib::uint8_t as ::core::ffi::c_int * 0x101i32)
                        as crate::stdlib::uint16_t;
                (*(ref0.offset((1i32 * s8x8) as isize) as *mut crate::src::common::base::x264_union16_t)).i =
                    (-(1i32) as crate::stdlib::uint8_t as ::core::ffi::c_int * 0x101i32)
                        as crate::stdlib::uint16_t;
                (*(mv0.offset((0i32 * s4x4) as isize) as *mut crate::src::common::base::x264_union128_t)).i =
                    crate::src::common::base::M128_ZERO;
                (*(mv0.offset((1i32 * s4x4) as isize) as *mut crate::src::common::base::x264_union128_t)).i =
                    crate::src::common::base::M128_ZERO;
                (*(mv0.offset((2i32 * s4x4) as isize) as *mut crate::src::common::base::x264_union128_t)).i =
                    crate::src::common::base::M128_ZERO;
                (*(mv0.offset((3i32 * s4x4) as isize) as *mut crate::src::common::base::x264_union128_t)).i =
                    crate::src::common::base::M128_ZERO;
                if (*h).sh.i_type == crate::src::common::base::SLICE_TYPE_B as ::core::ffi::c_int {
                    let mut mv1_0 = (*(&raw mut (*h).mb.mv as *mut *mut [crate::stdlib::int16_t; 2])
                        .offset(1isize))
                    .offset(i_mb_4x4 as isize);
        ...
        if (*h).param.cabac {
            let mut mvd0 = &raw mut *(*(&raw mut (*h).mb.mvd as *mut *mut [[crate::stdlib::uint8_t; 2]; 8])
                .offset(0isize))
            ...
            if 0x3FF30i32 >> (i_mb_type as u32) & 1i32 != 0 {
                (*(&raw mut *mvd0.offset(0isize) as *mut crate::src::common::base::x264_union64_t)).i =
                    (*(&raw mut *(&raw mut *(&raw mut (*h).mb.cache.mvd
                        as *mut [[crate::stdlib::uint8_t; 2]; 40])
                        .offset(0isize) as *mut [crate::stdlib::uint8_t; 2])
                        .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(10isize)
                            as isize)
                        as *mut crate::src::common::base::x264_union64_t))
                        .i;
                (*(&raw mut *mvd0.offset(4isize) as *mut crate::src::common::base::x264_union16_t)).i =
                    (*(&raw mut *(&raw mut *(&raw mut (*h).mb.cache.mvd
                        as *mut [[crate::stdlib::uint8_t; 2]; 40])
                        .offset(0isize) as *mut [crate::stdlib::uint8_t; 2])
                        .offset(
                            *(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(5isize) as isize
                        ) as *mut crate::src::common::base::x264_union16_t))
                        .i;
                (*(&raw mut *mvd0.offset(5isize) as *mut crate::src::common::base::x264_union16_t)).i =
                    (*(&raw mut *(&raw mut *(&raw mut (*h).mb.cache.mvd
                        as *mut [[crate::stdlib::uint8_t; 2]; 40])
                        .offset(0isize) as *mut [crate::stdlib::uint8_t; 2])
                        .offset(
                            *(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(7isize) as isize
                        ) as *mut crate::src::common::base::x264_union16_t))
                        .i;
                (*(&raw mut *mvd0.offset(6isize) as *mut crate::src::common::base::x264_union16_t)).i =
                    (*(&raw mut *(&raw mut *(&raw mut (*h).mb.cache.mvd
                        as *mut [[crate::stdlib::uint8_t; 2]; 40])
                        .offset(0isize) as *mut [crate::stdlib::uint8_t; 2])
                        .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(13isize)
                            as isize)
                        as *mut crate::src::common::base::x264_union16_t))
                        .i;
                if (*h).sh.i_type == crate::src::common::base::SLICE_TYPE_B as ::core::ffi::c_int {
                    let mut mvd1 =
                        &raw mut *(*(&raw mut (*h).mb.mvd as *mut *mut [[crate::stdlib::uint8_t; 2]; 8])
                            .offset(1isize))
                        .offset(i_mb_xy as isize) as *mut [crate::stdlib::uint8_t; 2];
                    (*(&raw mut *mvd1.offset(0isize) as *mut crate::src::common::base::x264_union64_t)).i =
                        (*(&raw mut *(&raw mut *(&raw mut (*h).mb.cache.mvd
                            as *mut [[crate::stdlib::uint8_t; 2]; 40])
                            .offset(1isize)
                            as *mut [crate::stdlib::uint8_t; 2])
                            ...
                            as *mut crate::src::common::base::x264_union64_t))
                            .i;
                    (*(&raw mut *mvd1.offset(4isize) as *mut crate::src::common::base::x264_union16_t)).i =
                        (*(&raw mut *(&raw mut *(&raw mut (*h).mb.cache.mvd
                            as *mut [[crate::stdlib::uint8_t; 2]; 40])
                            .offset(1isize)
                            as *mut [crate::stdlib::uint8_t; 2])
                            .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(5isize)
                                as isize)
                            as *mut crate::src::common::base::x264_union16_t))
                            .i;
                    (*(&raw mut *mvd1.offset(5isize) as *mut crate::src::common::base::x264_union16_t)).i =
                        (*(&raw mut *(&raw mut *(&raw mut (*h).mb.cache.mvd
                            as *mut [[crate::stdlib::uint8_t; 2]; 40])
                            .offset(1isize)
                            as *mut [crate::stdlib::uint8_t; 2])
                            .offset(*(&raw const x264_scan8 as *const crate::stdlib::uint8_t).offset(7isize)
                                as isize)
                            as *mut crate::src::common::base::x264_union16_t))
                            .i;
                    (*(&raw mut *mvd1.offset(6isize) as *mut crate::src::common::base::x264_union16_t)).i =
                        (*(&raw mut *(&raw mut *(&raw mut (*h).mb.cache.mvd
                            as *mut [[crate::stdlib::uint8_t; 2]; 40])
                            .offset(1isize)
                            as *mut [crate::stdlib::uint8_t; 2])
                ...
                (*(&raw mut *mvd0.offset(0isize) as *mut crate::src::common::base::x264_union128_t)).i =
                    crate::src::common::base::M128_ZERO;
                if (*h).sh.i_type == crate::src::common::base::SLICE_TYPE_B as ::core::ffi::c_int {
                    let mut mvd1_0 =
                        &raw mut *(*(&raw mut (*h).mb.mvd as *mut *mut [[crate::stdlib::uint8_t; 2]; 8])
                            .offset(1isize))
                        .offset(i_mb_xy as isize) as *mut [crate::stdlib::uint8_t; 2];
                    (*(&raw mut *mvd1_0.offset(0isize) as *mut crate::src::common::base::x264_union128_t))
                        .i = crate::src::common::base::M128_ZERO;
                }
            }
            if (*h).sh.i_type == crate::src::common::base::SLICE_TYPE_B as ::core::ffi::c_int {
...
pub unsafe extern "C" fn x264_8_macroblock_bipred_init(mut h: *mut crate::src::common::common::x264_t) {
    unsafe {
            ...
            while field <= (*h).sh.mbaff as ::core::ffi::c_int {
                ...
                while i_ref0 < (*h).i_ref[0usize] << mbfield {
                    ...
                    while i_ref1 < (*h).i_ref[1usize] << mbfield {
                        ...
                        let mut poc1 =
                            (*l1).i_poc + mbfield * (*l1).i_delta_poc[(field ^ i_ref1 & 1i32) as usize];
                        ...
                        if td == 0i32 {
                            ...
                            (*h).mb.bipred_weight_buf[mbfield as usize][field as usize][i_ref0 as usize]
                                [i_ref1 as usize] = 32i8;
                        } else {
