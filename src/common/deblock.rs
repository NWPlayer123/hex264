...
unsafe extern "C" fn deblock_edge_luma_c(
    ...
    unsafe {
        let mut p2: ::core::ffi::c_int = *pix.offset(-3isize * xstride) as ::core::ffi::c_int;
        let mut p1: ::core::ffi::c_int = *pix.offset(-2isize * xstride) as ::core::ffi::c_int;
        let mut p0: ::core::ffi::c_int = *pix.offset(-1isize * xstride) as ::core::ffi::c_int;
        let mut q0: ::core::ffi::c_int = *pix.offset(0isize * xstride) as ::core::ffi::c_int;
        let mut q1: ::core::ffi::c_int = *pix.offset(1isize * xstride) as ::core::ffi::c_int;
        let mut q2: ::core::ffi::c_int = *pix.offset(2isize * xstride) as ::core::ffi::c_int;
            ...
            && crate::stdlib::abs(q1 - q0) < beta
        {
            ...
            let mut delta: ::core::ffi::c_int =
                x264_clip3((q0 - p0) * 4i32 + (p1 - q1) + 4i32 >> 3i32, -tc, tc);
            ...
            if crate::stdlib::abs(p0 - q0) < (alpha >> 2i32) + 2i32 {
                if crate::stdlib::abs(p2 - p0) < beta {
                    let p3: ::core::ffi::c_int =
                        *pix.offset(-4isize * xstride) as ::core::ffi::c_int;
                    *pix.offset(-1isize * xstride) =
                ...
                if crate::stdlib::abs(q2 - q0) < beta {
                    let q3: ::core::ffi::c_int =
                        *pix.offset(3isize * xstride) as ::core::ffi::c_int;
...
unsafe extern "C" fn deblock_strength_c(
    ...
    unsafe {
        let mut dir: ::core::ffi::c_int = 0i32;
        while dir < 2i32 {
            let mut s1: ::core::ffi::c_int = if dir != 0 { 1i32 } else { 8i32 };
            let mut s2: ::core::ffi::c_int = if dir != 0 { 8i32 } else { 1i32 };
            let mut edge: ::core::ffi::c_int = 0i32;
            while edge < 4i32 {
                let mut i: ::core::ffi::c_int = 0i32;
...
unsafe extern "C" fn deblock_edge(
    ...
    unsafe {
        ...
        let mut alpha: ::core::ffi::c_int = (i_alpha_table[(index_a + 24i32) as usize]
            as ::core::ffi::c_int)
            << crate::internal::BIT_DEPTH - 8i32;
        let mut beta: ::core::ffi::c_int = (i_beta_table[(index_b + 24i32) as usize]
            as ::core::ffi::c_int)
            << crate::internal::BIT_DEPTH - 8i32;
...
pub unsafe extern "C" fn x264_8_frame_deblock_row(
    ...
    unsafe {
        ...
        let mut qp_thresh: ::core::ffi::c_int = 15i32
            - (if a < b { a } else { b })
            - (if 0i32
        ...
        let mut stridey: ::core::ffi::c_int = (*(*h).fdec).i_stride[0usize];
        let mut strideuv: ::core::ffi::c_int = (*(*h).fdec).i_stride[1usize];
        ...
        let mut chroma444: ::core::ffi::c_int = (crate::src::common::base::CHROMA_444
            ...
            == crate::src::common::base::CHROMA_444 as ::core::ffi::c_int)
            as ::core::ffi::c_int;
        let mut chroma_height: ::core::ffi::c_int = 16i32
            >> (crate::src::common::base::CHROMA_444 as ::core::ffi::c_int
        ...
        while mb_x < (*h).mb.i_mb_width {
            ...
            let mut pixy: *mut crate::src::common::common::pixel = (*(*h).fdec).plane[0usize]
            ...
            if (*h).mb.i_neighbour & crate::src::common::macroblock::MB_LEFT != 0 {
                        ...
                        != (*h).mb.b_interlaced
                {
                    ...
                    let mut c: ::core::ffi::c_int = if chroma444 != 0 { 0i32 } else { 1i32 };
            ...
            if (*h).mb.i_neighbour & crate::src::common::macroblock::MB_TOP != 0 {
                if b_interlaced != 0
                    ...
                    && *(*h).mb.field.offset((*h).mb.i_mb_top_xy as isize) as ::core::ffi::c_int
                        != 0
                {
                    let mut mbn_xy: ::core::ffi::c_int = mb_xy - 2i32 * (*h).mb.i_mb_stride;
                    let mut j: ::core::ffi::c_int = 0i32;
                    while j < 2i32 {
                        let mut qpt: ::core::ffi::c_int =
                            *(*h).mb.qp.offset(mbn_xy as isize) as ::core::ffi::c_int;
                        let mut qp_top: ::core::ffi::c_int = qp + qpt + 1i32 >> 1i32;
                    ...
                    let mut qp_top_0: ::core::ffi::c_int = qp + qpt_0 + 1i32 >> 1i32;
